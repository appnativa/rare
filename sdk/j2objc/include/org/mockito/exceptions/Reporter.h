...
- (void)invalidUseOfMatchersWithInt:(int)expectedMatchersCount
...
- (void)incorrectUseOfAdditionalMatchersWithNSString:(NSString *)additionalMatcherName
                                             withInt:(int)expectedSubMatchersCount
...
- (void)tooManyActualInvocationsWithInt:(int)wantedCount
...
- (NSString *)createTooManyInvocationsMessageWithInt:(int)wantedCount
                                             withInt:(int)actualCount
         withOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted
                    withOrgMockitoInvocationLocation:(id<OrgMockitoInvocationLocation>)firstUndesired;
- (void)neverWantedButInvokedWithOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted
                                        withOrgMockitoInvocationLocation:(id<OrgMockitoInvocationLocation>)firstUndesired;
- (void)tooManyActualInvocationsInOrderWithInt:(int)wantedCount
                                       withInt:(int)actualCount
   withOrgMockitoInvocationDescribedInvocation:(id<OrgMockitoInvocationDescribedInvocation>)wanted
              withOrgMockitoInvocationLocation:(id<OrgMockitoInvocationLocation>)firstUndesired;
...
- (void)wantedAtMostXWithInt:(int)maxNumberOfInvocations
                     withInt:(int)foundSize;
...
- (int)invalidArgumentPositionRangeAtInvocationTimeWithOrgMockitoInvocationInvocationOnMock:(id<OrgMockitoInvocationInvocationOnMock>)invocation
                                                                                withBoolean:(BOOL)willReturnLastParameter
                                                                                    withInt:(int)argumentIndex;
