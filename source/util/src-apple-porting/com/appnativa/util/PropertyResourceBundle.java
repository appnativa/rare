/*
 * @(#)PropertyResourceBundle.java   2013-02-21
 * 
...
public class PropertyResourceBundle extends ResourceBundle {
   ...
   *             {@code InputStream}.
   */
  public PropertyResourceBundle(OrderedProperties properties) {
  ...
  private Enumeration<String> getLocalKeys() {
    return (Enumeration<String>) resources.keySet();
  }
}
