 ...
 * </p>
 * 
 * Don DeCoteau - Removed GZIP support and Java object encoding/decoding
 * 
...
//  }    // end decodeObject
   ...
   * 
   *  @return the encoded string as ISO-8859-1 characters
   *  @since 2.0
   */
  public static String encode(byte[] source) {
    return encode(source, 0, source.length, "ISO-8859-1");
  }

  /**
   *  Encodes a string. The string is converted to UTF8
   *  bytes and then those bytes are encoded
   * 
   *  @param source  The data to convert
   * 
   */
  public static String encodeUTF8(String source) {
    byte []a =UTF8Helper.getInstance().getBytes(source);
    return encode(a, 0, a.length, "ISO-8859-1");
  }
  
  
  /**
   *  Decodes a string. The string is decoded
   *  into bytes and then those bytes are converted
   *  to a string using the UTF8 encoding
   * 
   *  @param source  The data to convert
   * 
   */
  public static String decodeUTF8(String source) {
    ...
    return UTF8Helper.getInstance().getString(a);
  }
   ...
   * @since 2.0
   */
  public static String encode(byte[] source, String encoding) {
    return encode(source, 0, source.length, encoding);
  }
   ...
   * @since 2.0
   */
  public static String encode(byte[] source, int off, int len, String encoding) {
...
//  }    // end encode
  ...
  public static java.io.InputStream decodingStream(java.io.InputStream in) {
