 ...
 * stream remains open.
 *
 * <p>A sub-stream should always be closed when it is no longer needed, as the
 * close operation might be required to complete any pending operations. These
 * streams are meant to be short-lived </p>
 *
 * @author Don DeCoteau
 * @version 1.0
 */
public class Streams {
  ...
  /**
   * Gets a reader for decoding the specified encoding
   * Only base64, base85 and ascii85 are supported
   *
   ...
   * <p>The reader is NOT closed prior to this method returning</p>
   *
  ...
  /**
   * Reads the contents of the specified reader and writes it out to the specified writer.
   * <p>The reader is NOT closed prior to this method returning</p>
   *
   * @param reader the reader
   * @param writer the writer
   * @param block an optional character block to use to buffer the reads
   *
   ...
   * <p>The stream is NOT closed prior to this method returning</p>
   *
   * @param stream the stream to convert
   * @param ba an optional byte array to use for the conversion
   *
   * @return a byte array
   */
  ...
  /**
   * Reads the contents of the specified input stream and writes it out to the specified output stream
   * <p>The stream is NOT closed prior to this method returning</p>
   *
   * @param istream the input stream
   * @param ostream the output stream
   * @param block an optional byte block to use to buffer the reads
   *
  ...
  /**
   * Reads the contents of an input stream and converts it to an array of strings
   * The bytes are converted to characters using iso-8859-1 encoding
   * <p>The stream is NOT closed prior to this method returning</p>
   *
   * @param stream the stream to convert
   *
  ...
  /**
   * Reads the contents of an input stream and converts it to a string
   * The bytes are converted to characters using iso-8859-1 encoding.
   * <p>The stream is NOT closed prior to this method returning</p>
   *
   * @param stream the stream to convert
  ...
  /**
   * Reads the contents of the specified input stream and writes it out to the specified writer.
   * The stream is converted to bytes using iso-8859-1 encoding.
   * <p>The stream is NOT closed prior to this method returning</p>
   *
   ...
   * underlying stream. Once the specified number of bytes are read no
   * more bytes are able to be read from this stream.
   */
  public static class FixedLengthInputStream extends InputStream {
    ...
    /**
     * Constructs a new fixed-length input stream on top of the specified input stream.
     *
     * @param stream the source stream
     * @param fixedlen the lenght of the records
     */
  ...
  public static class ISO88591Reader extends Reader {
     ...
     *
     * @param stream the input stream to read wrom
     */
  ...
  /**
   * This class implements a stream that will wait infinitely for data to be received
   */
  public static class InfiniteWaitStream extends InputStream {
     ...
     * Creates a new  infinite wait stream
     * @param stream  the source stream
     * @param poll    the polling interval to use when checking for available data
     */
   ...
   * stream and presents then as a single continuous stream. It is
   * meant to be used in conjunction with a segmented output stream.
   */
  public static class SegmentedInputStream extends InputStream {
    ...
    /**
     * Constructs a new segmented input stream on top of the specified input stream.
     *
     * @param stream the source stream
     */
  ...
  public static class SegmentedOutputStream extends OutputStream {
    ...
    /**
     * Constructs a new segmented output stream on top of the specified output stream.
     *
     * @param stream the source stream
     */
  ...
  /**
   * This class provides a output stream that simple does not close
   * the underlying stream when the close method is called.
   */
  public static class SimpleSubOutStream extends OutputStream {
    ...
    /**
     * Constructs a new simple sub-output stream on top of the specified output stream.
     *
     * @param stream the source stream
     */
