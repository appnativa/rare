...
+ (void)showProgressPopupWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)comp
  ...
  [RAREPlatform runOnUIThreadWithJavaLangRunnable:[[RAREWaitCursorHandler_StartRunnable alloc] initWithJavaLangCharSequence:message withRAREUTiCancelable:cancelable withInt:[((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getIntWithNSString:@"Rare.WaitCursorHandler.delay" withInt:200]]];
}
