...
static BOOL RAREPlatformHelper_beepError_;
...
+ (BOOL)beepError {
  return RAREPlatformHelper_beepError_;
}
...
+ (void)setup {
  ...
  [RAREUISoundHelper setDefaultVolumeWithInt:15];
}
...
+ (void)beep {
  if (RAREPlatformHelper_beepError_) {
    [RAREPlatformHelper beepEx];
  }
  else {
    RAREPlatformHelper_beepError_ = ![RAREUISoundHelper errorSound];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "beepError_", NULL, 0x8, "Z" },
  };
  static J2ObjcClassInfo _RAREPlatformHelper = { "PlatformHelper", "com.appnativa.rare.platform", NULL, 0x1, 67, methods, 6, fields, 0, NULL};
