...
+ (void)hideVirtualKeyboardWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)c {
  RAREView *v = [((id<RAREiPlatformComponent>) nil_chk(c)) getView];
  if ([v isKindOfClass:[RARETextFieldView class]]) {
    [((RARETextFieldView *) check_class_cast(v, [RARETextFieldView class])) setShowKeyBoardWithBoolean:NO];
  }
}
...
+ (void)initialize {
  if (self == [RAREPlatformHelper class]) {
...
+ (NSString *)getDefaultRowHeight {
  NSString *s = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getStringWithNSString:@"Rare.List.rowHeight"];
  return (s == nil) ? @"1.75ln" : s;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "systemAlertWithRAREiWidget:withId:withRAREiPlatformIcon:withRAREiActionListener:", NULL, "V", 0x109, NULL },
    ...
    { "getDefaultRowHeight", NULL, "LNSString", 0x9, NULL },
    ...
    { "setComponentAlphaWithRAREiPlatformComponent:withFloat:", NULL, "Z", 0x109, NULL },
    ...
    { "getSoundWithJavaNetURL:", NULL, "LRAREUISound", 0x9, NULL },
  };
  ...
  static J2ObjcClassInfo _RAREPlatformHelper = { "PlatformHelper", "com.appnativa.rare.platform", NULL, 0x1, 59, methods, 5, fields, 0, NULL};
