...
- (void)setEditingModeWithRAREiListView_EditingModeEnum:(RAREiListView_EditingModeEnum *)mode {
  ...
  if (editingSelectionAllowed_) {
    uncheckedImage_ = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getResourceAsImageWithNSString:@"Rare.List.editorUncheckedIcon"];
    checkedImage_ = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getResourceAsImageWithNSString:@"Rare.List.editorCheckedIcon"];
  }
}
...
- (int)getSpanWidthWithInt:(int)start
  ...
  while (start < span) {
    width += [((RAREColumn *) IOSObjectArray_Get(nil_chk(columns), start++)) getWidth] + cm;
  }
  return width;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "repaintVisibleRows", NULL, "V", 0x104, NULL },
    ...
    { "getSpanWidthWithInt:withInt:withInt:withRAREColumnArray:withInt:", NULL, "I", 0x14, NULL },
  ...
  static J2ObjcClassInfo _RAREaPlatformTableBasedView = { "aPlatformTableBasedView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x401, 69, methods, 10, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getMinimumSizeWithRAREUIDimension:", NULL, "V", 0x101, NULL },
...
- (void)paintBackgroundWithRAREAppleGraphics:(RAREAppleGraphics *)g
  ...
  BOOL pressed = [self isPressed];
  RAREPaintBucket *selectionPaint = [self isSelected] ? [((RAREListItemRenderer *) nil_chk(this$2_->itemRenderer_)) getSelectionPaintForExternalPainterWithBoolean:NO] : nil;
  if (pressed || (selectionPaint != nil)) {
    float sx = 0;
    float ex = 0;
    if ([this$2_ isColumnSelectionAllowed]) {
      int n = pressed ? [((RAREaPlatformTableBasedView_ContentView *) nil_chk(contentView_)) getPressedViewIndex] : [this$2_ getSelectedColumn];
      if (n > -1) {
    ...
    if (![RAREUTSNumber isEqualWithFloat:sx withFloat:ex]) {
      if (pressed) {
        RAREPaintBucket *pb = [((RAREListItemRenderer *) nil_chk(this$2_->itemRenderer_)) getPressedPaint];
        if (pb != nil) {
      ...
      else if (selectionPaint != nil) {
        [RAREaUIComponentPainter paintWithRAREiPlatformGraphics:g withFloat:sx withFloat:rect->y_ withFloat:ex - sx withFloat:height withRAREPaintBucket:selectionPaint];
      }
    }
  }
}
  ...
  for (int i = 0; i < len; i++) {
    ...
    if (!empty) {
      ...
      if (autoSize) {
        ...
        int width = (span == 1) ? [c getWidth] : [this$2_ getSpanWidthWithInt:i withInt:span withInt:len withRAREColumnArray:columns withInt:d];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getPressedViewIndex", NULL, "I", 0x101, NULL },
