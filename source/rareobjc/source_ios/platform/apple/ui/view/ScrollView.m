...
- (id)initWithBoolean:(BOOL)tieVisibilityToContent {
  if (self = [super initWithId:[RAREScrollView createProxy]]) {
    ...
    hasHorizontalScrollbar_ = YES;
    measureSize_ = [[RAREUIDimension alloc] init];
    self->tieVisibilityToContent_ = tieVisibilityToContent;
  }
  return self;
}
...
- (BOOL)isVisible {
  if (tieVisibilityToContent_) {
    return contentView_ == nil ? NO : [contentView_ isVisible];
  }
  else {
...
- (BOOL)isTieVisibilityToContent {
  return tieVisibilityToContent_;
}
...
- (void)copyAllFieldsTo:(RAREScrollView *)other {
  ...
  other->tieVisibilityToContent_ = tieVisibilityToContent_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "isTieVisibilityToContent", NULL, "Z", 0x1, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    ...
    { "inOnScrollChanged_", NULL, 0x4, "Z" },
    { "tieVisibilityToContent_", NULL, 0x4, "Z" },
    { "contentView_", NULL, 0x4, "LRAREView" },
  };
  static J2ObjcClassInfo _RAREScrollView = { "ScrollView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x1, 36, methods, 13, fields, 0, NULL};
