...
- (id<RAREiHyperlinkListener>)getHyperlinkListener {
  return linkListener_;
}

- (void)setHyperlinkListenerWithRAREiHyperlinkListener:(id<RAREiHyperlinkListener>)listener {
  self->linkListener_ = listener;
}
...
- (void)copyAllFieldsTo:(RARELabelView *)other {
  ...
  other->linkListener_ = linkListener_;
}

+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "getHyperlinkListener", NULL, "LRAREiHyperlinkListener", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RARELabelView = { "LabelView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x1, 19, methods, 1, fields, 0, NULL};
