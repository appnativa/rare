...
+ (SDFNode *)parseWithJavaIoReader:(JavaIoReader *)r
            withRAREUTiURLResolver:(id<RAREUTiURLResolver>)urlResolver
...
@interface SDFNode_ParserCallback : NSObject < SDFParser_iCallback > {
 @public
  ...
  id<RAREUTiURLResolver> urlResolver_;
...
J2OBJC_FIELD_SETTER(SDFNode_ParserCallback, urlResolver_, id<RAREUTiURLResolver>)
