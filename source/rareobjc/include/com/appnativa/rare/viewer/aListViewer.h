...
@interface RAREaListViewer_$4 : NSObject < RAREiActionListener > {
 @public
  RAREaListViewer *this$0_;
}
...
J2OBJC_FIELD_SETTER(RAREaListViewer_$4, this$0_, RAREaListViewer *)

@interface RAREaListViewer_$5 : NSObject < JavaUtilComparator > {
}
