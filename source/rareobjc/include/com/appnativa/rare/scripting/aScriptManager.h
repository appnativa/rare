...
@interface RAREaScriptManager : NSObject < RAREiScriptHandler > {
 @public
  ...
  id<RAREiWidget> scriptWidget_;
  id<RAREiFormViewer> scriptForm_;
  RAREWindowViewer *scriptWindow_;
}
...
J2OBJC_FIELD_SETTER(RAREaScriptManager, scriptWidget_, id<RAREiWidget>)
J2OBJC_FIELD_SETTER(RAREaScriptManager, scriptForm_, id<RAREiFormViewer>)
J2OBJC_FIELD_SETTER(RAREaScriptManager, scriptWindow_, RAREWindowViewer *)
...
@interface RAREaScriptManager_aCompiledScript : JavaxScriptCompiledScript {
 @public
  ...
  BOOL usesBindings_;
  __weak RAREScriptingEvent *scriptEvent_;
}
