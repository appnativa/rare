...
@interface RAREaComboBoxComponent : RAREXPContainer < RAREiActionListener, RAREiPopupMenuListener, RAREiComboBox, RAREiItemChangeListener, RAREiTextChangeListener, RAREiDataModelListener > {
 @public
  ...
  RAREUTContainsFilter *startsWithFilter_;
  BOOL deletingText_;
}
...
J2OBJC_FIELD_SETTER(RAREaComboBoxComponent, startsWithFilter_, RAREUTContainsFilter *)

typedef RAREaComboBoxComponent ComAppnativaRareUiAComboBoxComponent;

@interface RAREaComboBoxComponent_Listener : RAREaMouseAdapter < RAREiKeyListener, RAREiFocusListener, RAREiActionListener > {
 @public
...
@interface RAREaComboBoxComponent_$2 : NSObject < JavaLangRunnable > {
 @public
  RAREaComboBoxComponent *this$0_;
...
J2OBJC_FIELD_SETTER(RAREaComboBoxComponent_$2, this$0_, RAREaComboBoxComponent *)
J2OBJC_FIELD_SETTER(RAREaComboBoxComponent_$2, val$p_, id<RAREiPopup>)
