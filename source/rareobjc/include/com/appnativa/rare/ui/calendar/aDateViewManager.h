...
@interface RAREaDateViewManager : NSObject < RAREiDateViewManager, RAREiActionListener, RAREiFunctionCallback > {
 @public
...
J2OBJC_FIELD_SETTER(RAREaDateViewManager, dialog_, RAREAlertPanel *)
