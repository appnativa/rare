...
J2OBJC_FIELD_SETTER(RAREViewerCreator_$4, val$cfg_, RARESPOTViewer *)

@interface RAREViewerCreator_$5 : NSObject < JavaLangRunnable > {
 @public
  RAREViewerCreator *this$0_;
...
J2OBJC_FIELD_SETTER(RAREViewerCreator_$5, this$0_, RAREViewerCreator *)
J2OBJC_FIELD_SETTER(RAREViewerCreator_$5, val$e_, JavaLangException *)
