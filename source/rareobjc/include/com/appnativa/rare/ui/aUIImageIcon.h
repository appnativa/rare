...
@interface RAREaUIImageIcon : RAREaPlatformIcon < RAREiBackgroundPainter, JavaLangRunnable, RAREiImageObserver, RAREUTiCancelable, NSCopying, RAREiObservableImage > {
 @public
