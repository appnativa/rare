...
#ifndef _RAREiGraphics_H_
#define _RAREiGraphics_H_
...
@protocol RAREiGraphics < NSObject, JavaObject >
...
#define ComAppnativaRareUiIGraphics RAREiGraphics

typedef enum {
  RAREiGraphics_Op_DIFFERENCE = 0,
  RAREiGraphics_Op_INTERSECT = 1,
  RAREiGraphics_Op_REPLACE = 2,
  RAREiGraphics_Op_UNION = 3,
} RAREiGraphics_Op;

@interface RAREiGraphics_OpEnum : JavaLangEnum < NSCopying > {
}
