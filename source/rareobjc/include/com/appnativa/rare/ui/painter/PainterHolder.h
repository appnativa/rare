...
@interface RAREPainterHolder : NSObject < NSCopying > {
 @public
  ...
  RAREUIColor *disabledForegroundColor_;
...
- (void)setDisabledForegroundColorWithRAREUIColor:(RAREUIColor *)color;
...
J2OBJC_FIELD_SETTER(RAREPainterHolder, disabledForegroundColor_, RAREUIColor *)
