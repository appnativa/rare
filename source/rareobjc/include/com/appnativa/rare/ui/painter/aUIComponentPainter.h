...
+ (BOOL)paintFocusDefault;
+ (BOOL *)paintFocusDefaultRef;
...
- (void)clear;
- (void)updateColorsWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)comp;
- (id)clone;
...
- (void)firePropertyChangeWithNSString:(NSString *)propertyName
                                withId:(id)oldValue
                                withId:(id)newValue;
- (void)fixPainterholderWithBoolean:(BOOL)forBorder;
