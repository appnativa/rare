...
@interface RAREaDataItemTableModel_TableFilterableList : RAREUTFilterableList {
 @public
...
J2OBJC_FIELD_SETTER(RAREaDataItemTableModel_TableFilterableList, this$0_, RAREaDataItemTableModel *)
