...
J2OBJC_FIELD_SETTER(RAREPopupList, cancelButtonText_, NSString *)
J2OBJC_FIELD_SETTER(RAREPopupList, listenerList_, RAREEventListenerList *)
...
J2OBJC_FIELD_SETTER(RAREPopupList_$1, val$o_, id)

@interface RAREPopupList_$2 : NSObject < JavaLangRunnable > {
 @public
  RAREPopupList *this$0_;
}
...
@interface RAREPopupList_$3 : NSObject < RAREiActionListener > {
 @public
  RAREPopupList *this$0_;
}
...
J2OBJC_FIELD_SETTER(RAREPopupList_$3, this$0_, RAREPopupList *)
