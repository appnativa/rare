...
@interface RAREColorChooserPanel_ColorChooserComboBox_DateComboBoxListHandler : RAREaNonListListHandler {
 @public
...
J2OBJC_FIELD_SETTER(RAREColorChooserPanel_ColorChooserComboBox_DateComboBoxListHandler, this$0_, RAREColorChooserPanel_ColorChooserComboBox *)
