...
#ifndef _RAREURLEncoder_H_
#define _RAREURLEncoder_H_
...
@interface RAREURLEncoder : NSObject {
}
...
typedef RAREURLEncoder ComAppnativaRareNetURLEncoder;

#endif // _RAREURLEncoder_H_
