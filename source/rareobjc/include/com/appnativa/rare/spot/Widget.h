...
@interface RARESPOTWidget : SPOTSequence {
 @public
  ...
  SPOTPrintableString *standardHandlers_;
...
J2OBJC_FIELD_SETTER(RARESPOTWidget, actionLink_, RARESPOTLink *)
J2OBJC_FIELD_SETTER(RARESPOTWidget, standardHandlers_, SPOTPrintableString *)
