...
@interface RAREGenericInterfaceProxy : RAREaInterfaceProxy < RAREiFunctionCallback, JavaLangRunnable, RAREiWorkerTask, RAREUTiCancelable, RAREUTiFilter, RAREActionLink_iErrorHandler, RAREUTiStringConverter, JavaUtilComparator, RAREiActionListener, RAREiChangeListener, RAREiAnimatorValueListener, RAREiExpansionListener, RAREiExpandedListener, RAREiPopupMenuListener > {
}
