...
@interface RAREWebView_$2 : NSObject < JavaLangRunnable > {
 @public
...
J2OBJC_FIELD_SETTER(RAREWebView_$2, val$cb_, id<RAREiFunctionCallback>)
J2OBJC_FIELD_SETTER(RAREWebView_$2, val$value_, id)
