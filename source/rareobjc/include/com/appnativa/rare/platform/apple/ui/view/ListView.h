...
@interface RAREListView : RAREaPlatformTableBasedView < RAREiEditableListHandler > {
 @public
  ...
  id<RAREiExpansionListener> editModeListener_;
  id<RAREiExpansionListener> rowEditModeListener_;
...
J2OBJC_FIELD_SETTER(RAREListView, editModeListener_, id<RAREiExpansionListener>)
J2OBJC_FIELD_SETTER(RAREListView, rowEditModeListener_, id<RAREiExpansionListener>)
