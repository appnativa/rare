...
@interface RAREaTextFieldWidget_$2 : NSObject < RAREiActionListener > {
 @public
  RAREaTextFieldWidget *this$0_;
  NSString *val$title_;
  NSString *val$exts_;
...
J2OBJC_FIELD_SETTER(RAREaTextFieldWidget_$2, this$0_, RAREaTextFieldWidget *)
J2OBJC_FIELD_SETTER(RAREaTextFieldWidget_$2, val$title_, NSString *)
J2OBJC_FIELD_SETTER(RAREaTextFieldWidget_$2, val$exts_, NSString *)
