...
@class AndroidTextHtmlToSpannedConverter_Strikethrough;
...
+ (AndroidTextHtmlToSpannedConverter_Strikethrough *)newStrikethrough OBJC_METHOD_FAMILY_NONE;
...
@interface AndroidTextHtmlToSpannedConverter_Strikethrough : NSObject {
}
