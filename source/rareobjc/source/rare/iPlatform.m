...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "hasPhysicalKeyboard", NULL, "Z", 0x401, NULL },
    { "hasPointingDevice", NULL, "Z", 0x401, NULL },
  ...
  static J2ObjcClassInfo _RAREiPlatform = { "iPlatform", "com.appnativa.rare", NULL, 0x201, 70, methods, 0, NULL, 0, NULL};
