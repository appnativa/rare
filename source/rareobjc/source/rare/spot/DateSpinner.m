...
@implementation RARESPOTDateSpinner

- (id)init {
  return [self initRARESPOTDateSpinnerWithBoolean:YES];
}

- (id)initRARESPOTDateSpinnerWithBoolean:(BOOL)optional {
  if (self = [super initWithBoolean:optional withBoolean:NO]) {
    value_ = [[SPOTDate alloc] init];
    minValue_ = [[SPOTDate alloc] init];
    maxValue_ = [[SPOTDate alloc] init];
...
- (id)initWithBoolean:(BOOL)optional {
  return [self initRARESPOTDateSpinnerWithBoolean:optional];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "value_", NULL, 0x1, "LSPOTDate" },
    { "minValue_", NULL, 0x1, "LSPOTDate" },
    { "maxValue_", NULL, 0x1, "LSPOTDate" },
    { "format_", NULL, 0x1, "LSPOTPrintableString" },
  };
  static J2ObjcClassInfo _RARESPOTDateSpinner = { "DateSpinner", "com.appnativa.rare.spot", NULL, 0x1, 2, methods, 4, fields, 0, NULL};
  return &_RARESPOTDateSpinner;
}
