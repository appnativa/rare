...
static RAREUIEmptyBorder * RAREBorderUtils_EMPTY_FOCUS_AWARE_BORDER_;
...
static id<RAREiPlatformBorder> RAREBorderUtils_defaultEmptyButtonBorder_ = nil;
static id<RAREiPlatformBorder> RAREBorderUtils_defaultButtonBorder_;
static id<RAREiPlatformBorder> RAREBorderUtils_textareaBorder_;
static id<RAREiPlatformBorder> RAREBorderUtils_textfieldBorder_;
...
+ (RAREUIEmptyBorder *)EMPTY_FOCUS_AWARE_BORDER {
  return RAREBorderUtils_EMPTY_FOCUS_AWARE_BORDER_;
}
...
+ (id<RAREiPlatformBorder>)defaultEmptyButtonBorder {
  return RAREBorderUtils_defaultEmptyButtonBorder_;
}

+ (void)setDefaultEmptyButtonBorder:(id<RAREiPlatformBorder>)defaultEmptyButtonBorder {
  RAREBorderUtils_defaultEmptyButtonBorder_ = defaultEmptyButtonBorder;
}
...
+ (id<RAREiPlatformBorder>)createBorderWithRAREiWidget:(id<RAREiWidget>)context
  ...
  switch (btype) {
    ...
    {
      ca = (color == nil) ? nil : [RAREColorUtils getColorsWithNSString:color withInt:1];
    ...
    {
      c = (color == nil) ? [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.BalloonBorder.color"] : [RAREColorUtils getColorWithNSString:color];
      if (c == nil) {
...
+ (id<RAREiPlatformBorder>)createBorderWithRAREiWidget:(id<RAREiWidget>)context
  ...
  @try {
    ...
    SDFNode *node = [SDFNode parseWithJavaIoReader:r withRAREUTiURLResolver:[((id<RAREiWidget>) nil_chk(context)) getURLResolver] withNSString:nil withBoolean:NO];
...
+ (IOSObjectArray *)getBevelColorsWithRAREUIColor:(RAREUIColor *)c
  ...
  BOOL keep = [RAREColorUtils KEEP_COLOR_KEYS];
  if ([((RAREUIColor *) nil_chk(c)) isDarkColor]) {
    c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum BRIGHTER]] : [c brighter];
  }
  if (four) {
    ca = [IOSObjectArray arrayWithLength:4 type:[IOSClass classWithClass:[RAREUIColor class]]];
    (void) IOSObjectArray_Set(ca, 3, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum DARKER_DARKER]] : [((RAREUIColor *) nil_chk([c darker])) darker]);
    (void) IOSObjectArray_Set(ca, 2, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum DARKER]] : [c darker]);
    (void) IOSObjectArray_Set(ca, 1, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum BRIGHTER_BRIGHTER]] : [c brighterBrighter]);
    (void) IOSObjectArray_Set(ca, 0, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum BRIGHTER]] : [c brighter]);
  }
  else {
    ca = [IOSObjectArray arrayWithLength:2 type:[IOSClass classWithClass:[RAREUIColor class]]];
    (void) IOSObjectArray_Set(ca, 0, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum DARKER_DARKER]] : [((RAREUIColor *) nil_chk([c darker])) darker]);
    (void) IOSObjectArray_Set(ca, 1, c = keep ? [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum BRIGHTER]] : [c brighter]);
  }
  return ca;
}
...
+ (id<RAREiPlatformBorder>)getDefaultEmptyButtonBorder {
  if (RAREBorderUtils_defaultEmptyButtonBorder_ == nil) {
    RAREUIEmptyBorder *b;
    RAREUIInsets *insets = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getInsetsWithNSString:@"Rare.PushButton.borderInsets"];
    if (insets != nil) {
      b = [[RAREUIEmptyBorder alloc] initWithRAREUIInsets:insets];
    }
    else {
      int size = [RAREScreenUtils platformPixelsWithFloat:[RAREPlatform isTouchDevice] ? 8 : 4];
      b = [[RAREUIEmptyBorder alloc] initWithFloat:size];
    }
    RAREBorderUtils_defaultEmptyButtonBorder_ = b;
  }
  return RAREBorderUtils_defaultEmptyButtonBorder_;
}
...
+ (id<RAREiPlatformBorder>)getTextAreaBorder {
  if (RAREBorderUtils_textareaBorder_ == nil) {
    id<RAREiPlatformBorder> b = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getBorderWithNSString:@"Rare.TextArea.border"];
    if (b != nil) {
      ...
      RAREUILineBorder *lb = [[RAREUILineBorder alloc] initWithRAREUIColor:c withFloat:[RAREScreenUtils PLATFORM_PIXELS_1] withFloat:0];
      [lb setInsetsPaddingWithFloat:[RAREScreenUtils PLATFORM_PIXELS_2] withFloat:[RAREScreenUtils PLATFORM_PIXELS_2] withFloat:[RAREScreenUtils PLATFORM_PIXELS_2] withFloat:[RAREScreenUtils PLATFORM_PIXELS_2]];
      RAREBorderUtils_textareaBorder_ = lb;
    }
  }
  return RAREBorderUtils_textareaBorder_;
}
...
+ (id<RAREiPlatformBorder>)getTextFieldBorder {
  if (RAREBorderUtils_textfieldBorder_ == nil) {
    id<RAREiPlatformBorder> b = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getBorderWithNSString:@"Rare.TextField.border"];
    if (b != nil) {
      ...
      RAREUILineBorder *lb = [[RAREUILineBorder alloc] initWithRAREUIColor:c withFloat:[RAREScreenUtils PLATFORM_PIXELS_1] withFloat:[RAREScreenUtils PLATFORM_PIXELS_6]];
      [lb setInsetsPaddingWithFloat:2 withFloat:2 withFloat:2 withFloat:2];
      RAREBorderUtils_textfieldBorder_ = lb;
    }
  }
  return RAREBorderUtils_textfieldBorder_;
}
...
+ (void)initialize {
  if (self == [RAREBorderUtils class]) {
    ...
    RAREBorderUtils_EMPTY_FOCUS_AWARE_BORDER_ = [[RAREBorderUtils_$1 alloc] initWithInt:0 withInt:0 withInt:0 withInt:0];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getDefaultEmptyButtonBorder", NULL, "LRAREiPlatformBorder", 0x9, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "EMPTY_FOCUS_AWARE_BORDER_", NULL, 0x19, "LRAREUIEmptyBorder" },
    ...
    { "defaultEmptyButtonBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
    { "defaultButtonBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
    { "textareaBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
    { "textfieldBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
    { "toolbarPressedButtonBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
    { "widgetBorder_", NULL, 0xa, "LRAREiPlatformBorder" },
  };
  static J2ObjcClassInfo _RAREBorderUtils = { "BorderUtils", "com.appnativa.rare.ui", NULL, 0x1, 34, methods, 18, fields, 0, NULL};
  return &_RAREBorderUtils;
}

@end
@implementation RAREBorderUtils_$1
...
- (id)initWithInt:(int)arg$0
          ...
          withInt:(int)arg$2
          withInt:(int)arg$3 {
  return [super initWithFloat:arg$0 withFloat:arg$1 withFloat:arg$2 withFloat:arg$3];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREBorderUtils_$1 = { "$1", "com.appnativa.rare.ui", "BorderUtils", 0x8000, 1, methods, 0, NULL, 0, NULL};
  return &_RAREBorderUtils_$1;
}
