...
- (RAREUIImage *)createCopyWithReflectionWithInt:(int)height
                                       withFloat:(float)opacity
                                         withInt:(int)gap {
  return [[RAREUIImage alloc] initWithId:[RAREImageUtils createCopyWithReflectionWithId:proxy_ withInt:height withFloat:opacity withInt:gap]];
}

- (RAREUIImage *)createReflectionWithInt:(int)height
                               withFloat:(float)opacity
                                 withInt:(int)gap {
  return [[RAREUIImage alloc] initWithId:[RAREImageUtils createReflectionWithId:proxy_ withInt:height withFloat:opacity withInt:gap]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "createCopyWithReflectionWithInt:withFloat:withInt:", NULL, "LRAREUIImage", 0x1, NULL },
    { "createReflectionWithInt:withFloat:withInt:", NULL, "LRAREUIImage", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREUIImage = { "UIImage", "com.appnativa.rare.ui", NULL, 0x1, 16, methods, 2, fields, 0, NULL};
  return &_RAREUIImage;
}
