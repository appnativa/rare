...
- (RAREUIColor *)getDisabledColor {
  return (disabledColor_ == nil) ? defaultColor_ : disabledColor_;
}

- (RAREUIColor *)getDisabledColorWithRAREUIColor:(RAREUIColor *)def {
  return (disabledColor_ == nil) ? def : disabledColor_;
}
...
- (RAREUIColor *)getSelectedDisabledColorWithRAREUIColor:(RAREUIColor *)def {
  return (selectedDisabledColor_ == nil) ? [self getDisabledColorWithRAREUIColor:def] : selectedDisabledColor_;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getSelectedDisabledColorWithRAREUIColor:", NULL, "LRAREUIColor", 0x1, NULL },
  };
  static J2ObjcClassInfo _RARESimpleColorStateList = { "SimpleColorStateList", "com.appnativa.rare.ui", NULL, 0x1, 11, methods, 0, NULL, 0, NULL};
