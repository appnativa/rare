...
- (id)initRAREFormsPanel {
  return [super initWithId:[[RAREFormsView alloc] initWithRAREFormLayout:[[RAREFormLayout alloc] init]]];
}
...
- (id)initWithRAREiWidget:(id<RAREiWidget>)context
  ...
  return [super initWithId:[[RAREFormsView alloc] initWithRAREFormLayout:layout]];
}
...
- (id)initRAREFormsPanelWithRAREiWidget:(id<RAREiWidget>)context
  ...
  if (self = [super init]) {
    RARERowSpec *r = [RARERowSpec decodeWithNSString:rspec];
    RAREColumnSpec *c = [RAREColumnSpec decodeWithNSString:cspec];
    IOSObjectArray *ra = [IOSObjectArray arrayWithLength:rows type:[IOSClass classWithClass:[RARERowSpec class]]];
    IOSObjectArray *ca = [IOSObjectArray arrayWithLength:cols type:[IOSClass classWithClass:[RAREColumnSpec class]]];
    ...
    [self setViewWithRAREView:[[RAREFormsView alloc] initWithRAREFormLayout:[[RAREFormLayout alloc] initWithRAREColumnSpecArray:ca withRARERowSpecArray:ra]]];
  }
  return self;
}
...
- (void)getPreferredSizeExWithRAREUIDimension:(RAREUIDimension *)size
  ...
  [((RAREFormLayout *) nil_chk([self getFormLayout])) invalidatePreferredCache];
