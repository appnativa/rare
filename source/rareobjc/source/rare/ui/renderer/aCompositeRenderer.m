  ...
  if (position != iconPosition_) {
    ...
    switch ([position ordinal]) {
      ...
      if (cc != nil) {
        ...
        cc->vAlign_ = [RAREJGCellConstraints TOP];
      }
      iconGapInsets_->bottom_ = iconGap_;
      [iconLabel_ setIconPositionWithRARERenderableDataItem_IconPositionEnum:position];
      break;
      ...
      cc = [self getCellConstraintsWithRAREiPlatformComponent:c];
      if (cc != nil) {
        cc->hAlign_ = [RAREJGCellConstraints LEFT];
        cc->vAlign_ = [RAREJGCellConstraints TOP];
      }
      break;
      ...
      if (cc != nil) {
        cc->hAlign_ = [RAREJGCellConstraints LEFT];
        cc->vAlign_ = [RAREJGCellConstraints RIGHT];
      }
      break;
      ...
      if (cc != nil) {
        cc->hAlign_ = [RAREJGCellConstraints CENTER];
        cc->vAlign_ = [RAREJGCellConstraints BOTTOM];
      }
      break;
      ...
      cc = [self getCellConstraintsWithRAREiPlatformComponent:c];
      if (cc != nil) {
        cc->hAlign_ = [RAREJGCellConstraints RIGHT];
        cc->vAlign_ = [RAREJGCellConstraints BOTTOM];
      }
      break;
      ...
      if (cc != nil) {
        cc->hAlign_ = [RAREJGCellConstraints LEFT];
        cc->vAlign_ = [RAREJGCellConstraints CENTER];
      }
      break;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaCompositeRenderer = { "aCompositeRenderer", "com.appnativa.rare.ui.renderer", NULL, 0x401, 15, methods, 8, fields, 0, NULL};
