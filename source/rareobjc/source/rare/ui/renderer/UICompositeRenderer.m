...
- (id<RAREiPlatformRenderingComponent>)newCopy {
  ...
  RAREUICompositeRenderer *cr = [[RAREUICompositeRenderer alloc] initWithRAREiPlatformRenderingComponent:rc];
  [cr setIconPositionWithRARERenderableDataItem_IconPositionEnum:iconPosition_];
  cr->backgroundSurface_ = backgroundSurface_;
  (void) [RARERenderers setupNewCopyWithRAREiPlatformRenderingComponent:self withRAREiPlatformRenderingComponent:cr];
  return cr;
}
