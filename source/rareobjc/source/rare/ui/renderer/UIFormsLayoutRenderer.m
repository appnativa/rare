...
- (id)init {
  if (self = [super initWithRAREaFormsLayoutRenderer_FormsPanelEx:[[RAREUIFormsLayoutRenderer_$1 alloc] initWithRAREFormsView:[[RAREFormsView alloc] initWithRAREJGFormLayout:[[RAREJGFormLayout alloc] init]]]]) {
    ((RAREaFormsLayoutRenderer_FormsPanelEx *) nil_chk(formsPanel_))->renderer_ = self;
  }
  return self;
}
...
- (id)initWithNSString:(NSString *)columns
  ...
  if (self = [super initWithRAREaFormsLayoutRenderer_FormsPanelEx:[[RAREaFormsLayoutRenderer_FormsPanelEx alloc] initWithId:([[RAREFormsView alloc] initWithRAREJGFormLayout:[[RAREJGFormLayout alloc] initWithNSString:columns withNSString:rows]])]]) {
...
- (void)clearRenderer {
  [super clearRenderer];
  [((RAREView *) nil_chk([((RAREaFormsLayoutRenderer_FormsPanelEx *) nil_chk(formsPanel_)) getView])) clearVisualState];
}
...
- (id<RAREiPlatformRenderingComponent>)newCopy {
  ...
  return [self setupNewCopyWithRAREaFormsLayoutRenderer:[[RAREUIFormsLayoutRenderer alloc] initWithNSString:columns_ withNSString:rows_]];
}
...
- (void)setNativeViewWithId:(id)proxy {
  [((RAREView *) nil_chk([((RAREaFormsLayoutRenderer_FormsPanelEx *) nil_chk(formsPanel_)) getView])) setProxyWithId:proxy];
}
