...
- (id)init {
  if (self = [super initWithRAREaFormsLayoutRenderer_FormsPanelEx:[[RAREUIFormsLayoutRenderer_$1 alloc] initWithRAREFormsView:[[RAREFormsView alloc] initWithRAREFormLayout:[[RAREFormLayout alloc] init]]]]) {
...
- (id)initWithNSString:(NSString *)columns
  ...
  if (self = [super initWithRAREaFormsLayoutRenderer_FormsPanelEx:[[RAREaFormsLayoutRenderer_FormsPanelEx alloc] initWithId:([[RAREFormsView alloc] initWithRAREFormLayout:[[RAREFormLayout alloc] initWithNSString:columns withNSString:rows]])]]) {
