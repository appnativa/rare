...
- (id)initRAREaListItemRendererWithBoolean:(BOOL)handlesSelection {
  if (self = [super init]) {
    ...
    hilightIndex_ = JavaLangInteger_MIN_VALUE;
...
- (id<JavaLangCharSequence>)configureRenderingComponentWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)list
  ...
  if (isSelected) {
    ...
    if ((pb == nil) && (hilightSelected_ || hilightIndex_ == row)) {
      pb = [self getAutoHilightPaint];
    }
    if ((pb == nil) && override) {
  ...
  [self setIconAndAlignmentWithRAREiPlatformRenderingComponent:rc withJavaLangCharSequence:s withRARERenderableDataItem:item withRARERenderableDataItem:nil withRAREColumn:col withBoolean:enabled withBoolean:NO withBoolean:NO withBoolean:!noicon_ withBoolean:NO];
  ...
  if (col != nil) {
    if (in == nil) {
      ...
      if (insetsAdd_ == nil) {
        insetsAdd_ = [[RAREUIInsets alloc] initWithRAREUIInsets:in];
      }
      else {
        (void) [insetsAdd_ setWithRAREUIInsets:in];
      }
      in = insetsAdd_;
      [col addMarginWithRAREUIInsets:in];
    }
  }
  if (in != nil) {
...
- (void)setIconAndAlignmentWithRAREiPlatformRenderingComponent:(id<RAREiPlatformRenderingComponent>)rc
  ...
  id<RAREiPlatformIcon> icon = [RAREUtils getIconWithRARERenderableDataItem:item withRAREColumn:col withBoolean:enabled withBoolean:expanded withRAREiPlatformIcon:delayedIcon_];
  [RAREUtils setIconAndAlignmentWithRAREiPlatformRenderingComponent:rc withRARERenderableDataItem:item withRARERenderableDataItem:row withRAREColumn:col withBoolean:enabled withBoolean:center withBoolean:top withBoolean:seticon withRAREiPlatformIcon:icon];
}
...
- (BOOL)getHilightSelected {
  return hilightSelected_;
}

- (void)setHilightSelectedWithBoolean:(BOOL)hilightSelected {
  self->hilightSelected_ = hilightSelected;
}

- (int)getHilightIndex {
  return hilightIndex_;
}

- (void)setHilightIndexWithInt:(int)hilightIndex {
  if (hilightIndex < 0) {
    hilightIndex = JavaLangInteger_MIN_VALUE;
  }
  self->hilightIndex_ = hilightIndex;
}

- (BOOL)isIgnoreSelection {
  return ignoreSelection_;
}

- (void)setIgnoreSelectionWithBoolean:(BOOL)ignoreSelection {
  self->ignoreSelection_ = ignoreSelection;
}
...
- (void)copyAllFieldsTo:(RAREaListItemRenderer *)other {
  ...
  other->hilightIndex_ = hilightIndex_;
  other->hilightSelected_ = hilightSelected_;
  other->ignoreSelection_ = ignoreSelection_;
  other->insets_ = insets_;
  other->insetsAdd_ = insetsAdd_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "setIconAndAlignmentWithRAREiPlatformRenderingComponent:withJavaLangCharSequence:withRARERenderableDataItem:withRARERenderableDataItem:withRAREColumn:withBoolean:withBoolean:withBoolean:withBoolean:withBoolean:", NULL, "V", 0x4, NULL },
    ...
    { "getHilightSelected", NULL, "Z", 0x1, NULL },
    { "isIgnoreSelection", NULL, "Z", 0x1, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    ...
    { "insetsAdd_", NULL, 0x4, "LRAREUIInsets" },
    ...
    { "hilightIndex_", NULL, 0x4, "I" },
    { "hilightSelected_", NULL, 0x4, "Z" },
    { "ignoreSelection_", NULL, 0x4, "Z" },
  };
  static J2ObjcClassInfo _RAREaListItemRenderer = { "aListItemRenderer", "com.appnativa.rare.ui.renderer", NULL, 0x401, 20, methods, 20, fields, 0, NULL};
