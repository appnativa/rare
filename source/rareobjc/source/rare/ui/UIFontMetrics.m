...
static id RAREUIFontMetrics_dictionaryProxy_;

+ (id)dictionaryProxy {
  return RAREUIFontMetrics_dictionaryProxy_;
}

+ (void)setDictionaryProxy:(id)dictionaryProxy {
  RAREUIFontMetrics_dictionaryProxy_ = dictionaryProxy;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREUIFontMetrics = { "UIFontMetrics", "com.appnativa.rare.ui", NULL, 0x1, 9, methods, 2, fields, 0, NULL};
