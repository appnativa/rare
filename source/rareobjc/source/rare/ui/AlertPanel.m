...
- (RARELinearPanel *)createButtonPanelWithRAREiWidget:(id<RAREiWidget>)context
  ...
  if (rightAlignButtons_) {
    if (count == 2) {
      a = [IOSIntArray arrayWithInts:(int[]){ 2, 3 } count:2];
    }
    else if (count == 3) {
      a = [IOSIntArray arrayWithInts:(int[]){ 2, 3, 4 } count:3];
    }
  }
  else {
    if (count == 2) {
  ...
  if (a != nil) {
    if (horizontal) {
      [((RAREJGFormLayout *) nil_chk([((RARELinearPanel *) nil_chk(p)) getFormLayout])) setColumnGroupsWithIntArray2:[IOSObjectArray arrayWithObjects:(id[]){ a } count:1 type:[IOSIntArray iosClass]]];
    }
    else {
      [((RAREJGFormLayout *) nil_chk([((RARELinearPanel *) nil_chk(p)) getFormLayout])) setRowGroupsWithIntArray2:[IOSObjectArray arrayWithObjects:(id[]){ a } count:1 type:[IOSIntArray iosClass]]];
    }
  }
  return p;
}
...
+ (RAREAlertPanel *)promptWithRAREiWidget:(id<RAREiWidget>)context
  ...
  if (tf != value) {
    ...
    [((RARETextFieldWidget *) nil_chk(tf)) addActionListenerWithRAREiActionListener:[[RAREAlertPanel_$4 alloc] initWithRAREPushButtonWidget:ok]];
  }
  return d;
}
...
+ (void)adjustLabelWithRAREaWidget:(RAREaWidget *)l
  ...
  if ([((NSString *) nil_chk(s)) sequenceLength] != 0) {
    ...
    int ln = [JavaLangMath maxWithInt:len / chars withInt:3];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "paneViewer_", NULL, 0x0, "LRAREWidgetPaneViewer" },
    { "promptWidget_", NULL, 0x0, "LRARETextFieldWidget" },
    { "messageComponent_", NULL, 0x0, "LRAREiPlatformComponent" },
    { "rightAlignButtons_", NULL, 0x0, "Z" },
  };
  static J2ObjcClassInfo _RAREAlertPanel = { "AlertPanel", "com.appnativa.rare.ui", NULL, 0x1, 28, methods, 19, fields, 0, NULL};
