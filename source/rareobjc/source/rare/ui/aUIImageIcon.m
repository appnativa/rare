...
- (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  if ((image_ != nil) && loaded_) {
    ...
    if ((c != nil) && [c isScaleIcon]) {
      ...
      f = size / [JavaLangMath minWithFloat:iw withFloat:ih];
      iw *= f;
      ih *= f;
    }
...
- (void)setImageWithRAREUIImage:(RAREUIImage *)image {
  ...
  if (image != nil) {
    ...
    loaded_ = [image isLoadedWithRAREiImageObserver:self];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaUIImageIcon = { "aUIImageIcon", "com.appnativa.rare.ui", NULL, 0x401, 42, methods, 26, fields, 0, NULL};
