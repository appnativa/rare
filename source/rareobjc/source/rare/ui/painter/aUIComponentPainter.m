...
static BOOL RAREaUIComponentPainter_paintFocusDefault_;
...
+ (BOOL)paintFocusDefault {
  return RAREaUIComponentPainter_paintFocusDefault_;
}
...
+ (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  [RAREaUIComponentPainter paintWithRAREiPlatformGraphics:g withFloat:x withFloat:y withFloat:width withFloat:height withRAREPaintBucket:pb withBoolean:YES];
}
...
+ (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  id<RAREiPlatformBorder> b = paintBorder ? ((RAREPaintBucket *) nil_chk(pb))->border_ : nil;
  RAREUIColor *oc = [((id<RAREiPlatformGraphics>) nil_chk(g)) getColor];
  id<RAREiPlatformPaint> op = [g getPaint];
  id<RAREiBackgroundPainter> bp = ((RAREPaintBucket *) nil_chk(pb))->backgroundPainter_;
  ...
  if (clips && (((bg != nil) && (bp != nil)) || (bgop != nil))) {
    [g saveState];
    [b clipWithRAREiPlatformGraphics:g withFloat:x withFloat:y withFloat:width withFloat:height];
...
- (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  if (!end) {
    ...
    if (!paintAll_ && RAREaUIComponentPainter_paintFocusDefault_ && ((pc != nil) && [pc isFocusPainted])) {
      if ((b == nil) || ![b isFocusAware]) {
        RAREPaintBucket *pb = [pc getFocusPaintWithRAREPaintBucket:RAREaUIComponentPainter_focusPaint_];
        b = (pb == nil) ? nil : [pb getBorder];
        if (b != nil) {
          ...
          [b paintWithRAREiPlatformGraphics:g withFloat:ox withFloat:oy withFloat:owidth withFloat:oheight withBoolean:[b isPaintLast]];
        }
      }
    }
  }
...
- (void)setBackgroundPainterWithRAREiBackgroundPainter:(id<RAREiBackgroundPainter>)painter
  ...
  if (backgroundPainter_ != painter) {
    ...
    [self imagePainterCheckedAndOkToAddWithRAREiPlatformPainter:painter];
    if (checkOthers) {
      [self fixPainterholderWithBoolean:NO];
    }
  }
}
...
- (void)setBorderWithRAREiPlatformBorder:(id<RAREiPlatformBorder>)b {
  if ((border_ != b) || ((b != nil) && ([b getModCount] != borderModCount_))) {
    ...
    [self fixPainterholderWithBoolean:YES];
...
- (RAREUIColor *)getForegroundColor {
  return (painterHolder_ == nil) ? nil : painterHolder_->foregroundColor_;
}
...
- (BOOL)imagePainterCheckedAndOkToAddWithRAREiPlatformPainter:(id<RAREiPlatformPainter>)p {
  if ([(id) p isKindOfClass:[RAREUIImagePainter class]]) {
    ...
    if (([((RAREUIImagePainter *) nil_chk(ip)) getImage] != nil) && [((RAREUIImage *) nil_chk([ip getImage])) isImageLoadedWithRAREiImageObserver:self]) {
      return YES;
    }
    return NO;
  }
...
+ (void)initialize {
  if (self == [RAREaUIComponentPainter class]) {
    RAREaUIComponentPainter_paintFocusDefault_ = ![RAREPlatform isTouchDevice];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "fixPainterholderWithBoolean:", NULL, "V", 0x4, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    { "paintFocusDefault_", NULL, 0x9, "Z" },
    { "focusPaint_", NULL, 0x9, "LRAREPaintBucket" },
    { "isApple_", NULL, 0xc, "Z" },
  ...
  static J2ObjcClassInfo _RAREaUIComponentPainter = { "aUIComponentPainter", "com.appnativa.rare.ui.painter", NULL, 0x401, 28, methods, 15, fields, 0, NULL};
