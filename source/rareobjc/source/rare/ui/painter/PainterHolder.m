...
- (void)clear {
  ...
  self->disabledForegroundColor_ = nil;
...
- (RAREUIColor *)getForegroundWithRAREiPaintedButton_ButtonStateEnum:(RAREiPaintedButton_ButtonStateEnum *)state
  ...
  RAREUIColor *color = nil;
  {
    ...
    switch ([state ordinal]) {
      ...
      if (disabledForegroundColor_ != nil) {
        color = disabledForegroundColor_;
      }
      else {
        color = (disabledPainter_ == nil) ? nil : [disabledPainter_ getForegroundColor];
        if ((color == nil) && returnDefaults) {
          color = [RAREColorUtils getDisabledForeground];
        }
      }
      break;
      default:
...
- (void)setDisabledForegroundColorWithRAREUIColor:(RAREUIColor *)color {
  disabledForegroundColor_ = color;
}
...
+ (RAREPainterHolder *)createWithRAREiWidget:(id<RAREiWidget>)context
  ...
  RAREUIColor *fg = nil, *dfg = nil;
  NSString *s;
  s = [((id<iSPOTElement>) nil_chk(cfg)) spot_getAttributeWithNSString:@"fgColor"];
  if (s != nil) {
    fg = [RAREUIColorHelper getColorWithNSString:s];
  }
  s = [cfg spot_getAttributeWithNSString:@"disabledColor"];
  if (s != nil) {
    dfg = [RAREUIColorHelper getColorWithNSString:s];
  }
  ...
  if ((pi != nil) || (si != nil) || (ni != nil) || (di != nil) || (fg != nil) || (dfg != nil)) {
    if (ph == nil) {
...
+ (RAREPainterHolder *)createWithNSString:(NSString *)keyPrefix
  ...
  (void) [sb appendWithNSString:@"disabledForeground"];
  if (themed) {
    (void) [sb appendWithNSString:theme];
  }
  ph->disabledForegroundColor_ = [props getColorWithNSString:[sb description]];
  if (!paintOnly) {
    [sb setLengthWithInt:sblen];
...
- (void)copyAllFieldsTo:(RAREPainterHolder *)other {
  ...
  other->disabledForegroundColor_ = disabledForegroundColor_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "disabledForegroundColor_", NULL, 0x1, "LRAREUIColor" },
  ...
  static J2ObjcClassInfo _RAREPainterHolder = { "PainterHolder", "com.appnativa.rare.ui.painter", NULL, 0x1, 27, methods, 17, fields, 0, NULL};
