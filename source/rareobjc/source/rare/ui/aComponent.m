  ...
  if (listenerList_ != nil) {
    ...
    for (int i = (int) [((IOSObjectArray *) nil_chk(listeners)) count] - 2; i >= 0; i -= 2) {
      if ((IOSObjectArray_Get(listeners, i) == [IOSClass classWithProtocol:@protocol(RAREiFocusListener)]) && (IOSObjectArray_Get(listeners, i + 1) != self)) {
        [((id<RAREiFocusListener>) check_protocol_cast(IOSObjectArray_Get(listeners, i + 1), @protocol(RAREiFocusListener))) focusChangedWithId:view withBoolean:hasFocus withId:oppositeView withBoolean:temporary];
      }
    }
  }
}
...
- (RAREPaintBucket *)getFocusPaintWithRAREPaintBucket:(RAREPaintBucket *)def {
  ...
  if (widget_ != nil) {
    if ([((RAREaWidget *) check_class_cast(widget_, [RAREaWidget class])) isPopupMenuShowing]) {
      return (focusPaint_ == nil) ? def : focusPaint_;
    }
    if (![widget_ isFocusOwner]) {
      return nil;
    }
  }
  else if (![self isFocusOwner]) {
    return nil;
  }
  return (focusPaint_ == nil) ? def : focusPaint_;
}
...
- (RAREUIDimension *)getMinimumSizeWithRAREUIDimension:(RAREUIDimension *)size {
  return [self getMinimumSizeWithRAREUIDimension:size withFloat:0];
}
...
- (RAREUIDimension *)getMinimumSizeWithRAREUIDimension:(RAREUIDimension *)size
  ...
  [self getMinimumSizeExWithRAREUIDimension:size withFloat:maxWidth];
...
+ (void)populateMeasuredSizeCacheWithRAREiParentComponent:(id<RAREiParentComponent>)parent
  ...
  for (int i = 0; i < len; i++) {
    ...
    if (!([o isKindOfClass:[RARECellConstraints class]])) {
      o = [[RARECellConstraints alloc] init];
      [c putClientPropertyWithNSString:[RAREiConstants RARE_CONSTRAINTS_PROPERTY] withId:o];
    }
    RARECellConstraints *cc = (RARECellConstraints *) check_class_cast(o, [RARECellConstraints class]);
    (void) [c getPreferredSizeWithRAREUIDimension:size];
    ((RARECellConstraints *) nil_chk(cc))->gridWidth_ = (int) size->width_;
...
+ (RARECellConstraints *)getMeasuredCellConstraintsWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)c
  ...
  return (RARECellConstraints *) check_class_cast(o, [RARECellConstraints class]);
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getFocusPaintWithRAREPaintBucket:", NULL, "LRAREPaintBucket", 0x1, NULL },
    ...
    { "getMinimumSizeWithRAREUIDimension:withFloat:", NULL, "LRAREUIDimension", 0x1, NULL },
    ...
    { "getMeasuredCellConstraintsWithRAREiPlatformComponent:withBoolean:", NULL, "LRARECellConstraints", 0xc, NULL },
    { "getMinimumSizeExWithRAREUIDimension:withFloat:", NULL, "V", 0x404, NULL },
  ...
  static J2ObjcClassInfo _RAREaComponent = { "aComponent", "com.appnativa.rare.ui", NULL, 0x401, 111, methods, 23, fields, 0, NULL};
