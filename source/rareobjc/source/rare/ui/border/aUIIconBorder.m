...
- (void)paintPatternWithRAREUIImage:(RAREUIImage *)image
          withRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
                          ...
                          withFloat:(float)width
                          withFloat:(float)height {
  [RAREaUIImagePainter drawTiledImageWithRAREiPlatformGraphics:g withRAREUIImage:image withFloat:0 withFloat:0 withFloat:x withFloat:y withFloat:width withFloat:height withRAREiComposite:nil];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaUIIconBorder = { "aUIIconBorder", "com.appnativa.rare.ui.border", NULL, 0x401, 14, methods, 23, fields, 0, NULL};
