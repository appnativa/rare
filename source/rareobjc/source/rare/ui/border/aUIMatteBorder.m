...
- (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  RAREUIColor *color = [self getPaintColorWithRAREiPlatformGraphics:g];
...
- (RAREUIColor *)getDisabledLineColor {
  return [((RAREUIColor *) nil_chk(lineColor_)) getDisabledColor];
}
...
- (RAREUIColor *)getPaintColorWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g {
  ...
  RAREUIColor *color = (pc == nil) ? nil : [self getFocusColorWithRAREiPlatformComponent:pc withBoolean:NO];
  if (color == nil) {
    color = lineColor_;
    if ((pc != nil) && ![pc isEnabled]) {
      color = [self getDisabledLineColor];
    }
  }
  return color;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getDisabledLineColor", NULL, "LRAREUIColor", 0x4, NULL },
    { "getPaintColorWithRAREiPlatformGraphics:", NULL, "LRAREUIColor", 0x4, NULL },
  };
  ...
  static J2ObjcClassInfo _RAREaUIMatteBorder = { "aUIMatteBorder", "com.appnativa.rare.ui.border", NULL, 0x401, 8, methods, 3, fields, 0, NULL};
