...
- (void)updateComponentWithFloat:(float)x
  ...
  if (outComponent_ != nil) {
    ...
    if (fadeIn_) {
      [RAREPlatformHelper setComponentAlphaWithRAREiPlatformComponent:inComponent_ withFloat:small ? 1 - fraction : fraction];
      [((id<RAREiPlatformComponent>) nil_chk(inComponent_)) repaint];
    }
    if (fadeOut_ && (outComponent_ != nil)) {
      [RAREPlatformHelper setComponentAlphaWithRAREiPlatformComponent:outComponent_ withFloat:1 - fraction];
      [outComponent_ repaint];
    }
  }
  else {
    ...
    if (fade) {
      [RAREPlatformHelper setComponentAlphaWithRAREiPlatformComponent:component_ withFloat:small ? 1 - fraction : fraction];
    }
  }
}
