...
+ (id<RAREiPlatformComponentPainter>)createProgressPopupPainter {
  id o = [((RAREUIProperties *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getUIDefaults])) getWithNSString:@"Rare.ProgressPopup.background"];
...
+ (RAREPainterHolder *)createButtonPaintHolder {
  ...
  if (ph == nil) {
    ...
    if (((RAREPainterHolder *) nil_chk(ph))->disabledForegroundColor_ == nil) {
      ph->disabledForegroundColor_ = [RAREColorUtils getDisabledForeground];
    }
...
+ (RAREPainterHolder *)createComboBoxPaintHolder {
  ...
  if (ph == nil) {
    ...
    if (ph->normalPainter_ == nil) {
      ph->normalPainter_ = [[RAREPaintBucket alloc] initWithRAREiBackgroundPainter:(RAREUIBackgroundPainter *) check_class_cast([((RAREUIBackgroundPainter *) nil_chk([RAREUIBackgroundPainter BGCOLOR_GRADIENT_PAINTER_MID])) clone], [RAREUIBackgroundPainter class])];
    }
...
+ (RAREPainterHolder *)createPaintHolderFromAttributesWithRAREiWidget:(id<RAREiWidget>)context
  ...
  s = (NSString *) check_class_cast([attrs getWithId:@"disabledFgColor"], [NSString class]);
  if (s != nil) {
    dfg = [RAREColorUtils getColorWithNSString:s];
  }
  s = (NSString *) check_class_cast([attrs getWithId:@"fgColor"], [NSString class]);
  if (s != nil) {
    fg = [RAREColorUtils getColorWithNSString:s];
  }
  if ((fg == nil) && (dfg == nil) && (pb == nil) && (ppb == nil) && (rpb == nil) && (dpb == nil) && (icon == nil) && (sicon == nil) && (ricon == nil) && (dicon == nil) && (picon == nil)) {
    return nil;
  }
  ...
  ph->disabledForegroundColor_ = dfg;
  return ph;
}
...
+ (RAREPainterHolder *)createPaintHolderFromSequenceWithRAREiWidget:(id<RAREiWidget>)context
  ...
  s = [seq spot_elementForWithNSString:@"disabledFgColor"];
  if ([(id) s isKindOfClass:[SPOTPrintableString class]]) {
    dfg = [RAREColorUtils getColorWithNSString:[((SPOTPrintableString *) check_class_cast(s, [SPOTPrintableString class])) stringValue]];
  }
...
+ (RAREPainterHolder *)createRedHyperlinkPainterHolder {
  ...
  if (ph == nil) {
    ph = [[RAREPainterHolder alloc] init];
    [ph setForegroundColorWithRAREUIColor:[RAREUIColor RED]];
    [ph setDisabledForegroundColorWithRAREUIColor:[RAREColorUtils getDisabledVersionWithRAREUIColor:[RAREUIColor RED]]];
    RAREPaintBucket *pp = [[RAREPaintBucket alloc] init];
    [pp setForegroundColorWithRAREUIColor:[RAREColorUtils getPressedVersionWithRAREUIColor:[RAREUIColor RED]]];
    [ph setPressedPainterWithRAREPaintBucket:pp];
...
+ (RAREPainterHolder *)createSpinnerButtonPaintHolder {
  ...
  if (ph == nil) {
    ...
    if (ph->disabledForegroundColor_ == nil) {
      ph->disabledForegroundColor_ = [RAREColorUtils getDisabledForeground];
    }
    if (ph->normalPainter_ == nil) {
...
+ (RAREPaintBucket *)getUnpressedButtonPaintBucket {
  ...
  return [RAREColorUtils getPaintBucketWithNSString:@"Rare.background,Rare.backgroundDkShadow"];
}
...
+ (void)setPopupListRenderingDefaultsWithRAREiListHandler:(id<RAREiListHandler>)lh
  ...
  c = [p getColorWithNSString:@"Rare.ComboBox.list.disabledForeground"];
  if (c != nil) {
    c = [RAREColorUtils getListDisabledForeground];
  }
  if (c == nil) {
    c = [RAREColorUtils getDisabledForeground];
  }
  [list setDisabledColorWithRAREUIColor:c];
  ...
  [lh setRowHeightWithInt:[RAREScreenUtils toPlatformPixelHeightWithNSString:[RAREPlatformHelper getDefaultRowHeight] withRAREiPlatformComponent:list withFloat:100]];
}
...
- (void)paintWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  if (circleColor_ == nil) {
    ...
    if (disabledCircleColor_ == nil) {
      disabledCircleColor_ = [RAREaUILineBorder getDefaultDisabledColor];
    }
...
- (id)initWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)owner
  ...
  if (self = [super init]) {
    up_ = YES;
    iconSize_ = [RAREUIScreen platformPixelsWithInt:[RAREPlatform isTouchDevice] ? 20 : 12];
    self->up_ = up;
    self->owner_ = owner;
...
- (void)setIconSizeWithInt:(int)size {
  int n = [RAREUIScreen platformPixelsWithInt:[RAREPlatform isTouchDevice] ? 20 : 12];
  iconSize_ = [JavaLangMath maxWithInt:n withInt:size];
}
