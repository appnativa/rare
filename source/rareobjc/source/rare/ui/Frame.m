...
- (id<RAREiPlatformMenuBar>)getMenuBar {
  return (window_ == nil) ? nil : [window_ getMenuBar];
}
...
- (id<RAREiStatusBar>)getStatusBar {
  return (window_ == nil) ? nil : [window_ getStatusBar];
}
...
- (id<RAREiToolBarHolder>)getToolBarHolder {
  return (window_ == nil) ? nil : [window_ getiToolBarHolder];
}
...
- (void)repackAndCenter {
  if (!mainWindow_) {
    [((RAREWindow *) nil_chk(window_)) repackAndCenter];
  }
}
...
- (void)setBorderWithRAREiPlatformBorder:(id<RAREiPlatformBorder>)border {
  [((RAREWindow *) nil_chk(window_)) setBorderWithRAREiPlatformBorder:border];
}

- (void)setCancelableWithBoolean:(BOOL)cancelable {
  [((RAREWindow *) nil_chk(window_)) setCancelableWithBoolean:cancelable];
}
