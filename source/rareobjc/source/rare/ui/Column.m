...
- (void)setMarginWithInt:(int)top
                 ...
                 withInt:(int)left {
  if (insets_ == nil) {
    insets_ = [[RAREUIInsets alloc] initWithInt:top withInt:right withInt:bottom withInt:left];
  }
  else {
    (void) [insets_ setWithInt:top withInt:right withInt:bottom withInt:left];
  }
}
...
- (void)addMarginWithRAREUIInsets:(RAREUIInsets *)inArg {
  if (insets_ != nil) {
    (void) [((RAREUIInsets *) nil_chk(inArg)) addInsetsWithRAREUIInsets:insets_];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREColumn = { "Column", "com.appnativa.rare.ui", NULL, 0x1, 38, methods, 36, fields, 0, NULL};
  return &_RAREColumn;
}
