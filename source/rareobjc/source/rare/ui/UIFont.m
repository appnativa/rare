...
- (RAREUIFont *)deriveBold {
  ...
  RAREUIFont *f = [[RAREUIFont alloc] initWithId:[RAREUIFont deriveFontWithRAREUIFont:self withFloat:baseSize_ withBoolean:YES withBoolean:NO]];
...
- (RAREUIFont *)deriveFontWithInt:(int)style
  ...
  RAREUIFont *f = [[RAREUIFont alloc] initWithId:[RAREUIFont deriveFontWithRAREUIFont:self withFloat:size withBoolean:[RAREUIFont isBoldWithInt:style] withBoolean:[RAREUIFont isItalicWithInt:style]]];
  [f setUnderlineWithBoolean:underline_];
  [f setStrikeThroughWithBoolean:strikethrough_];
  return f;
}
...
- (RAREUIFont *)deriveFontSizeWithFloat:(float)size {
  ...
  RAREUIFont *f = [[RAREUIFont alloc] initWithId:[RAREUIFont deriveFontWithRAREUIFont:self withFloat:size withBoolean:[RAREUIFont isBoldWithInt:style_] withBoolean:[RAREUIFont isItalicWithInt:style_]]];
  [f setUnderlineWithBoolean:underline_];
  [f setStrikeThroughWithBoolean:strikethrough_];
  return f;
}
...
- (RAREUIFont *)deriveItalic {
  ...
  RAREUIFont *f = [[RAREUIFont alloc] initWithId:[RAREUIFont deriveFontWithRAREUIFont:self withFloat:size_ withBoolean:[self isBold] withBoolean:YES]];
  [f setUnderlineWithBoolean:underline_];
  [f setStrikeThroughWithBoolean:strikethrough_];
  return f;
}
...
- (RAREUIFont *)deriveRelativeFontWithFloat:(float)nrs {
  ...
  RAREUIFont *f = [[RAREUIFont alloc] initWithId:[RAREUIFont deriveFontWithRAREUIFont:self withFloat:sz withBoolean:[RAREUIFont isBoldWithInt:style_] withBoolean:[RAREUIFont isItalicWithInt:style_]]];
  f->relativeSize_ = nrs;
...
+ (id)deriveFontWithRAREUIFont:(RAREUIFont *)base
  ...
  return [RAREUIFont newFontWithNSString:((RAREUIFont *) nil_chk(base))->family_ withFloat:size withBoolean:bold withBoolean:italic];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "deriveFontWithRAREUIFont:withFloat:withBoolean:withBoolean:", NULL, "LNSObject", 0xa, NULL },
