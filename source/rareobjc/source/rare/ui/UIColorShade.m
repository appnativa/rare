...
static long long int RAREUIColorShade_colorChangeTime_;

+ (long long int)colorChangeTime {
  return RAREUIColorShade_colorChangeTime_;
}
...
- (id)getAPColor {
  if (myColorUpdateTime_ < RAREUIColorShade_colorChangeTime_) {
    proxy_ = nil;
  }
...
- (int)getColor {
  ...
  c = [((RAREUIColor *) nil_chk(sourceColor_)) getColor];
  if (c == cachedsourceColor_) {
    return cachedShadeColor_;
  }
  cachedsourceColor_ = c;
  proxy_ = nil;
...
- (RAREUIColor *)getDisabledColorWithRAREUIColor:(RAREUIColor *)def {
  if (colorStateList_ != nil) {
    return [colorStateList_ getDisabledColorWithRAREUIColor:def];
  }
  return def;
}
...
- (BOOL)isDynamic {
  return (colorKey_ != nil) || ((sourceColor_ != nil) && [sourceColor_ isDynamic]);
}
...
- (void)copyAllFieldsTo:(RAREUIColorShade *)other {
  ...
  other->cachedShadeColor_ = cachedShadeColor_;
  other->cachedsourceColor_ = cachedsourceColor_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "colorChangeTime_", NULL, 0x9, "J" },
    { "myColorUpdateTime_", NULL, 0x1, "J" },
  };
  static J2ObjcClassInfo _RAREUIColorShade = { "UIColorShade", "com.appnativa.rare.ui", NULL, 0x1, 12, methods, 2, fields, 0, NULL};
