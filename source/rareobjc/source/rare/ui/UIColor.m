...
- (RAREUIColor *)getDisabledColor {
  if (disabledColor_ == nil) {
    disabledColor_ = [RAREColorUtils getDisabledVersionWithRAREUIColor:self];
  }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREUIColor = { "UIColor", "com.appnativa.rare.ui", NULL, 0x1, 21, methods, 17, fields, 0, NULL};
  return &_RAREUIColor;
}
