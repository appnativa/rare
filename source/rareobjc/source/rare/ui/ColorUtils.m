...
static BOOL RAREColorUtils_KEEP_COLOR_KEYS_ = NO;
...
static float RAREColorUtils_disabledAlpha_ = 0.5f;

+ (BOOL)KEEP_COLOR_KEYS {
  return RAREColorUtils_KEEP_COLOR_KEYS_;
}

+ (BOOL *)KEEP_COLOR_KEYSRef {
  return &RAREColorUtils_KEEP_COLOR_KEYS_;
}
...
+ (float)disabledAlpha {
  return RAREColorUtils_disabledAlpha_;
}

+ (float *)disabledAlphaRef {
  return &RAREColorUtils_disabledAlpha_;
}

+ (void)clearCache {
  RAREColorUtils_foreground_ = nil;
  RAREColorUtils_background_ = nil;
  RAREColorUtils_backgroundBucket_ = nil;
  [RAREUtils clearCache];
  [RAREPainterUtils clearCache];
}
  ...
  if (tok != nil) {
    ...
    if (scanner->foundDelimiter_ < 1) {
      if (sc != nil) {
        ...
        if ((sc != nil) && RAREColorUtils_KEEP_COLOR_KEYS_ && !([sc isKindOfClass:[RAREUIColorShade class]])) {
          sc = [[RAREUIColorShade alloc] initWithRAREUIColor:sc withNSString:color];
        }
        if (alwaysUsePainter) {
  ...
  if (c == nil) {
    ...
    if (!([c isKindOfClass:[RAREUIColorShade class]])) {
      ...
      if ([nc isKindOfClass:[RAREUIColorShade class]]) {
        [cs copyShadeWithRAREUIColorShade:((RAREUIColorShade *) check_class_cast(nc, [RAREUIColorShade class]))];
      }
      else {
        [cs setToColorWithRAREUIColor:nc];
      }
    }
  }
}
...
+ (id<RAREiPlatformPainter>)getPainterWithRAREiWidget:(id<RAREiWidget>)context
                                 withRARESPOTGridCell:(RARESPOTGridCell *)gc {
  RAREPaintBucket *pb = [RAREColorUtils configureWithRAREiWidget:context withRARESPOTGridCell:gc withRAREPaintBucket:nil];
  return pb == nil ? nil : [pb getPainter];
}
...
+ (RAREUIColor *)getColorWithCharArray:(IOSCharArray *)color
  ...
  if ((c != nil) && (inc != 0)) {
    ...
    if (RAREColorUtils_KEEP_COLOR_KEYS_) {
      c = [[RAREUIColorShade alloc] initWithRAREUIColor:c withInt:inc];
    }
    else {
    ...
    alpha = (255 * alpha) / 100;
    if (RAREColorUtils_KEEP_COLOR_KEYS_) {
      RAREUIColorShade *cs = [[RAREUIColorShade alloc] initWithRAREUIColor:c withRAREColorUtils_ShadeEnum:[RAREColorUtils_ShadeEnum ALPHA]];
      [cs setAlphaWithInt:alpha];
      c = cs;
    }
    else {
...
+ (RAREUIColor *)getDisabledForeground {
  return [((RAREUIColor *) nil_chk([RAREColorUtils getForeground])) getDisabledColor];
}

+ (RAREUIColor *)getDisabledVersionWithRAREUIColor:(RAREUIColor *)fg {
  return [fg alphaWithInt:(int) ([((RAREUIColor *) nil_chk(fg)) getAlpha] * RAREColorUtils_disabledAlpha_)];
}

+ (float)getDisabledAplhaPercent {
  return RAREColorUtils_disabledAlpha_;
}

- (void)setDisabledAplhaPercentWithFloat:(float)percent {
  RAREColorUtils_disabledAlpha_ = percent;
}
...
+ (RAREUIColor *)getTextFieldForeground {
  RAREUIColor *fg = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.TextField.foreground"];
  return (fg == nil) ? [RAREUIColor BLACK] : fg;
}

+ (RAREUIColor *)getTextFieldBackground {
  RAREUIColor *fg = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.TextField.background"];
  return (fg == nil) ? [RAREUIColor WHITE] : fg;
}

+ (RAREUIColor *)getTextAreaForeground {
  RAREUIColor *fg = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.TextArea.foreground"];
  return (fg == nil) ? [RAREUIColor BLACK] : fg;
}

+ (RAREUIColor *)getTextAreaBackground {
  RAREUIColor *fg = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.TextArea.background"];
  return (fg == nil) ? [RAREUIColor WHITE] : fg;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getPainterWithRAREiWidget:withRARESPOTGridCell:", NULL, "LRAREiPlatformPainter", 0x9, NULL },
    ...
    { "getTextFieldForeground", NULL, "LRAREUIColor", 0x9, NULL },
    { "getTextFieldBackground", NULL, "LRAREUIColor", 0x9, NULL },
    { "getTextAreaForeground", NULL, "LRAREUIColor", 0x9, NULL },
    { "getTextAreaBackground", NULL, "LRAREUIColor", 0x9, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "disabledAlpha_", NULL, 0xa, "F" },
  };
  static J2ObjcClassInfo _RAREColorUtils = { "ColorUtils", "com.appnativa.rare.ui", NULL, 0x1, 48, methods, 20, fields, 0, NULL};
