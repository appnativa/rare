...
- (void)actionPerformedWithRAREActionEvent:(RAREActionEvent *)e {
  switch (actionType_) {
    ...
    [((id<RAREiFormViewer>) nil_chk([self getFormViewer])) submitFormWithRAREiFunctionCallback:nil];
    break;
    case RARESPOTPushButton_CActionType_clear_form:
    [((id<RAREiFormViewer>) nil_chk([self getFormViewer])) reloadForm];
    break;
    case RARESPOTPushButton_CActionType_popup_widget:
    [self showPopupWidget];
    break;
    case RARESPOTPushButton_CActionType_popup_menu:
    [self showPopupMenuWithInt:0 withInt:[self getHeight]];
    break;
    default:
    if ([self size] > 0) {
      togglePosition_++;
      if (togglePosition_ >= [self size]) {
        togglePosition_ = 0;
      }
      [self setValueWithId:[((RARERenderableDataItem *) nil_chk([self getWithInt:togglePosition_])) description]];
    }
...
- (void)configureExWithRARESPOTPushButton:(RARESPOTPushButton *)cfg {
  ...
  if ((actionType_ == RARESPOTPushButton_CActionType_popup_widget) || ([cfg->popupWidget_ getValue] != nil)) {
    [self removeActionListenerWithRAREiActionListener:self];
    [self addActionListenerWithRAREiActionListener:self];
    ...
    if (origPopupAttributes_ != nil) {
      ...
      if ((popupConfiguration_ == nil) && ([origPopupAttributes_ getWithId:@"url"] != nil)) {
        popupLink_ = [[RAREActionLink alloc] initWithRAREiWidget:self withNSString:[origPopupAttributes_ getWithId:@"url"] withNSString:nil];
      }
    }
    if (popupConfiguration_ != nil) {
  ...
  if ((pp != nil) || (sp != nil) || (dp != nil)) {
    ...
    if (p != nil) {
      ...
      if ([((SPOTPrintableString *) nil_chk(cfg->fgColor_)) getValue] != nil) {
        ...
        [((RAREPaintBucket *) nil_chk(((RAREPainterHolder *) nil_chk(p))->normalPainter_)) setForegroundColorWithRAREUIColor:fg];
        ...
        if ([p getForegroundWithRAREiPaintedButton_ButtonStateEnum:[RAREiPaintedButton_ButtonStateEnum DISABLED]] == nil) {
          [p setDisabledForegroundColorWithRAREUIColor:[RAREColorUtils getDisabledVersionWithRAREUIColor:fg]];
        }
      }
      [((id<RAREiPlatformComponentPainter>) nil_chk([self getComponentPainterWithBoolean:YES withBoolean:YES])) setPainterHolderWithRAREPainterHolder:p];
    }
...
- (void)disposeOfPopup {
  if (popupComponent_ != nil) {
    ...
    popupComponent_ = nil;
    if (popupWidget_ != nil) {
      [popupWidget_ setParentWithRAREiContainer:nil];
    }
  }
}
...
- (void)initializeListenersWithRAREaWidgetListener:(RAREaWidgetListener *)l {
  ...
  switch (actionType_) {
    ...
    [((id<RAREiActionComponent>) check_protocol_cast(dataComponent_, @protocol(RAREiActionComponent))) addActionListenerWithRAREiActionListener:self];
    return;
    default:
    break;
  }
...
- (void)showPopupWidgetEx {
  ...
  if (popupWidget_ == nil) {
    if ((popupConfiguration_ == nil) && (popupLink_ != nil)) {
      @try {
        (void) [RAREViewerCreator createConfigurationWithRAREiWidget:self withRAREActionLink:popupLink_ withRAREiFunctionCallback:[[RAREaPushButtonWidget_$2 alloc] initWithRAREaPushButtonWidget:self]];
      }
  ...
  [((id<RAREiPopup>) nil_chk(popupComponent_)) setTransientWithBoolean:YES];
  ...
  [((id<RAREiWidget>) nil_chk(popupWidget_)) setParentWithRAREiContainer:[self getParent]];
  ...
  [popupComponent_ addPopupMenuListenerWithRAREiPopupMenuListener:[[RAREaPushButtonWidget_$3 alloc] initWithRAREaPushButtonWidget:self]];
  if (popupBounds_ == nil) {
  ...
  if (shareBorder_) {
    ...
    if ((((RAREUIRectangle *) nil_chk(popupBounds_))->y_ == 0) || [RAREUTSNumber isEqualWithFloat:popupBounds_->y_ + popupBounds_->height_ + ((RAREUIDimension *) nil_chk(d))->height_ withFloat:[RAREScreenUtils PLATFORM_PIXELS_2]]) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaPushButtonWidget = { "aPushButtonWidget", "com.appnativa.rare.widget", NULL, 0x401, 22, methods, 26, fields, 0, NULL};
...
- (void)popupMenuWillBecomeInvisibleWithRAREExpansionEvent:(RAREExpansionEvent *)e {
  ...
  [RAREPlatform invokeLaterWithJavaLangRunnable:[[RAREaPushButtonWidget_$3_$1 alloc] initWithRAREaPushButtonWidget_$3:self]];
  [this$0_ resetButtonBorderAndBackground];
}
...
@end
@implementation RAREaPushButtonWidget_$3_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LRAREaPushButtonWidget_$3" },
  };
  static J2ObjcClassInfo _RAREaPushButtonWidget_$3_$1 = { "$1", "com.appnativa.rare.widget", "aPushButtonWidget$$3", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_RAREaPushButtonWidget_$3_$1;
}
