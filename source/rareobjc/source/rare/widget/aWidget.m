...
- (RAREColumn *)createColumnWithRARESPOTItemDescription:(RARESPOTItemDescription *)id_ {
  ...
  RARESPOTMargin *in = [id_ getContentPadding];
  if (in != nil) {
    [di setMarginWithRAREUIInsets:[in getInsets]];
  }
  ...
  if ((cell != nil) || (s != nil)) {
    ...
    if (cell != nil) {
      (void) [RAREColorUtils configureWithRAREiWidget:self withRARESPOTGridCell:cell withRAREPaintBucket:pb];
    }
    if (s != nil) {
  ...
  if (l != nil) {
    [di setActionListenerWithRAREiActionListener:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withRARESPOTLink:l]];
  }
  cell = [id_ getSelectionGridCell];
  if (cell != nil) {
    [di setItemSelectionPainterWithRAREPaintBucket:[RAREColorUtils configureWithRAREiWidget:self withRARESPOTGridCell:cell withRAREPaintBucket:nil]];
  }
  cell = [id_ getGridCell];
  if (cell != nil) {
    [di setItemPainterWithRAREPaintBucket:[RAREColorUtils configureWithRAREiWidget:self withRARESPOTGridCell:cell withRAREPaintBucket:nil]];
  }
  cell = [id_ getHeaderRolloverCell];
  if (cell != nil) {
    [di setHeaderRollOverPainterWithRAREPaintBucket:[RAREColorUtils configureWithRAREiWidget:self withRARESPOTGridCell:cell withRAREPaintBucket:nil]];
  }
  cell = [id_ getHeaderSelectionCell];
  if (cell != nil) {
    [di setHeaderSelectionPainterWithRAREPaintBucket:[RAREColorUtils configureWithRAREiWidget:self withRARESPOTGridCell:cell withRAREPaintBucket:nil]];
  }
...
- (void)dispose {
  ...
  @try {
    ...
    id<RAREiFormViewer> fv = [self getFormViewerEx];
    if (fv != nil) {
...
- (void)expandStringWithNSString:(NSString *)value
  ...
  @try {
    ...
    if (n == -1) {
      if (encode) {
        [RAREUTURLEncoder encodeComponentWithNSString:value withNSString:@"iso-8859-1" withJavaIoWriter:writer];
      }
      else {
...
- (void)handleActionLinkWithRAREActionLink:(RAREActionLink *)link
  ...
  @try {
    if ((widgetDataLink_ != nil) && (widgetDataLink_ != link)) {
      [widgetDataLink_ setContextWithRAREUTiURLResolver:nil];
    }
...
- (void)handleDataURLWithNSString:(NSString *)url {
  [self handleActionLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withNSString:url withNSString:nil] withBoolean:NO];
}

- (void)handleDataURLWithJavaNetURL:(JavaNetURL *)url {
  [self handleActionLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withJavaNetURL:url withNSString:nil] withBoolean:NO];
}

- (id<RAREiCancelableFuture>)handleDataURLWithNSString:(NSString *)url
                                           withBoolean:(BOOL)deferred {
  RAREActionLink *link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:self withNSString:url withNSString:nil];
  if (deferred) {
...
- (void)handleDataURLWithNSString:(NSString *)mimeType
  ...
  [self handleActionLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withNSString:url withNSString:mimeType] withBoolean:NO];
}

- (void)handleDataURLWithNSString:(NSString *)mimeType
                   withJavaNetURL:(JavaNetURL *)url {
  [self handleActionLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withJavaNetURL:url withNSString:mimeType] withBoolean:NO];
}

- (void)handleDataURLWithJavaNetURL:(JavaNetURL *)url
                        withBoolean:(BOOL)deferred {
  RAREActionLink *link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:self withJavaNetURL:url withNSString:nil];
  if (deferred) {
    [self loadStartedWithRAREActionLink:link];
...
+ (RARERenderableDataItem *)populateItemWithRAREiWidget:(id<RAREiWidget>)widget
  ...
  if (cell != nil) {
    RAREPaintBucket *pb = [[RAREPaintBucket alloc] init];
    (void) [RAREColorUtils configureWithRAREiWidget:widget withRARESPOTGridCell:cell withRAREPaintBucket:pb];
  ...
  if (l != nil) {
    [di setActionListenerWithRAREiActionListener:[[RAREActionLink alloc] initWithRAREUTiURLResolver:widget withRARESPOTLink:l]];
  }
  return di;
}
...
- (void)showPopupMenuWithInt:(int)x
  ...
  if (menu != nil) {
    if ([menu getActionScript] != nil) {
      (void) [RAREaWidgetListener evaluateWithRAREiWidget:self withRAREiScriptHandler:[self getScriptHandler] withId:[menu getActionScript] withJavaUtilEventObject:[[RAREExpansionEvent alloc] initWithId:menu withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_EXPAND]]];
    }
...
- (NSString *)toJSON {
  ...
  (void) [jw object];
  [self writeJSONValueWithRAREUTJSONWriter:jw];
  (void) [jw endObject];
  return [sw description];
}
...
- (void)triggerActionEventWithNSString:(NSString *)cmd {
  if (actionListener_ != nil) {
    [actionListener_ actionPerformedWithRAREActionEvent:[[RAREActionEvent alloc] initWithId:[self getDataComponent]]];
  }
  if (([self getWidgetListener] != nil) && [((RAREaWidgetListener *) nil_chk([self getWidgetListener])) isActionEventEnabled]) {
    [((RAREaWidgetListener *) nil_chk([self getWidgetListener])) actionPerformedWithRAREActionEvent:[[RAREActionEvent alloc] initWithId:[self getDataComponent]]];
  }
}
...
- (BOOL)writeHTTPValueWithBoolean:(BOOL)first
  ...
  @try {
    ...
    if ([value isKindOfClass:[NSString class]]) {
      ...
      [RAREUTURLEncoder encodeComponentWithNSString:name withNSString:@"iso-8859-1" withJavaIoWriter:writer];
      [((JavaIoWriter *) nil_chk(writer)) writeWithInt:'='];
      [RAREUTURLEncoder encodeComponentWithNSString:(NSString *) check_class_cast(value, [NSString class]) withNSString:@"iso-8859-1" withJavaIoWriter:writer];
      return YES;
    }
    else if ([value isKindOfClass:[IOSIntArray class]]) {
      ...
      return [RAREFormHelper writeHTTPValueWithBoolean:first withJavaIoWriter:writer withNSString:name withNSStringArray:(IOSObjectArray *) check_class_cast(value, [IOSObjectArray class]) withBoolean:YES];
    }
  }
  @catch (JavaIoIOException *e) {
    @throw [RAREApplicationException runtimeExceptionWithJavaLangThrowable:e];
...
- (BOOL)setAlphaWithFloat:(float)alpha {
  return [((id<RAREiPlatformComponent>) nil_chk([self getContainerComponent])) setAlphaWithFloat:alpha];
}

- (float)getAplha {
  return [((id<RAREiPlatformComponent>) nil_chk([self getContainerComponent])) getAlpha];
}

- (void)setActionListenerWithRAREiActionListener:(id<RAREiActionListener>)al {
  [super setActionListenerWithRAREiActionListener:al];
  if ([self conformsToProtocol: @protocol(RAREiActionable)]) {
    [((id<RAREiActionable>) check_protocol_cast(self, @protocol(RAREiActionable))) addActionListenerWithRAREiActionListener:al];
  }
}
...
- (void)setDataURLWithNSString:(NSString *)url {
  (void) [self setDataLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withNSString:url withNSString:nil] withBoolean:YES];
}

- (void)setDataURLWithJavaNetURL:(JavaNetURL *)url {
  (void) [self setDataLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withJavaNetURL:url withNSString:nil] withBoolean:YES];
}

- (id<RAREiCancelableFuture>)setDataURLWithNSString:(NSString *)url
                                        withBoolean:(BOOL)defer {
  return [self setDataLinkWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withNSString:url withNSString:nil] withBoolean:defer];
}
...
- (void)setNameWithNSString:(NSString *)name {
  ...
  if (p != nil) {
    ...
    if ((w != nil) && (w != self)) {
      ...
      (void) [p unregisterNamedItemWithNSString:widgetName_];
      [((id<RAREiFormViewer>) nil_chk([self getFormViewer])) unregisterFormWidgetWithRAREiWidget:self];
    }
    widgetName_ = name;
    (void) [p registerNamedItemWithNSString:name withId:self];
    (void) [((id<RAREiFormViewer>) nil_chk([self getFormViewer])) registerFormWidgetWithRAREiWidget:self];
  }
  else {
    widgetName_ = name;
  }
...
- (void)setParentWithRAREiContainer:(id<RAREiContainer>)parent {
  if ((id<RAREiWidget>) check_protocol_cast(parent, @protocol(RAREiWidget)) != self) {
    parentContainer_ = parent;
  }
}
...
- (void)setWidgetListenerWithRAREaWidgetListener:(RAREaWidgetListener *)listener {
  [self uninitializeListenersWithRAREaWidgetListener:widgetListener_];
  self->widgetListener_ = listener;
  if (listener != nil) {
    [self initializeListenersWithRAREaWidgetListener:listener];
  }
}
...
- (NSString *)resolvePotentialVariableOrFunctionWithNSString:(NSString *)value {
  unichar c = [((NSString *) nil_chk(value)) charAtWithInt:0];
  if ((c == '%') || (c == '@') || (c == '$')) {
    id o = [self getWidgetAttributeWithNSString:value];
...
- (id)getAttributeWithNSString:(NSString *)key {
  ...
  if ((c == 'u') && [key hasPrefix:[RAREiConstants UIPROPERTY_PREFIX]]) {
    key = [key substring:[((NSString *) nil_chk([RAREiConstants UIPROPERTY_PREFIX])) sequenceLength]];
    return [((RAREUIProperties *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([self getAppContext])) getUIDefaults])) getWithNSString:key];
  }
  if ((c == 'r') && [((NSString *) nil_chk(key)) hasPrefix:[RAREiConstants RESOURCE_PREFIX]]) {
    key = [key substring:[((NSString *) nil_chk([RAREiConstants RESOURCE_PREFIX])) sequenceLength]];
...
- (JavaNetURL *)getBaseURL {
  ...
  return [((id<RAREiViewer>) nil_chk(v)) getBaseURL];
}
...
- (id<RAREiFormViewer>)getFormViewer {
  id<RAREiContainer> c = [self findParent];
...
- (RAREUIImage *)getImageWithNSString:(NSString *)image {
  return [self getImageWithNSString:image withBoolean:[RAREPlatform isUIThread] withRAREUIDimension:nil withRAREiImagePainter_ScalingTypeEnum:nil withFloat:[RAREaPlatformHelper getUnscaledImageDensity]];
}

- (RAREUIImage *)getImageWithJavaNetURL:(JavaNetURL *)url {
  return [self getImageWithJavaNetURL:url withBoolean:[RAREPlatform isUIThread] withRAREUIDimension:nil withRAREiImagePainter_ScalingTypeEnum:nil withFloat:[RAREaPlatformHelper getUnscaledImageDensity]];
}
...
- (id<RAREiContainer>)findParent {
  if (parentContainer_ != nil) {
    return parentContainer_;
  }
  if (formComponent_ != nil) {
    id<RAREiParentComponent> pc = [formComponent_ getParent];
    id<RAREiWidget> w = (pc == nil) ? nil : [RAREPlatform findWidgetForComponentWithId:pc];
    if (w != self) {
      if ([(id) w conformsToProtocol: @protocol(RAREiContainer)]) {
        return (id<RAREiContainer>) check_protocol_cast(w, @protocol(RAREiContainer));
      }
      else if (w != nil) {
        return [w getParent];
      }
...
- (RAREWidgetContext *)getScriptingContextEx {
  return scriptingContex_;
}
...
- (BOOL)isAttached {
  return [self isDisposed] ? NO : [((id<RAREiPlatformComponent>) nil_chk([self getContainerComponent])) isDisplayable];
}
...
- (BOOL)isPopupMenuShowing {
  return (popupMenu_ != nil) && [popupMenu_ isShowing];
}
...
- (BOOL)isSubmittable {
  return isSubmittable__ && ![self isDisposed];
}
...
- (void)configureWithRARESPOTWidget:(RARESPOTWidget *)cfg
  ...
  if (map != nil) {
    widgetListener_ = [self createWidgetListenerWithRAREiWidget:self withJavaUtilMap:map withRAREiScriptHandler:[self getScriptHandler]];
  }
...
- (RAREActionLink *)createActionLinkWithRARESPOTLink:(RARESPOTLink *)link {
  return [[RAREActionLink alloc] initWithRAREUTiURLResolver:self withRARESPOTLink:link];
}
...
- (void)expandStringExWithNSString:(NSString *)value
  ...
  do {
    ...
    if (o != nil) {
      ...
      if (encode) {
        @try {
          [RAREUTURLEncoder encodeComponentWithNSString:s withNSString:@"ISO-8859-1" withJavaIoWriter:writer];
        }
        @catch (JavaIoIOException *e) {
          [RAREPlatform ignoreExceptionWithNSString:nil withJavaLangThrowable:e];
        }
...
- (void)finishedLoadingEx {
  ...
  if ((wl != nil) && [wl isEnabledWithNSString:[RAREiConstants EVENT_FINISHED_LOADING]]) {
    RAREEventBase *e = [[RAREEventBase alloc] initWithId:self];
...
- (void)handleDataURLWithRARESPOTWidget:(RARESPOTWidget *)cfg
  ...
  sourceURL_ = nil;
  RAREActionLink *ref = [RAREActionLink getActionLinkWithRAREUTiURLResolver:self withSPOTPrintableString:((RARESPOTWidget *) nil_chk(cfg))->dataURL_ withInt:0];
  [self startedParsing];
  if (deferred) {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "resolvePotentialVariableOrFunctionWithNSString:", NULL, "LNSString", 0x1, NULL },
    ...
    { "getFormViewerEx", NULL, "LRAREiFormViewer", 0x4, NULL },
    ...
    { "findParent", NULL, "LRAREiContainer", 0x1, NULL },
    ...
    { "getScriptingContextEx", NULL, "LRAREWidgetContext", 0x1, NULL },
    ...
    { "isPopupMenuShowing", NULL, "Z", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREaWidget = { "aWidget", "com.appnativa.rare.widget", NULL, 0x401, 222, methods, 35, fields, 0, NULL};
  return &_RAREaWidget;
}
