...
- (void)expandStringWithNSString:(NSString *)value
  ...
  @try {
    ...
    if (n == -1) {
      if (encode) {
        [RAREUTURLEncoder encodeWithNSString:value withNSString:@"iso-8859-1" withJavaIoWriter:writer];
      }
      else {
...
- (BOOL)writeHTTPValueWithBoolean:(BOOL)first
  ...
  @try {
    ...
    if ([value isKindOfClass:[NSString class]]) {
      ...
      [((JavaIoWriter *) nil_chk(writer)) writeWithInt:'='];
      [RAREUTURLEncoder encodeWithNSString:(NSString *) check_class_cast(value, [NSString class]) withNSString:@"iso-8859-1" withJavaIoWriter:writer];
      return YES;
    }
    else if ([value isKindOfClass:[IOSIntArray class]]) {
...
- (void)expandStringExWithNSString:(NSString *)value
  ...
  do {
    ...
    if (o != nil) {
      ...
      if (encode) {
        @try {
          [RAREUTURLEncoder encodeWithNSString:s withNSString:@"ISO-8859-1" withJavaIoWriter:writer];
        }
        @catch (JavaIoIOException *e) {
          [RAREPlatform ignoreExceptionWithNSString:nil withJavaLangThrowable:e];
        }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaWidget = { "aWidget", "com.appnativa.rare.widget", NULL, 0x401, 223, methods, 36, fields, 0, NULL};
  return &_RAREaWidget;
}
