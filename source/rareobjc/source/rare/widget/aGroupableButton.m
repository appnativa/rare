...
- (void)addActionListenerWithRAREiActionListener:(id<RAREiActionListener>)l {
  ...
  [((id<RAREiActionComponent>) nil_chk(b)) removeActionListenerWithRAREiActionListener:l];
  [b addActionListenerWithRAREiActionListener:l];
}
...
- (void)addChangeListenerWithRAREiChangeListener:(id<RAREiChangeListener>)l {
  ...
  [b addChangeListenerWithRAREiChangeListener:l];
}
