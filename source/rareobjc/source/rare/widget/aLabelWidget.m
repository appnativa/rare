...
- (id<RAREiHyperlinkListener>)createHyperlinkListener {
  return [[RAREaLabelWidget_$1 alloc] initWithRAREaLabelWidget:self];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "createHyperlinkListener", NULL, "LRAREiHyperlinkListener", 0x4, NULL },
    { "createActionComponentWithRARESPOTLabel:", NULL, "LRAREiActionComponent", 0x404, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "initialValue_", NULL, 0x4, "LNSString" },
  };
  static J2ObjcClassInfo _RAREaLabelWidget = { "aLabelWidget", "com.appnativa.rare.widget", NULL, 0x401, 9, methods, 1, fields, 0, NULL};
  return &_RAREaLabelWidget;
}

@end
@implementation RAREaLabelWidget_$1
...
- (void)linkExitedWithId:(id)source
  ...
  if ((l != nil) && [l isChangeEventEnabled]) {
    RAREItemChangeEvent *ce = [[RAREItemChangeEvent alloc] initWithId:[this$0_ getDataComponent] withId:href withId:nil];
    [l itemChangedWithRAREItemChangeEvent:ce];
  }
}
...
- (void)linkEnteredWithId:(id)source
  ...
  RAREaWidgetListener *l = [this$0_ getWidgetListener];
  if ((l != nil) && [l isChangeEventEnabled]) {
    RAREItemChangeEvent *ce = [[RAREItemChangeEvent alloc] initWithId:[this$0_ getDataComponent] withId:nil withId:href];
    [l itemChangedWithRAREItemChangeEvent:ce];
  }
}
...
- (void)linkClickedWithId:(id)source
  ...
  if ((l != nil) && [l isActionEventEnabled]) {
    [l actionPerformedWithRAREActionEvent:[[RAREActionEvent alloc] initWithId:[this$0_ getDataComponent] withNSString:href]];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LRAREaLabelWidget" },
  };
  static J2ObjcClassInfo _RAREaLabelWidget_$1 = { "$1", "com.appnativa.rare.widget", "aLabelWidget", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_RAREaLabelWidget_$1;
}
