...
+ (NSString *)getWidgetAttributeWithRAREiListHandler:(id<RAREiListHandler>)listComponent
  ...
  int row = -1;
  if (n != -1) {
    row = [RAREUTSNumber intValueWithNSString:[name substring:n + 1]];
  ...
  if (row != -1) {
    ...
    if ([((NSString *) nil_chk(name)) isEqual:[RAREiConstants WIDGET_ATT_SELECTION_ROWS]]) {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getWidgetAttributeWithRAREiListHandler:withNSString:", NULL, "LNSString", 0x9, NULL },
