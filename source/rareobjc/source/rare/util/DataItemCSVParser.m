...
- (void)parseItemWithRAREiWidget:(id<RAREiWidget>)context
  ...
  SDFNode *node = [SDFNode parseWithJavaIoReader:reader withRAREUTiURLResolver:[((id<RAREiWidget>) nil_chk(context)) getURLResolver] withNSString:nil withBoolean:NO];
