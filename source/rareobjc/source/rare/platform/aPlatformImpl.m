...
- (id)createChartHandler {
  return [self createObjectWithNSString:@"com.appnativa.rare.ui.chart.coreplot.ChartHandler"];
}
...
- (id)createObjectWithNSString:(NSString *)className_ {
  @try {
    return [((IOSClass *) nil_chk([RAREaPlatformHelper loadClassWithNSString:className_])) newInstance];
  }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "createObjectWithNSString:", NULL, "LNSObject", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREaPlatformImpl = { "aPlatformImpl", "com.appnativa.rare.platform", NULL, 0x401, 50, methods, 3, fields, 0, NULL};
