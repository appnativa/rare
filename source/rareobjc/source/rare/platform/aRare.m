...
- (void)configureWithRARESPOTApplication:(RARESPOTApplication *)app
  ...
  RAREActionLink *link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->lookAndFeelPropertiesURL_ withInt:0];
  if (link != nil) {
    if ([@"true" isEqual:[((SPOTPrintableString *) nil_chk(app->lookAndFeelPropertiesURL_)) spot_getAttributeWithNSString:@"keep_color_keys"]]) {
      (*[RAREColorUtils KEEP_COLOR_KEYSRef]) = YES;
    }
    @try {
  ...
  @try {
    ...
    SPOTSet *set;
    link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->attributesURL_ withInt:0];
    if (link != nil) {
    ...
    link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->resourceStringsURL_ withInt:0];
    if (link != nil) {
      ...
      link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->resourceStringsURL_ withInt:1];
      if (link != nil) {
        @try {
    ...
    NSString *value;
    link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->resourceIconsURL_ withInt:0];
    if (link != nil) {
      ...
      link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->resourceIconsURL_ withInt:1];
      if (link != nil) {
        @try {
    ...
    RAREUIImageIcon *ic = [((id<RAREiPlatformAppContext>) nil_chk(appContext_)) getResourceAsIconExWithNSString:@"Rare.icon.list.editorCheckedIcon"];
    if (ic == nil) {
      ...
      (void) [appContext_ addResourceIconWithNSString:@"Rare.icon.list.editorCheckedIcon" withRAREUIImageIcon:ic];
    }
    ic = [appContext_ getResourceAsIconExWithNSString:@"Rare.icon.list.editorUncheckedIcon"];
    if (ic == nil) {
      ...
      (void) [appContext_ addResourceIconWithNSString:@"Rare.icon.list.editorUncheckedIcon" withRAREUIImageIcon:ic];
    }
    int len;
    link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->actionItemsURL_ withInt:0];
    if (link != nil) {
    ...
    link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:v withSPOTPrintableString:app->dataCollectionsURL_ withInt:0];
    if (link != nil) {
...
- (JavaNetURL *)createURLWithRAREiPlatformAppContext:(id<RAREiPlatformAppContext>)app
  ...
  if ([url hasPrefix:[RAREiConstants INLINE_PREFIX]]) {
    return [RAREInlineURLConnection createURLWithNSString:[url substring:[RAREiConstants INLINE_PREFIX_LENGTH]]];
  }
  if (context == nil) {
...
- (NSString *)loadScriptCodeWithRAREActionLink:(RAREActionLink *)link
  ...
  @try {
    if ([((RAREActionLink *) nil_chk(link)) isInlineURL]) {
      ...
      JavaNetURL *url = [link getURLWithRAREUTiURLResolver:[self getRootViewer]];
      if (url != nil) {
...
- (NSString *)getScriptTypeWithRAREActionLink:(RAREActionLink *)link {
  @try {
    ...
    if ((type == nil) || [((NSString *) nil_chk([RAREiConstants TEXT_MIME_TYPE])) isEqual:type] || [((NSString *) nil_chk([RAREiConstants OCTET_MIME_TYPE])) isEqual:type]) {
      NSString *s = [((JavaNetURL *) nil_chk([link getURLWithRAREUTiURLResolver:context])) toExternalForm];
      int n = [((NSString *) nil_chk(s)) lastIndexOf:'.'];
      if (n > -1) {
...
- (void)handleConfigurationLocaleURLsWithRARESPOTApplication:(RARESPOTApplication *)app
  ...
  if ([@"true" equalsIgnoreCase:[((SPOTPrintableString *) nil_chk(url)) spot_getAttributeWithNSString:@"localeSensitive"]]) {
    ...
    if ((lp != nil) && ((int) [lp count] > 0)) {
      ...
      for (int i = 0; i < (int) [lp count]; i++) {
        ...
        link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withNSString:[sb description] withNSString:nil];
        @try {
  ...
  if (link == nil) {
    link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:url];
  }
  if (link != nil) {
...
- (void)handleConfigurationURLsWithRARESPOTApplication:(RARESPOTApplication *)app {
  ...
  if (multiScreenSupport_) {
    ...
    scriptContextURL = [link getURLWithRAREUTiURLResolver:context];
    [link close];
  }
  ...
  RAREActionLink *link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:app->attributesURL_];
  if (link != nil) {
    (void) [((SPOTPrintableString *) nil_chk(app->attributesURL_)) spot_setLinkedDataWithId:link];
  }
  link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:app->dataCollectionsURL_];
  if (link != nil) {
    (void) [((SPOTPrintableString *) nil_chk(app->dataCollectionsURL_)) spot_setLinkedDataWithId:link];
  }
  link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:app->lookAndFeelPropertiesURL_];
  if (link != nil) {
  ...
  if (mb != nil) {
    link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:mb->dataURL_];
    if (link != nil) {
  ...
  if (sb != nil) {
    link = [RAREActionLink createInlineLinkIfNecessaryWithRAREUTiURLResolver:context withSPOTPrintableString:sb->dataURL_];
    if (link != nil) {
