...
- (void)ignoreExceptionWithNSString:(NSString *)msg
  ...
  if ([RARERare isDebugEnabled]) {
    if ((msg != nil) && (e == nil)) {
      [RARERare logWithJavaUtilLoggingLevel:[JavaUtilLoggingLevel FINE] withNSString:msg withJavaLangThrowable:nil];
    }
    else if (e != nil) {
      if (msg == nil) {
        msg = @"ignoreException";
      }
      [RARERare logWithJavaUtilLoggingLevel:[JavaUtilLoggingLevel FINE] withNSString:msg withJavaLangThrowable:e];
    }
  }
}
...
+ (void)logWithJavaUtilLoggingLevel:(JavaUtilLoggingLevel *)level
  ...
  RAREAppContext *app = [RAREAppContext getContext];
  JavaUtilLoggingLogger *l = [((RAREAppContext *) nil_chk(app)) getLogger];
  if (throwable == nil) {
    if (msg != nil) {
      [((JavaUtilLoggingLogger *) nil_chk(l)) logWithJavaUtilLoggingLevel:level withNSString:msg];
    }
  }
  else {
    [((JavaUtilLoggingLogger *) nil_chk(l)) logWithJavaUtilLoggingLevel:level withNSString:msg withJavaLangThrowable:throwable];
  }
}

+ (void)logWarningWithNSString:(NSString *)msg
         withJavaLangThrowable:(JavaLangThrowable *)throwable {
  [RARERare logWithJavaUtilLoggingLevel:[JavaUtilLoggingLevel WARNING] withNSString:msg withJavaLangThrowable:throwable];
}
...
- (void)exitEx {
  ...
  @catch (JavaLangThrowable *e) {
    [RARERare logWarningWithNSString:@"Shutdown Error" withJavaLangThrowable:e];
  }
}
...
- (void)setupSelectionPainterWithRARESPOTGridCell:(RARESPOTGridCell *)gc {
  if (gc != nil) {
    selectionPainter_ = [RAREUIColorHelper configureWithRAREiWidget:[self getRootViewer] withRARESPOTGridCell:gc withRAREPaintBucket:nil];
  }
  else {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RARERare = { "Rare", "com.appnativa.rare.platform.apple", NULL, 0x1, 28, methods, 2, fields, 0, NULL};
  return &_RARERare;
}
