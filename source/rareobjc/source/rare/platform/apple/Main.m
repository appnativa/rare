...
- (void)dumpWithJavaNetURL:(JavaNetURL *)url
  ...
  @try {
    ...
    [pw flush];
    SDFNode *node = [SDFNode parseForReformatWithJavaIoReader:[[JavaIoStringReader alloc] initWithNSString:[sw description]] withRAREUTiURLResolver:nil withNSString:file];
