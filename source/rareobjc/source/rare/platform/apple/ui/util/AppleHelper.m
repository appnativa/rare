...
+ (id<RAREiPlatformComponent>)configureScrollPaneWithRAREiWidget:(id<RAREiWidget>)widget
  ...
  if ((v != nil) && ([sp hasColumnWidgets] || [sp hasRowWidgets])) {
    ...
    if (w != nil) {
      ...
      [bp setTopViewWithRAREiPlatformComponent:[w getContainerComponent]];
      [RAREAppleHelper setScrollComponentViewWithRAREiPlatformComponent:fc withRAREView:view withRAREiPlatformComponent:[w getContainerComponent] withRARELocationEnum:[RARELocationEnum TOP]];
    }
    wc = (RARESPOTWidget *) check_class_cast([((SPOTAny *) nil_chk(sp->columnFooter_)) getValue], [RARESPOTWidget class]);
    w = [RAREAppleHelper getWidgetWithRAREiWidget:widget withRARESPOTWidget:wc];
    if (w != nil) {
      [v registerOrphanWidgetWithRAREiWidget:w];
      [bp setBottomViewWithRAREiPlatformComponent:[w getContainerComponent]];
      [RAREAppleHelper setScrollComponentViewWithRAREiPlatformComponent:fc withRAREView:view withRAREiPlatformComponent:[w getContainerComponent] withRARELocationEnum:[RARELocationEnum BOTTOM]];
    }
    wc = (RARESPOTWidget *) check_class_cast([((SPOTAny *) nil_chk(sp->rowFooter_)) getValue], [RARESPOTWidget class]);
    w = [RAREAppleHelper getWidgetWithRAREiWidget:widget withRARESPOTWidget:wc];
    if (w != nil) {
      [v registerOrphanWidgetWithRAREiWidget:w];
      [bp setRightViewWithRAREiPlatformComponent:[w getContainerComponent]];
      [RAREAppleHelper setScrollComponentViewWithRAREiPlatformComponent:fc withRAREView:view withRAREiPlatformComponent:[w getContainerComponent] withRARELocationEnum:[RARELocationEnum RIGHT]];
    }
    wc = (RARESPOTWidget *) check_class_cast([((SPOTAny *) nil_chk(sp->rowHeader_)) getValue], [RARESPOTWidget class]);
    w = [RAREAppleHelper getWidgetWithRAREiWidget:widget withRARESPOTWidget:wc];
    if (w != nil) {
      [v registerOrphanWidgetWithRAREiWidget:w];
      [bp setLeftViewWithRAREiPlatformComponent:[w getContainerComponent]];
      [RAREAppleHelper setScrollComponentViewWithRAREiPlatformComponent:fc withRAREView:view withRAREiPlatformComponent:[w getContainerComponent] withRARELocationEnum:[RARELocationEnum LEFT]];
    }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREAppleHelper = { "AppleHelper", "com.appnativa.rare.platform.apple.ui.util", NULL, 0x1, 6, methods, 1, fields, 0, NULL};
