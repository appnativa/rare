...
- (IOSIntArray *)getSelectedIndexes {
  if ([(id) listView_ isKindOfClass:[RAREaTableBasedView class]]) {
    return [((RAREaTableBasedView *) check_class_cast(listView_, [RAREaTableBasedView class])) getSelectedIndexes];
  }
  return nil;
}
...
- (IOSIntArray *)getCheckedIndexes {
  if ([(id) listView_ isKindOfClass:[RAREListView class]]) {
    return [((RAREListView *) check_class_cast(listView_, [RAREListView class])) getCheckedIndexes];
  }
  return nil;
}
...
- (int)getSelectedIndexCount {
  if ([(id) listView_ isKindOfClass:[RAREaTableBasedView class]]) {
    return [((RAREaTableBasedView *) check_class_cast(listView_, [RAREaTableBasedView class])) getSelectedIndexCount];
  }
  return 0;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaPlatformListHandler = { "aPlatformListHandler", "com.appnativa.rare.platform.apple.ui", NULL, 0x401, 14, methods, 0, NULL, 0, NULL};
