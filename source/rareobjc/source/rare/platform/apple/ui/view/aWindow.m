...
- (void)repackAndCenter {
  ...
  RAREUIDimension *osize = [self getSize];
  if (![size isEqual:osize]) {
    [self setSizeExWithFloat:size->width_ withFloat:size->height_];
    [self centerOnScreen];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaWindow = { "aWindow", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x401, 52, methods, 9, fields, 0, NULL};
  return &_RAREaWindow;
}
