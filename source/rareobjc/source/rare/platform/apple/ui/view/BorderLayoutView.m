...
- (void)addWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)c
  ...
  RAREJGCellConstraints *cc = [RAREaBorderPanel getConstraintsWithRARELocationEnum:constraints withBoolean:useCrossPattern_ withBoolean:topBottomPriority_];
  cc = (RAREJGCellConstraints *) check_class_cast([((RAREJGCellConstraints *) nil_chk(cc)) clone], [RAREJGCellConstraints class]);
  if (padding_ != nil) {
    ((RAREJGCellConstraints *) nil_chk(cc))->insets_ = padding_;
  }
...
- (id<RAREiPlatformComponent>)getComponentAtWithRARELocationEnum:(RARELocationEnum *)location {
  RAREJGCellConstraints *cc = [RAREaBorderPanel getConstraintsWithRARELocationEnum:location withBoolean:useCrossPattern_ withBoolean:topBottomPriority_];
  if (cc == nil) {
    return nil;
  }
