...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaTableBasedView = { "aTableBasedView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x401, 56, methods, 47, fields, 0, NULL};
...
- (void)paintBackgroundWithRAREAppleGraphics:(RAREAppleGraphics *)g
  ...
  if ([self isPressed]) {
    RAREPaintBucket *pb = [((RAREListItemRenderer *) nil_chk(this$0_->itemRenderer_)) getPressedPaint];
    if (pb != nil) {
  ...
  else if (!editing_ && [self isSelected]) {
    RAREPaintBucket *pb = [((RAREListItemRenderer *) nil_chk(this$0_->itemRenderer_)) getSelectionPaintForExternalPainterWithBoolean:NO];
    if (pb != nil) {
      [RAREaUIComponentPainter paintWithRAREiPlatformGraphics:g withFloat:sx withFloat:rect->y_ withFloat:ex - sx withFloat:height withRAREPaintBucket:pb];
    }
  }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaTableBasedView_RowView = { "RowView", "com.appnativa.rare.platform.apple.ui.view", "aTableBasedView", 0x1, 6, methods, 7, fields, 0, NULL};
