...
- (void)updateForColorChange {
  if (componentPainter_ != nil) {
    [componentPainter_ updateModCount];
    [self updateComponentPainter];
  }
}
...
- (void)updateComponentPainter {
  id<RAREiPlatformComponentPainter> cp = componentPainter_;
  if ([self isUsePainterBorder]) {
...
- (void)updateForStateChangeWithRAREiPlatformBorder:(id<RAREiPlatformBorder>)border {
  [self handleBorderWithRAREiPlatformBorder:border];
}
...
- (RAREUIColor *)getBackgroundColorAlways {
  ...
  RAREView *p = [self getParent];
  if (p == nil) {
    return [RAREColorUtils getBackground];
  }
  return [((RAREView *) nil_chk(p)) getBackgroundColorAlways];
}
...
- (RAREUIFont *)getFontAlways {
  ...
  return [((RAREView *) nil_chk(p)) getFontAlways];
}
...
- (RAREUIColor *)getForegroundColorAlways {
  ...
  return [((RAREView *) nil_chk(p)) getForegroundColorAlways];
}
...
- (void)checkForegroundColor {
  ...
  else if (foregroundColor_ != nil) {
    [self setForegroundColorExWithRAREUIColor:[foregroundColor_ getColorWithRAREiPaintedButton_ButtonStateEnum:enabled_ ? [RAREiPaintedButton_ButtonStateEnum DEFAULT] : [RAREiPaintedButton_ButtonStateEnum DISABLED]]];
  }
}
...
- (void)handleBorderWithRAREiPlatformBorder:(id<RAREiPlatformBorder>)border {
  ...
  if ([(id) b isKindOfClass:[RAREUICompoundBorder class]]) {
    ...
    if ([(id) ib isKindOfClass:[RAREUIEmptyBorder class]]) {
      ...
      if ([((RAREUILineBorder *) nil_chk(lb)) usesPath]) {
        [self setPathLineBorderWithRAREUIColor:[lb getPaintColorWithRAREiPlatformComponent:component_] withFloat:[lb getPathWidth] withNSString:[lb getLineStyle]];
  ...
  if ([(id) b isKindOfClass:[RAREUILineBorder class]]) {
    ...
    if ([((RAREUILineBorder *) nil_chk(lb)) canUseMainLayer]) {
      [self setLineBorderWithRAREUIColor:[lb getPaintColorWithRAREiPlatformComponent:component_] withFloat:[lb getPathWidth] withFloat:[lb getArcHeight]];
      return;
    }
    else if ([lb usesPath]) {
      [self setPathLineBorderWithRAREUIColor:[lb getPaintColorWithRAREiPlatformComponent:component_] withFloat:[lb getPathWidth] withNSString:[lb getLineStyle]];
...
- (void)visibilityChangedWithBoolean:(BOOL)shown {
  if (viewListener_ != nil) {
    if (shown && ([self getHeight] == 0)) {
      if (visibilityRunner_ == nil) {
        visibilityRunner_ = [[RAREaView_$1 alloc] initWithRAREaView:self];
      }
      [RAREPlatform invokeLaterWithJavaLangRunnable:visibilityRunner_ withInt:10];
      return;
    }
    [self visibilityChangedExWithBoolean:shown];
  }
}
...
- (BOOL)imagePainterCheckedAndOkToAddWithRAREiPlatformPainter:(id<RAREiPlatformPainter>)p {
  if ([(id) p isKindOfClass:[RAREUIImagePainter class]]) {
    RAREUIImagePainter *ip = (RAREUIImagePainter *) check_class_cast(p, [RAREUIImagePainter class]);
    if (([((RAREUIImagePainter *) nil_chk(ip)) getImage] != nil) && [((RAREUIImage *) nil_chk([ip getImage])) isImageLoadedWithRAREiImageObserver:nil]) {
      return YES;
    }
    return NO;
  }
...
- (void)copyAllFieldsTo:(RAREaView *)other {
  ...
  other->visibilityRunner_ = visibilityRunner_;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "updateComponentPainter", NULL, "V", 0x4, NULL },
    ...
    { "getParent", NULL, "LRAREView", 0x401, NULL },
    ...
    { "getHeight", NULL, "F", 0x401, NULL },
    { "getWidth", NULL, "F", 0x401, NULL },
    ...
    { "visibilityChangedExWithBoolean:", NULL, "V", 0x4, NULL },
  ...
  static J2ObjcClassInfo _RAREaView = { "aView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x401, 90, methods, 34, fields, 0, NULL};
  return &_RAREaView;
}

@end
@implementation RAREaView_$1

- (void)run {
  [this$0_ visibilityChangedExWithBoolean:YES];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LRAREaView" },
  };
  static J2ObjcClassInfo _RAREaView_$1 = { "$1", "com.appnativa.rare.platform.apple.ui.view", "aView", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_RAREaView_$1;
}
