...
- (void)hideRowEditingComponentWithBoolean:(BOOL)animate {
  int row = editingRow_;
  if ((row > -1) && (rowEditModeListener_ != nil)) {
    [rowEditModeListener_ itemWillCollapseWithRAREExpansionEvent:[[RAREExpansionEvent alloc] initWithId:editingComponent_ withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_COLLAPSE]]];
  }
  editingRow_ = -1;
  if (row > -1) {
...
withRAREaTableBasedView_RowView:(RAREaTableBasedView_RowView *)view
  ...
  if (c != nil) {
    ...
    c = [((id<RAREiPlatformRenderingComponent>) nil_chk(rc)) getComponentWithJavaLangCharSequence:text withRARERenderableDataItem:item];
  }
  ...
  if (!fixedRowSize_) {
    ...
    (void) [((id<RAREiPlatformComponent>) nil_chk(c)) getPreferredSizeWithRAREUIDimension:size withFloat:width];
    int rh = (int) [JavaLangMath ceilWithDouble:((RAREUIDimension *) nil_chk(size))->height_] + 8;
    if (rh < effectiveMinRowHeight_) {
      rh = -effectiveMinRowHeight_;
    }
    [item setHeightWithInt:[JavaLangMath maxWithInt:rh withInt:[self getRowHeight]]];
  }
}
...
- (void)startEditingWithBoolean:(BOOL)animate
    ...
    BOOL isDelete = NO;
    {
      ...
      while (b__ < e__) {
        ...
        if ([@"Rare.action.delete" equalsIgnoreCase:[((RAREUIAction *) nil_chk(a)) getActionName]]) {
          if ([a getActionListener] == nil) {
            [a setActionListenerWithRAREiActionListener:[[RAREListView_$1 alloc] initWithRAREListView:self]];
          }
          if ([a getActionText] == nil) {
            [a setActionTextWithJavaLangCharSequence:[RAREPlatform getResourceAsStringWithNSString:@"Rare.action.delete"]];
          }
  ...
  if (editModeListener_ != nil) {
    [editModeListener_ itemWillExpandWithRAREExpansionEvent:[[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_EXPAND]]];
  }
}

- (void)stopEditingWithBoolean:(BOOL)animate {
  if (editModeListener_ != nil) {
    [editModeListener_ itemWillCollapseWithRAREExpansionEvent:[[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_COLLAPSE]]];
  }
  self->editing_ = NO;
...
- (void)setRowEditingComponentWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)c
  ...
  if (c != nil) {
    ...
    [self setRowEditingGestureListenerWithRAREiGestureListener:nil];
  }
}
...
- (void)setSelectedIndexWithInt:(int)index {
  ...
  if (index > -1 && linkedSelection_ && (checkListManager_ != nil)) {
    if (![checkListManager_ isRowCheckedWithInt:index]) {
      [self toggleCheckedStateWithInt:index];
    }
  }
...
- (IOSIntArray *)getCheckedIndexes {
  if (checkListManager_ != nil) {
    return [checkListManager_ getCheckedIndexesWithJavaUtilList:listModel_];
  }
  return nil;
}
...
- (id<RAREiExpansionListener>)getEditModeListener {
  return editModeListener_;
}
...
- (void)getPreferredSizeWithRAREUIDimension:(RAREUIDimension *)size
  ...
  int h = [RARETableHelper getPreferredListHeightWithRAREiPlatformComponent:component_ withInt:[JavaLangMath maxWithInt:minVisibleRows_ withInt:visibleRows_] withInt:rowHeight_ withInt:[self getRowCount]];
...
- (id<RAREiExpansionListener>)getRowEditModeListener {
  return rowEditModeListener_;
}

- (void)setRowEditModeListenerWithRAREiExpansionListener:(id<RAREiExpansionListener>)rowEditModeListener {
  self->rowEditModeListener_ = rowEditModeListener;
}
...
- (BOOL)isEditModeItemMarkedWithInt:(int)index {
  return [((id<RAREiPlatformListDataModel>) nil_chk(listModel_)) editModeIsItemMarkedWithInt:index];
}
...
- (void)clearEditModeMarks {
  [((id<RAREiPlatformListDataModel>) nil_chk(listModel_)) editModeClearMarks];
  if (editing_) {
    [self updateActions];
    [self repaint];
  }
...
- (void)setEditModeItemMarkWithInt:(int)index
  ...
  if ([((id<RAREiPlatformListDataModel>) nil_chk(listModel_)) editModeIsItemMarkedWithInt:index] != mark) {
    [listModel_ editModeChangeMarkWithInt:index withBoolean:mark];
    if (editing_) {
      [self updateActions];
      [self repaint];
    }
...
- (void)toggleEditModeItemMarkWithInt:(int)index {
  [self setEditModeItemMarkWithInt:index withBoolean:![((id<RAREiPlatformListDataModel>) nil_chk(listModel_)) editModeIsItemMarkedWithInt:index]];
}
...
- (void)copyAllFieldsTo:(RAREListView *)other {
  ...
  other->editModeListener_ = editModeListener_;
  ...
  other->rowEditModeListener_ = rowEditModeListener_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getEditModeListener", NULL, "LRAREiExpansionListener", 0x1, NULL },
    ...
    { "getRowEditModeListener", NULL, "LRAREiExpansionListener", 0x1, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "editModeListener_", NULL, 0x4, "LRAREiExpansionListener" },
  ...
  static J2ObjcClassInfo _RAREListView = { "ListView", "com.appnativa.rare.platform.apple.ui.view", NULL, 0x1, 41, methods, 16, fields, 0, NULL};
...
- (void)onFlingWithId:(id)view
  ...
  if (this$0_->editingRow_ == -1) {
    if ([e1 getX] > [((RAREMouseEvent *) nil_chk(e2)) getX]) {
      ...
      [this$0_ clearSelections];
      if (this$0_->rowEditModeListener_ != nil) {
        [this$0_->rowEditModeListener_ itemWillExpandWithRAREExpansionEvent:[[RAREExpansionEvent alloc] initWithId:this$0_->editingComponent_ withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_EXPAND]]];
      }
    ...
    if ([e1 getX] < [((RAREMouseEvent *) nil_chk(e2)) getX]) {
      [this$0_ hideRowEditingComponentWithBoolean:YES];
    }
  }
}
