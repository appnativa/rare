...
- (void)getMinimumSizeWithRAREUIDimension:(RAREUIDimension *)size {
  (void) [((RAREJGFormLayout *) nil_chk([self getLayout])) getMinimumSizeWithRAREiParentComponent:(id<RAREiParentComponent>) check_protocol_cast([RAREComponent fromViewWithRAREView:self], @protocol(RAREiParentComponent)) withRAREUIDimension:size];
}
