...
- (id)initWithRAREaRare:(RAREaRare *)instance
  ...
  if (self = [super init]) {
    ...
    nameCharArray_ = [[RAREUTCharArray alloc] initWithInt:32];
    self->RARE_ = instance;
...
- (void)handleConfigurationWillChangeWithId:(id)newConfig {
  [self closePopupWindowsWithBoolean:NO];
  if (configListeners_ != nil) {
    for (id<RAREiConfigurationListener> __strong l in configListeners_) {
...
- (void)setThemeColorsWithRAREUIColor:(RAREUIColor *)fg
  ...
  if (dark) {
    [uiDefaults_ putWithNSString:@"Rare.TitledBorder.titleColor" withId:[[RAREUIColorShade alloc] initWithRAREUIColor:fg withInt:-75]];
  }
  else {
    [uiDefaults_ putWithNSString:@"Rare.TitledBorder.titleColor" withId:[[RAREUIColorShade alloc] initWithRAREUIColor:fg withInt:75]];
  }
...
- (void)setDefaultDateTimeContextWithRAREDateContext:(RAREDateContext *)ctx {
  ((RAREaRare *) nil_chk(RARE_))->defaultDateTimeContext_ = ctx;
}

- (void)setDefaultDateContextWithRAREDateContext:(RAREDateContext *)ctx {
  ((RAREaRare *) nil_chk(RARE_))->defaultDateContext_ = ctx;
}
...
- (RAREUIImage *)getManagedResourceWithNSString:(NSString *)name
  ...
  RAREUTCharArray *ca = [RAREPlatform isUIThread] ? nameCharArray_ : [[RAREUTCharArray alloc] init];
  ...
  return [self getManagedResourceWithNSString:name withNSString:cname withBoolean:landscape withRAREUTCharArray:ca];
}
...
- (JavaIoReader *)getReaderWithJavaNetURL:(JavaNetURL *)url {
  id<RAREiURLConnection> conn = [((RAREaRare *) nil_chk(RARE_)) openConnectionWithJavaNetURL:url];
  JavaIoReader *r = [((id<RAREiURLConnection>) nil_chk(conn)) getReader];
  if ([(id) conn isKindOfClass:[RAREJavaURLConnection class]]) {
    [RAREJavaURLConnection stopTrackingConnectionWithRAREJavaURLConnection:(RAREJavaURLConnection *) check_class_cast(conn, [RAREJavaURLConnection class])];
  }
  return r;
}
...
- (RAREUISound *)getSoundWithNSString:(NSString *)sound {
  sound = [((NSString *) nil_chk(sound)) lowercaseStringWithJRELocale:[JavaUtilLocale US]];
  sound = [((NSString *) nil_chk(sound)) replace:'.' withChar:'_'];
  if ([((NSString *) nil_chk(sound)) hasPrefix:@"rare_"]) {
...
- (RAREUIImageIcon *)addResourceIconWithNSString:(NSString *)name
  ...
  return [((id<JavaUtilMap>) nil_chk(appIcons_)) putWithId:cname withId:icon];
}
...
- (RAREUIImageIcon *)getResourceAsIconExWithNSString:(NSString *)name {
  ...
  NSString *cname = [ca description];
  if (appIcons_ != nil) {
    icon = [appIcons_ getWithId:cname];
    if (icon != nil) {
      return icon;
    }
  }
  RAREUIImage *img = [self getManagedResourceWithNSString:name withNSString:cname withBoolean:landscapeMode_ withRAREUTCharArray:ca];
  if (img != nil) {
    RAREUIImageIcon *ic = [[RAREUIImageIcon alloc] initWithRAREUIImage:img withNSString:@"" withNSString:[img getLocation]];
    [ic setResourceNameWithNSString:cname];
    return ic;
  }
  return nil;
}
...
- (RAREUIImage *)getResourceAsImageWithNSString:(NSString *)name {
  RAREUIImage *img;
  if (resourceFinder_ != nil) {
    img = [resourceFinder_ getResourceAsImageWithNSString:name];
    if (img != nil) {
      return img;
    }
  }
  ...
  NSString *cname = [ca description];
  if (appIcons_ != nil) {
    RAREUIImageIcon *icon = [appIcons_ getWithId:cname];
    if (icon != nil) {
      return [icon getImage];
    }
  }
  return [self getManagedResourceWithNSString:name withNSString:cname withBoolean:landscapeMode_ withRAREUTCharArray:ca];
}
...
- (void)lockOrientationWithJavaLangBoolean:(JavaLangBoolean *)landscape {
  orientationLocked_ = [RAREPlatformHelper lockOrientationWithJavaLangBoolean:landscape];
}

- (void)unlockOrientation {
  [RAREPlatformHelper unlockOrientation];
...
- (void)copyAllFieldsTo:(RAREaAppContext *)other {
  ...
  other->nameCharArray_ = nameCharArray_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "addResourceIconWithNSString:withRAREUIImageIcon:", NULL, "LRAREUIImageIcon", 0x1, NULL },
    { "getResourceAsIconExWithNSString:", NULL, "LRAREUIImageIcon", 0x1, NULL },
    { "getResourceAsImageWithNSString:", NULL, "LRAREUIImage", 0x1, NULL },
    ...
    { "getMainWindowViewer", NULL, "LRAREWindowViewer", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREaAppContext = { "aAppContext", "com.appnativa.rare.platform", NULL, 0x401, 122, methods, 22, fields, 0, NULL};
