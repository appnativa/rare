...
+ (NSString *)getDefaultRowHeight {
  ...
  if (s == nil) {
    s = [RAREPlatform hasPointingDevice] ? @"1ln" : @"1.75ln";
  }
  return s;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaPlatformHelper = { "aPlatformHelper", "com.appnativa.rare.platform", NULL, 0x1, 82, methods, 4, fields, 0, NULL};
