...
- (id<JavaUtilMap>)loadResourceIconsWithRAREiPlatformAppContext:(id<RAREiPlatformAppContext>)app
  ...
  @try {
    ...
    JavaNetURL *linkURL = [link isInlineURL] ? [((id<RAREiViewer>) nil_chk([((id<RAREiWidget>) nil_chk(context)) getViewer])) getContextURL] : [link getURLWithRAREUTiURLResolver:context];
...
withRAREActionLink_ReturnDataTypeEnum:(RAREActionLink_ReturnDataTypeEnum *)type {
  {
    ...
    switch ([type ordinal]) {
      ...
      url = [((RAREActionLink *) nil_chk(link)) getURLWithRAREUTiURLResolver:w];
...
- (void)run {
  ...
  @try {
    [((RAREActionLink *) nil_chk(val$link_)) sendFormDataExWithRAREUTiURLResolver:val$context_ withJavaUtilMap:val$data_ withBoolean:val$multipart_ withBoolean:YES];
