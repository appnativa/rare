...
- (JavaUtilHashMap *)getHTTPValuesHash {
  ...
  if (submitAttributes_ != nil) {
    [((JavaUtilHashMap *) nil_chk(map)) putAllWithJavaUtilMap:submitAttributes_];
  }
  return map;
}
...
- (BOOL)writeJSONValueWithBoolean:(BOOL)first
                 withJavaIoWriter:(JavaIoWriter *)writer {
  return [self writeJSONValueWithBoolean:first withJavaIoWriter:writer withJavaUtilMap:nil];
}
...
- (BOOL)writeJSONValueWithBoolean:(BOOL)first
  ...
  @try {
    ...
    [((JavaIoWriter *) nil_chk(writer)) writeWithNSString:@": {\n\t"];
    if ((attributes != nil) && [RAREFormHelper writeJSONValuesWithRAREiWidget:self withJavaIoWriter:writer withJavaUtilMap:attributes withBoolean:first withBoolean:YES]) {
      first = NO;
    }
    if ((submitAttributes_ != nil) && [RAREFormHelper writeJSONValuesWithRAREiWidget:self withJavaIoWriter:writer withJavaUtilMap:submitAttributes_ withBoolean:first withBoolean:YES]) {
      first = NO;
    }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "writeJSONValueWithBoolean:withJavaIoWriter:withJavaUtilMap:", NULL, "Z", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREaFormViewer = { "aFormViewer", "com.appnativa.rare.viewer", NULL, 0x1, 11, methods, 4, fields, 0, NULL};
  ...
  if (!dataWritten_) {
    ...
    @try {
      ...
      if ([self getRequestEncoding] == [RAREActionLink_RequestEncodingEnum JSON]) {
        [this$0_ writeJSONValueWithBoolean:YES withJavaIoWriter:w withJavaUtilMap:[self getAttributes]];
