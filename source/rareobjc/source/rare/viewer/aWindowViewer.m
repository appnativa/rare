...
- (id)initWithRAREiPlatformAppContext:(id<RAREiPlatformAppContext>)ctx
  ...
  if (self = [super initWithRAREiContainer:nil]) {
    ...
    theWindow_ = win;
    theEvent_ = [[RAREScriptingEvent alloc] initWithRAREiScriptHandler:sh withNSString:[RAREiConstants ATTRIBUTE_ON_CONFIGURE] withJavaUtilEventObject:[[RAREEventBase alloc] initWithId:win] withId:win withId:nil];
  }
  return self;
}
...
withRAREiFunctionCallback:(id<RAREiFunctionCallback>)cb {
  ...
  if (![RAREPlatform isTouchDevice]) {
    [((RAREAlertPanel *) nil_chk(d)) setRightAlignButtonsWithBoolean:YES];
  }
...
- (RAREActionLink *)createActionLinkWithRAREiWidget:(id<RAREiWidget>)context
  ...
  if ([url isKindOfClass:[NSString class]]) {
    return [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:[((id<RAREiWidget>) nil_chk(context)) getURLWithNSString:(NSString *) check_class_cast(url, [NSString class])]];
  }
  if ([url isKindOfClass:[JavaNetURL class]]) {
    return [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:(JavaNetURL *) check_class_cast(url, [JavaNetURL class])];
  }
  if ([url isKindOfClass:[JavaIoFile class]]) {
    return [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:[RAREaPlatformHelper fileToURLWithJavaIoFile:(JavaIoFile *) check_class_cast(url, [JavaIoFile class])]];
  }
  return [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:[((id<RAREiWidget>) nil_chk(context)) getURLWithNSString:[nil_chk(url) description]]];
}
...
- (void)okCancelWithNSString:(NSString *)title
  ...
  RAREAlertPanel *d = [RAREAlertPanel okCancelWithRAREiWidget:self withNSString:title withId:message withRAREiPlatformIcon:nil];
  if (![RAREPlatform isTouchDevice]) {
    [((RAREAlertPanel *) nil_chk(d)) setRightAlignButtonsWithBoolean:YES];
  }
  [((RAREAlertPanel *) nil_chk(d)) showDialogWithRAREiFunctionCallback:cb];
...
- (RAREWindowViewer *)openWithRAREActionLink:(RAREActionLink *)link
  ...
  [link setURLWithJavaNetURL:[((RAREActionLink *) nil_chk(link)) getURLWithRAREUTiURLResolver:self]];
  [link setContextWithRAREUTiURLResolver:w];
...
- (RAREWindowViewer *)openWithNSString:(NSString *)url
                          withNSString:(NSString *)winoptions
                                withId:(id)viewerValue {
  return [self openWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:nil withNSString:url withNSString:nil] withNSString:winoptions withId:viewerValue];
}
...
- (void)setMenuBarWithRAREiPlatformMenuBar:(id<RAREiPlatformMenuBar>)mb {
  [((id<RAREiWindow>) nil_chk(theWindow_)) setMenuBarWithRAREiPlatformMenuBar:mb];
}
...
- (void)setStatusWithNSString:(NSString *)status {
  ...
  else if ([((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getBooleanWithNSString:@"Rare.StatusBar.useNotifier" withBoolean:YES]) {
    [RAREUINotifier showMessageWithNSString:status];
  }
}

- (void)setStatusBarWithRAREiStatusBar:(id<RAREiStatusBar>)sb {
  [((id<RAREiWindow>) nil_chk(theWindow_)) setStatusBarWithRAREiStatusBar:sb];
}
...
- (id<RAREiViewer>)getWorkspaceViewer {
  return [((id<RAREiTarget>) nil_chk([((id<RAREiWindow>) nil_chk(theWindow_)) getTarget])) getViewer];
}
...
- (RAREWindowViewer *)getTop {
  ...
  return (RAREWindowViewer *) check_class_cast(top, [RAREWindowViewer class]);
}
...
- (RAREWindowViewer *)getWindow {
  return (RAREWindowViewer *) check_class_cast(self, [RAREWindowViewer class]);
}
...
- (RAREScriptingEvent *)getTimerEvent {
  if (timerEvent_ == nil) {
    timerEvent_ = [[RAREScriptingEvent alloc] initWithRAREiScriptHandler:[self getScriptHandler] withNSString:[RAREiConstants ATTRIBUTE_TIMER] withJavaUtilEventObject:[[RAREEventBase alloc] initWithId:theWindow_] withId:theWindow_ withId:nil];
  }
  return timerEvent_;
}
...
- (void)initializeListenersWithRAREaWidgetListener:(RAREaWidgetListener *)listener {
  ...
  if (listener != nil) {
    [((id<RAREiWindow>) nil_chk(theWindow_)) addWindowListenerWithRAREiWindowListener:listener];
  }
}
...
- (void)uninitializeListenersWithRAREaWidgetListener:(RAREaWidgetListener *)listener {
  ...
  if (listener != nil) {
    [((id<RAREiWindow>) nil_chk(theWindow_)) removeWindowListenerWithRAREiWindowListener:listener];
  }
}
...
- (void)loadScriptExWithRAREActionLink:(RAREActionLink *)link
  ...
  if ((s != nil) && ([s sequenceLength] > 0)) {
    ...
    if ([link isInlineURL]) {
      ...
      @try {
        JavaNetURL *url = [link getURLWithRAREUTiURLResolver:self];
...
- (void)loadScriptExWithNSString:(NSString *)url
  ...
  @try {
    ...
    if (![((NSString *) nil_chk(url)) hasPrefix:@"/"] && (name != nil)) {
      u = [[JavaNetURL alloc] initWithJavaNetURL:[self getURLWithNSString:name] withNSString:url];
    }
  }
  @catch (JavaLangException *e) {
    u = nil;
  ...
  [self loadScriptExWithRAREActionLink:[[RAREActionLink alloc] initWithRAREUTiURLResolver:self withJavaNetURL:u] withBoolean:use withBoolean:strict withBoolean:optimized];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "copyToClipboardWithNSString:", NULL, "V", 0x401, NULL },
    ...
    { "setCancelableWithBoolean:", NULL, "V", 0x401, NULL },
    ...
    { "getClipboardContents", NULL, "LNSString", 0x401, NULL },
    ...
    { "getTop", NULL, "LRAREWindowViewer", 0x1, NULL },
  ...
  static J2ObjcClassInfo _RAREaWindowViewer = { "aWindowViewer", "com.appnativa.rare.viewer", NULL, 0x401, 149, methods, 12, fields, 0, NULL};
