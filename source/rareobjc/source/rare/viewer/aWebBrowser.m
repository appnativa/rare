...
- (void)handleActionLinkWithRAREActionLink:(RAREActionLink *)link
  ...
  @try {
    [self setURLWithJavaNetURL:[((RAREActionLink *) nil_chk(link)) getURLWithRAREUTiURLResolver:self]];
  }
...
- (void)hideWaitCursorIfShowing {
  if (handleWaitCursor_ && (waitCursors_ > 0)) {
    while (waitCursors_ > 0) {
      waitCursors_--;
...
- (id<RAREiCancelableFuture>)setDataLinkWithRAREActionLink:(RAREActionLink *)link
  ...
  if (link != nil) {
    @try {
      [self setURLWithNSString:[RAREJavaURLConnection toExternalFormWithJavaNetURL:[link getURLWithRAREUTiURLResolver:self]]];
    }
...
- (void)setURLWithNSString:(NSString *)url {
  [self checkConfigure];
  if (useRuntimeToLoadContent_) {
    RAREWindowViewer *w = [RAREPlatform getWindowViewer];
    @try {
      (void) [((RAREWindowViewer *) nil_chk(w)) getContentWithRAREiWidget:self withId:url withId:[RAREActionLink_ReturnDataTypeEnum STRING] withRAREiFunctionCallback:[[RAREaWebBrowser_$1 alloc] initWithRAREaWebBrowser:self withRAREWindowViewer:w withNSString:url]];
      if ([self isHandleWaitCursor]) {
        [w showWaitCursor];
      }
    }
    @catch (JavaNetMalformedURLException *e) {
  ...
  if ([RAREPlatform isUIThread]) {
    ...
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[RAREaWebBrowser_$2 alloc] initWithRAREaWebBrowser:self withNSString:url]];
  }
}
...
- (void)handleCustomPropertiesWithRARESPOTWidget:(RARESPOTWidget *)cfg
  ...
  o = [properties getWithId:@"useRuntimeToLoadContent"];
  if ([o isKindOfClass:[NSString class]]) {
    useRuntimeToLoadContent_ = [@"true" isEqual:o];
  }
  else if ([o isKindOfClass:[JavaLangBoolean class]]) {
    useRuntimeToLoadContent_ = [((JavaLangBoolean *) check_class_cast(o, [JavaLangBoolean class])) booleanValue];
  }
}
...
- (void)loadContentWithNSString:(NSString *)content
  ...
  if ([RAREPlatform isUIThread]) {
    ...
    NSString *s = content;
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[RAREaWebBrowser_$3 alloc] initWithRAREaWebBrowser:self withNSString:s withNSString:contentType withNSString:baseHref]];
  }
}

- (void)showWaitCursor {
  if (handleWaitCursor_) {
    if (stackWaitCursors_ || (waitCursors_ == 0)) {
      waitCursors_++;
      [RAREWaitCursorHandler startWaitCursorWithRAREiPlatformComponent:[self getDataComponent] withRAREUTiCancelable:nil];
    }
  }
}
...
- (id)getNativeBrowserView {
  return [((id<RAREaWebBrowser_iBrowser>) nil_chk(theBrowser_)) getNativeBrowser];
}
...
- (void)copyAllFieldsTo:(RAREaWebBrowser *)other {
  ...
  other->stackWaitCursors_ = stackWaitCursors_;
  other->theBrowser_ = theBrowser_;
  other->useRuntimeToLoadContent_ = useRuntimeToLoadContent_;
  other->waitCursors_ = waitCursors_;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "showWaitCursor", NULL, "V", 0x4, NULL },
    { "hideWaitCursor", NULL, "V", 0x4, NULL },
    { "setURLExWithNSString:", NULL, "V", 0x4, NULL },
    { "getNativeBrowserView", NULL, "LNSObject", 0x1, NULL },
    { "isAutoInsertMetaContent", NULL, "Z", 0x1, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "generateBrowserExceptions_", NULL, 0x4, "Z" },
    { "handleWaitCursor_", NULL, 0x4, "Z" },
    { "stackWaitCursors_", NULL, 0x4, "Z" },
    { "waitCursors_", NULL, 0x4, "I" },
    { "theBrowser_", NULL, 0x4, "LRAREaWebBrowser_iBrowser" },
    { "autoInsertMetaContent_", NULL, 0x4, "Z" },
    { "useRuntimeToLoadContent_", NULL, 0x4, "Z" },
  };
  static J2ObjcClassInfo _RAREaWebBrowser = { "aWebBrowser", "com.appnativa.rare.viewer", NULL, 0x401, 20, methods, 7, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getNativeBrowser", NULL, "LNSObject", 0x401, NULL },
    { "getLocation", NULL, "LNSString", 0x401, NULL },
  };
  static J2ObjcClassInfo _RAREaWebBrowser_iBrowser = { "iBrowser", "com.appnativa.rare.viewer", "aWebBrowser", 0x201, 9, methods, 0, NULL, 0, NULL};
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if ([this$0_ isHandleWaitCursor]) {
    [((RAREWindowViewer *) nil_chk(val$w_)) hideWaitCursor];
  }
  if ([returnValue isKindOfClass:[JavaLangThrowable class]]) {
    @throw [RAREApplicationException runtimeExceptionWithJavaLangThrowable:(JavaLangThrowable *) check_class_cast(returnValue, [JavaLangThrowable class])];
  }
  if (returnValue != nil) {
    RAREUTObjectHolder *oh = (RAREUTObjectHolder *) check_class_cast(returnValue, [RAREUTObjectHolder class]);
    NSString *contentType = (NSString *) check_class_cast(oh->type_, [NSString class]);
    NSString *content = (NSString *) check_class_cast(oh->value_, [NSString class]);
    NSString *baseHref = ([((NSString *) nil_chk(val$url_)) hasPrefix:@"http:"] || [val$url_ hasPrefix:@"https:"]) ? val$url_ : nil;
    [this$0_ loadContentWithNSString:content withNSString:contentType withNSString:baseHref];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaWebBrowser_$1 = { "$1", "com.appnativa.rare.viewer", "aWebBrowser", 0x8000, 0, NULL, 3, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaWebBrowser_$2 = { "$2", "com.appnativa.rare.viewer", "aWebBrowser", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_RAREaWebBrowser_$2;
}

@end
@implementation RAREaWebBrowser_$3
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaWebBrowser_$3 = { "$3", "com.appnativa.rare.viewer", "aWebBrowser", 0x8000, 0, NULL, 4, fields, 0, NULL};
  return &_RAREaWebBrowser_$3;
}
