...
- (void)dispose {
  ...
  if (rowEditingWidget_ != nil) {
    [rowEditingWidget_ dispose];
  }
  rowEditingWidget_ = nil;
  listModel_ = nil;
  listComponent_ = nil;
...
- (void)flashSelectedRow {
  [self flashRowWithInt:[self getSelectedIndex] withInt:3 withJavaLangRunnable:nil];
}
...
- (void)flashRowWithInt:(int)row
  ...
  if (row != -1) {
    RAREaListItemRenderer *renderer = (RAREaListItemRenderer *) check_class_cast([((id<RAREiPlatformListHandler>) nil_chk(listComponent_)) getItemRenderer], [RAREaListItemRenderer class]);
    BOOL ignore = [((RAREaListItemRenderer *) nil_chk(renderer)) isIgnoreSelection];
    id<JavaLangRunnable> r = nil;
    if (!ignore && (row == [self getSelectedIndex])) {
      [renderer setIgnoreSelectionWithBoolean:YES];
      r = [[RAREaListViewer_$1 alloc] initWithRAREaListViewer:self withRAREaListItemRenderer:renderer withInt:row withJavaLangRunnable:runnable];
    }
    if (r == nil) {
      r = runnable;
    }
    [RAREListHelper flashHilightWithRAREiListHandler:listComponent_ withInt:row withBoolean:YES withInt:count withJavaLangRunnable:r];
  }
}
    ...
    if (tempList_ != nil) {
      ...
      if (addIndexToList_) {
        ...
        if ([self isEmpty]) {
          ...
          [listComponent_ addAllWithJavaUtilCollection:tempList_];
        }
...
- (void)startEditingWithBoolean:(BOOL)animate
  ...
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) startEditingWithBoolean:animate withRAREUIActionArray:actions];
  }
  else {
...
- (void)stopEditingWithBoolean:(BOOL)animate {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) stopEditingWithBoolean:animate];
  }
}
...
- (BOOL)setAllWithJavaUtilCollection:(id<JavaUtilCollection>)rows {
  id<JavaLangRunnable> r = [[RAREaListViewer_$2 alloc] initWithRAREaListViewer:self withJavaUtilCollection:rows];
  if ([RAREPlatform isUIThread]) {
    [r run];
  }
  else {
...
- (void)setRowEditModeListenerWithRAREiExpansionListener:(id<RAREiExpansionListener>)l {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setRowEditModeListenerWithRAREiExpansionListener:l];
  }
}

- (void)setEditModeListenerWithRAREiExpansionListener:(id<RAREiExpansionListener>)l {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setEditModeListenerWithRAREiExpansionListener:l];
  }
}
...
- (void)setItemsWithJavaUtilCollection:(id<JavaUtilCollection>)items {
  if (listComponent_ != nil) {
    if (![RAREPlatform isUIThread]) {
      id<JavaLangRunnable> r = [[RAREaListViewer_$3 alloc] initWithRAREaListViewer:self withJavaUtilCollection:items];
      [RAREPlatform invokeLaterWithJavaLangRunnable:r];
      return;
    }
    if (listComponent_ != nil) {
...
- (void)setRowEditingWidgetWithRAREiWidget:(id<RAREiWidget>)widget
  ...
  if ((rowEditingWidget_ != nil) && (rowEditingWidget_ != widget)) {
    [self unregisterOrphanWidgetWithRAREiWidget:rowEditingWidget_];
  }
  rowEditingWidget_ = widget;
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setRowEditingComponentWithRAREiPlatformComponent:widget == nil ? nil : [widget getContainerComponent] withBoolean:centerVertically];
  }
  if (widget != nil) {
    [self registerOrphanWidgetWithRAREiWidget:widget];
  }
}
...
- (int)getEditModeMarkCount {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditModeMarkCount];
  }
  return 0;
}
...
- (void)clearEditModeMarks {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) clearEditModeMarks];
  }
}

- (BOOL)isEditModeItemMarkedWithInt:(int)index {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) isEditModeItemMarkedWithInt:index];
  }
  return NO;
}
...
- (void)toggleEditModeItemMarkWithInt:(int)index {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) toggleEditModeItemMarkWithInt:index];
  }
}
...
- (void)setEditModeItemMarkWithInt:(int)index
  ...
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setEditModeItemMarkWithInt:index withBoolean:mark];
  }
}

- (void)setEditModeAllItemMarksWithBoolean:(BOOL)mark {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setEditModeAllItemMarksWithBoolean:mark];
  }
}

- (id<RAREiToolBar>)getEditModeToolBar {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditModeToolBar];
  }
  return nil;
}
...
- (void)setEditModeToolBarWithRAREiToolBar:(id<RAREiToolBar>)tb {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    id<RAREiToolBar> otb = [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditModeToolBar];
    if (tb != otb) {
      if (otb != nil) {
        [self unregisterOrphanWidgetWithRAREiWidget:[((id<RAREiPlatformComponent>) nil_chk([otb getComponent])) getWidget]];
      }
      [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) setEditModeToolBarWithRAREiToolBar:tb];
    }
  }
}
...
- (IOSIntArray *)getEditModeMarkedIndices {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditModeMarkedIndices];
  }
  return nil;
}
...
- (IOSObjectArray *)getEditModeMarkedItems {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditModeMarkedItems];
  }
  return nil;
}
...
- (int)getEditingRow {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getEditingRow];
  }
  return -1;
}
...
- (int)getLastEditedRow {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) getLastEditedRow];
  }
  return -1;
}
...
- (BOOL)isEditing {
  if ([(id) listComponent_ conformsToProtocol: @protocol(RAREiEditableListHandler)]) {
    return [((id<RAREiEditableListHandler>) check_protocol_cast(listComponent_, @protocol(RAREiEditableListHandler))) isEditing];
  }
  return NO;
}
...
- (void)upArrow {
  if ([self getRowCount] > 0) {
    ...
    if (selectionModelGroup_ != nil) {
      (void) [selectionModelGroup_ selectPreviousRowWithInt:row withId:listComponent_];
    }
    else {
...
- (void)downArrow {
  if ([self getRowCount] > 0) {
    int row = [self getSelectedIndex];
    if (selectionModelGroup_ != nil) {
      (void) [selectionModelGroup_ selectNextRowWithInt:row withId:listComponent_];
    }
    else {
...
- (id<RAREiToolBar>)createEditingToolbarIfNecessaryWithRARESPOTListBox:(RARESPOTListBox *)cfg {
  ...
  if (editable) {
    ...
    if ([(id) formComponent_ isKindOfClass:[RAREBorderPanel class]]) {
      ...
      [bp setBackgroundWithRAREUIColor:[RAREColorUtils getListBackground]];
    ...
    [((id<RAREiPlatformComponent>) nil_chk([tb getComponent])) setBorderWithRAREiPlatformBorder:[[RAREUIMatteBorder alloc] initWithFloat:[RAREScreenUtils PLATFORM_PIXELS_1] withFloat:0 withFloat:0 withFloat:0 withRAREUIColor:[RAREaUILineBorder getDefaultLineColor]]];
    [self registerWithWidgetWithRAREiPlatformComponent:[tb getComponent]];
  }
  return tb;
}
...
- (void)initializeListenersWithRAREaWidgetListener:(RAREaWidgetListener *)l {
  ...
  id<RAREiActionListener> al = [[RAREaListViewer_$4 alloc] initWithRAREaListViewer:self];
  [((id<RAREiPlatformListHandler>) nil_chk(listComponent_)) addActionListenerWithRAREiActionListener:al];
  if (l != nil) {
    if ([l isChangeEventEnabled]) {
      [listComponent_ addSelectionChangeListenerWithRAREiItemChangeListener:l];
    }
  }
}
...
- (id<JavaUtilList>)updateListWithFilteringIndexWithRAREUTFilterableList:(RAREUTFilterableList *)list {
  ...
  [JavaUtilArrays sortWithNSObjectArray:a withJavaUtilComparator:[[RAREaListViewer_$5 alloc] init]];
...
- (void)copyAllFieldsTo:(RAREaListViewer *)other {
  ...
  other->rowEditingWidget_ = rowEditingWidget_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "rowEditingWidget_", NULL, 0x4, "LRAREiWidget" },
  };
  static J2ObjcClassInfo _RAREaListViewer = { "aListViewer", "com.appnativa.rare.viewer", NULL, 0x401, 78, methods, 14, fields, 0, NULL};
...
- (void)run {
  [((RAREaListItemRenderer *) nil_chk(val$renderer_)) setIgnoreSelectionWithBoolean:NO];
  [this$0_ repaintRowWithInt:val$row_];
...
- (id)initWithRAREaListViewer:(RAREaListViewer *)outer$
  ...
  this$0_ = outer$;
  val$renderer_ = capture$0;
  val$row_ = capture$1;
  val$runnable_ = capture$2;
  return [super init];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    ...
    { "val$renderer_", NULL, 0x1012, "LRAREaListItemRenderer" },
    { "val$row_", NULL, 0x1012, "I" },
    { "val$runnable_", NULL, 0x1012, "LJavaLangRunnable" },
  };
  static J2ObjcClassInfo _RAREaListViewer_$1 = { "$1", "com.appnativa.rare.viewer", "aListViewer", 0x8000, 0, NULL, 4, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaListViewer_$3 = { "$3", "com.appnativa.rare.viewer", "aListViewer", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_RAREaListViewer_$3;
}

@end
@implementation RAREaListViewer_$4
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaListViewer_$4 = { "$4", "com.appnativa.rare.viewer", "aListViewer", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_RAREaListViewer_$4;
}

@end
@implementation RAREaListViewer_$5
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _RAREaListViewer_$5 = { "$5", "com.appnativa.rare.viewer", "aListViewer", 0x8000, 0, NULL, 0, NULL, 0, NULL};
  return &_RAREaListViewer_$5;
}
