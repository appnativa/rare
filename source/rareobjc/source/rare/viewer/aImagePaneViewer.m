...
- (BOOL)isImageFitted {
  return [((RAREaImagePanel *) nil_chk(imageView_)) isImageFitted];
}
...
- (RAREUIImage *)getRenderedImage {
  return [((RAREaImagePanel *) nil_chk(imageView_)) getRenderedImage];
}

- (void)handleActionLinkWithRAREActionLink:(RAREActionLink *)link
                               withBoolean:(BOOL)deferred {
  @try {
    RAREUIImage *img = [RAREaPlatformHelper createImageWithJavaNetURL:[((RAREActionLink *) nil_chk(link)) getURLWithRAREUTiURLResolver:self] withBoolean:deferred withFloat:[link getImageDensity]];
    if (!disposeOnChangeSet_) {
      [((RAREaImagePanel *) nil_chk(imageView_)) setDisposeImageOnChangeWithBoolean:YES];
    }
    [((RAREaImagePanel *) nil_chk(imageView_)) setImageWithRAREUIImage:img];
  }
...
- (void)resetImage {
  [((RAREaImagePanel *) nil_chk(imageView_)) resetImage];
}

- (void)rotateLeft {
  [((RAREaImagePanel *) nil_chk(imageView_)) rotateLeft];
}

- (void)rotateRight {
  [((RAREaImagePanel *) nil_chk(imageView_)) rotateRight];
}

- (void)zoomIn {
  [((RAREaImagePanel *) nil_chk(imageView_)) zoomIn];
}

- (void)zoomOut {
  [((RAREaImagePanel *) nil_chk(imageView_)) zoomOut];
}

- (void)setMovingOnlyAllowedWhenToLargeWithBoolean:(BOOL)allowed {
  [((RAREaImagePanel *) nil_chk(imageView_)) setMovingOnlyAllowedWhenToLargeWithBoolean:allowed];
}
...
- (void)setImageWithRAREUIImage:(RAREUIImage *)image
                        ...
                        withInt:(int)height {
  if (!disposeOnChangeSet_) {
    [((RAREaImagePanel *) nil_chk(imageView_)) setDisposeImageOnChangeWithBoolean:NO];
  }
  [((RAREaImagePanel *) nil_chk(imageView_)) setImageWithRAREUIImage:image withInt:width withInt:height];
}

- (void)setDisposeImageOnChangeWithBoolean:(BOOL)dispose {
  disposeOnChangeSet_ = YES;
  [((RAREaImagePanel *) nil_chk(imageView_)) setDisposeImageOnChangeWithBoolean:dispose];
}

- (BOOL)isDisposeImageOnChange {
  return [((RAREaImagePanel *) nil_chk(imageView_)) isDisposeImageOnChange];
}
...
- (void)setMaximumZoomWithInt:(int)percent {
  [((RAREaImagePanel *) nil_chk(imageView_)) setMaximumZoomWithInt:maxZoom_];
}

- (void)setMinimumZoomWithInt:(int)percent {
  [((RAREaImagePanel *) nil_chk(imageView_)) setMinimumZoomWithInt:maxZoom_];
}
...
- (void)setZoomPercentWithInt:(int)percent {
  ...
  [((RAREaImagePanel *) nil_chk(imageView_)) zoomWithInt:percent];
}

- (void)setZoomingAllowedWithBoolean:(BOOL)allowed {
  self->zoomingAllowed_ = allowed;
  [((RAREaImagePanel *) nil_chk(imageView_)) setZoomingAllowedWithBoolean:allowed];
}

- (RAREUIImage *)getImage {
  return [((RAREaImagePanel *) nil_chk(imageView_)) getImage];
}
...
- (int)getImageRotation {
  return [((RAREaImagePanel *) nil_chk(imageView_)) getImageRotation];
}

- (float)getImageScale {
  return [((RAREaImagePanel *) nil_chk(imageView_)) getImageScale];
}
...
- (int)getZoomPercent {
  return [((RAREaImagePanel *) nil_chk(imageView_)) getZoomPercent];
}
...
- (void)configureExWithRARESPOTImagePane:(RARESPOTImagePane *)cfg {
  ...
  formComponent_ = dataComponent_ = [((RAREaImagePanel *) nil_chk(imageView_)) getComponent];
...
- (BOOL)isFillViewport {
  return [((RAREaImagePanel *) nil_chk(imageView_)) isFillViewport];
}

- (void)setFillViewportWithBoolean:(BOOL)fillViewport {
  [((RAREaImagePanel *) nil_chk(imageView_)) setFillViewportWithBoolean:fillViewport];
}

- (BOOL)isAnimateBoundsChange {
  return [((RAREaImagePanel *) nil_chk(imageView_)) isAnimateBoundsChange];
}
...
- (void)setAnimateBoundsChangeWithBoolean:(BOOL)animateBoundsChange
  ...
  [((RAREaImagePanel *) nil_chk(imageView_)) setAnimateBoundsChangeWithBoolean:animateBoundsChange withRAREiAnimatorListener:listener];
}

- (void)fitImage {
  [((RAREaImagePanel *) nil_chk(imageView_)) fitImage];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getImagePanel", NULL, "LRAREaImagePanel", 0x1, NULL },
    ...
    { "createPanelWithRARESPOTImagePane:", NULL, "LRAREaImagePanel", 0x404, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    ...
    { "imageView_", NULL, 0x4, "LRAREaImagePanel" },
  ...
  static J2ObjcClassInfo _RAREaImagePaneViewer = { "aImagePaneViewer", "com.appnativa.rare.viewer", NULL, 0x401, 20, methods, 12, fields, 0, NULL};
