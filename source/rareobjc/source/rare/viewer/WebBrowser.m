...
- (void)executeScriptWithNSString:(NSString *)script
  ...
  [((RAREWebView *) nil_chk(webView_)) executeScriptWithNSString:script withRAREiFunctionCallback:cb];
}

- (void)setWindowPropertyWithNSString:(NSString *)name
                               withId:(id)value {
  [((RAREWebView *) nil_chk(webView_)) setWindowPropertyWithNSString:name withId:value];
}
...
- (void)handleViewerConfigurationChangedWithBoolean:(BOOL)reset {
  [((RAREWebView *) nil_chk(webView_)) handleViewerConfigurationChanged];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREWebBrowser = { "WebBrowser", "com.appnativa.rare.viewer", NULL, 0x1, 2, methods, 1, fields, 0, NULL};
...
- (void)loadStartedWithRAREWebView:(RAREWebView *)view {
  if (this$0_->webView_ != nil && loadingUrl_ != nil) {
    if ([this$0_ isEventEnabledWithNSString:[RAREiConstants EVENT_STARTED_LOADING]]) {
      RAREDataEvent *e = [[RAREDataEvent alloc] initWithId:this$0_->webView_ withId:loadingUrl_ withId:nil];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getNativeBrowser", NULL, "LNSObject", 0x1, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LRAREWebBrowser" },
    { "loadingUrl_", NULL, 0x0, "LNSString" },
  };
  static J2ObjcClassInfo _RAREWebBrowser_AppleBrowser = { "AppleBrowser", "com.appnativa.rare.viewer", "WebBrowser", 0x4, 5, methods, 2, fields, 0, NULL};
