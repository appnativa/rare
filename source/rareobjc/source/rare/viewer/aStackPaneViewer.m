...
- (NSString *)getActiveViewerHREF {
  ...
  @try {
    return (l == nil) ? nil : [l getStringURLWithRAREUTiURLResolver:self];
  }
...
- (id<RAREiWidget>)getWidgetWithNSString:(NSString *)name {
  if (entries_ != nil) {
    for (RAREaStackPaneViewer_StackEntry * __strong e in entries_) {
      if (((RAREaStackPaneViewer_StackEntry *) nil_chk(e))->theViewer_ != nil && [((NSString *) nil_chk(name)) isEqual:[e->theViewer_ getName]]) {
        return e->theViewer_;
      }
    }
  }
...
- (void)createViewerEntriesWithRARESPOTStackPane:(RARESPOTStackPane *)cfg {
  ...
  for (i = 0; i < len; i++) {
    ...
    RAREActionLink *link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:self withSPOTPrintableString:aURL withInt:0];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaStackPaneViewer = { "aStackPaneViewer", "com.appnativa.rare.viewer", NULL, 0x401, 30, methods, 10, fields, 0, NULL};
...
- (BOOL)reloadWithRAREiFunctionCallback:(id<RAREiFunctionCallback>)cb {
  if (httpLink_ != nil) {
    if (![httpLink_ isDeferredWithRAREUTiURLResolver:this$0_]) {
