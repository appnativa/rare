...
static RAREColumnSpec * RAREaGridPaneViewer_ZERO_COL_SPEC_;
static RARERowSpec * RAREaGridPaneViewer_ZERO_ROW_SPEC_;
...
- (void)setRegionVerticalFillWithInt:(int)pos
  ...
  RARECellConstraints *cc = [((id<RAREiFormsPanel>) nil_chk(gridPanel_)) getCellConstraintsWithRAREiPlatformComponent:[((id<RAREiTarget>) nil_chk(t)) getContainerComponent]];
  if (cc != nil) {
...
- (void)configureExWithRARESPOTGridPane:(RARESPOTGridPane *)cfg {
  ...
  if (rg != nil) {
    ...
    [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setRowGroupsWithIntArray2:rg];
  }
  if (cg != nil) {
    [self fixGroupingsWithIntArray2:cg];
    [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setColumnGroupsWithIntArray2:cg];
  }
  if (dm) {
...
- (void)targetHiddenWithRAREiTarget:(id<RAREiTarget>)t {
  ...
  int row = ((RARECellConstraints *) nil_chk(cc))->gridY_;
  int col = cc->gridX_;
  ...
  if (IOSBooleanArray_Get(nil_chk(b), 0)) {
    ...
    if ([((JavaUtilHashMap *) nil_chk(savedRowSpecs_)) getWithId:[JavaLangInteger valueOfWithInt:row]] == nil) {
      (void) [savedRowSpecs_ putWithId:[JavaLangInteger valueOfWithInt:row] withId:[((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) getRowSpecWithInt:row]];
    }
    [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setRowSpecWithInt:row withRARERowSpec:RAREaGridPaneViewer_ZERO_ROW_SPEC_];
  }
  if (IOSBooleanArray_Get(b, 1)) {
    ...
    if ([((JavaUtilHashMap *) nil_chk(savedColumnSpecs_)) getWithId:[JavaLangInteger valueOfWithInt:col]] == nil) {
      (void) [savedColumnSpecs_ putWithId:[JavaLangInteger valueOfWithInt:col] withId:[((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) getColumnSpecWithInt:col]];
    }
    [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setColumnSpecWithInt:col withRAREColumnSpec:RAREaGridPaneViewer_ZERO_COL_SPEC_];
  }
}
...
- (void)targetShownWithRAREiTarget:(id<RAREiTarget>)t {
  ...
  IOSBooleanArray *b = [gridPanel_ isColumnRowComponentsHiddenWithInt:col withInt:row];
  if (!IOSBooleanArray_Get(nil_chk(b), 0)) {
    RARERowSpec *spec = (savedRowSpecs_ == nil) ? nil : [savedRowSpecs_ getWithId:[JavaLangInteger valueOfWithInt:row]];
    if (spec != nil) {
      [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setRowSpecWithInt:row withRARERowSpec:spec];
    }
  }
  if (!IOSBooleanArray_Get(b, 1)) {
    RAREColumnSpec *spec = (savedColumnSpecs_ == nil) ? nil : [savedColumnSpecs_ getWithId:[JavaLangInteger valueOfWithInt:col]];
    if (spec != nil) {
      [((RAREFormLayout *) nil_chk([gridPanel_ getFormLayout])) setColumnSpecWithInt:col withRAREColumnSpec:spec];
    }
  }
  [self update];
}
...
+ (void)initialize {
  if (self == [RAREaGridPaneViewer class]) {
    RAREaGridPaneViewer_ZERO_COL_SPEC_ = [[RAREColumnSpec alloc] initWithRAREFormSpec_DefaultAlignment:[RAREColumnSpec DEFAULT] withRARESize:[RARESizes ZERO] withDouble:0];
    RAREaGridPaneViewer_ZERO_ROW_SPEC_ = [[RARERowSpec alloc] initWithRAREFormSpec_DefaultAlignment:[RARERowSpec DEFAULT] withRARESize:[RARESizes ZERO] withDouble:0];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "ZERO_COL_SPEC_", NULL, 0xa, "LRAREColumnSpec" },
    { "ZERO_ROW_SPEC_", NULL, 0xa, "LRARERowSpec" },
