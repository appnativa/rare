...
- (int)getEditingRow {
  ...
  return [((RAREListView *) nil_chk(v)) getEditingRow];
}

- (int)getLastEditedRow {
  RAREListView *v = (RAREListView *) check_class_cast([self getDataView], [RAREListView class]);
  return [((RAREListView *) nil_chk(v)) getLastEditedRow];
}
...
- (void)setEditModeListenerWithRAREiExpansionListener:(id<RAREiExpansionListener>)l {
  RAREListView *v = (RAREListView *) check_class_cast([self getDataView], [RAREListView class]);
  [((RAREListView *) nil_chk(v)) setEditModeListenerWithRAREiExpansionListener:l];
}

- (void)setRowEditModeListenerWithRAREiExpansionListener:(id<RAREiExpansionListener>)l {
  RAREListView *v = (RAREListView *) check_class_cast([self getDataView], [RAREListView class]);
  [((RAREListView *) nil_chk(v)) setRowEditModeListenerWithRAREiExpansionListener:l];
}

- (void)setRowEditingWidgetWithRAREiWidget:(id<RAREiWidget>)widget
                               withBoolean:(BOOL)centerVertically {
  [super setRowEditingWidgetWithRAREiWidget:widget withBoolean:centerVertically];
  RAREListView *v = (RAREListView *) check_class_cast([self getDataView], [RAREListView class]);
  [((RAREListView *) nil_chk(v)) setRowEditingComponentWithRAREiPlatformComponent:[((id<RAREiWidget>) nil_chk(widget)) getContainerComponent] withBoolean:centerVertically];
}
...
- (void)startEditingWithBoolean:(BOOL)animate
  ...
  [((RAREListView *) check_class_cast([self getDataView], [RAREListView class])) startEditingWithRAREUIActionArray:actions withBoolean:animate];
}

- (void)stopEditingWithBoolean:(BOOL)animate {
  [((RAREListView *) check_class_cast([self getDataView], [RAREListView class])) stopEditingWithBoolean:animate];
}
...
- (void)createModelAndComponentsWithRARESPOTViewer:(RARESPOTViewer *)vcfg {
  ...
  listComponent_ = [[RAREListBoxListHandler alloc] initWithRAREaPlatformTableBasedView:list withRAREiPlatformListDataModel:listModel_];
  ...
  if (tb != nil) {
    [list setEditingToolbarWithRAREiToolBar:tb];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREListBoxViewer = { "ListBoxViewer", "com.appnativa.rare.viewer", NULL, 0x1, 12, methods, 1, fields, 0, NULL};
