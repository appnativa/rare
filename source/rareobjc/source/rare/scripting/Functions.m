...
+ (RAREFunctionCallbackChainner *)createFunctionCallbackChainner {
  return [[RAREFunctionCallbackChainner alloc] init];
}
...
+ (NSString *)decodeWithNSString:(NSString *)str {
  return [RAREURLEncoder decodeWithNSString:str];
}
...
+ (void)enableDebugLoggingWithJavaIoOutputStream:(JavaIoOutputStream *)outArg {
}

+ (NSString *)encodeWithNSString:(NSString *)str {
  return [RAREURLEncoder encodeWithNSString:str];
}

+ (NSString *)encodeFullWithNSString:(NSString *)str {
  return [RAREURLEncoder encodeExWithNSString:str];
}
  ...
  if (n > 0) {
    ...
    if (len > 0) {
      ...
      for (int i = 0; i < len; i++) {
        ...
        (void) IOSObjectArray_Set(parameters, i, s);
      }
    }
  }
...
- (NSString *)executeFunctionWithRAREiWidget:(id<RAREiWidget>)context
  ...
  int plen = (parameters == nil) ? 0 : (int) [parameters count];
  {
    ...
    switch ([((JavaLangInteger *) nil_chk(in)) intValue]) {
      ...
      return [RAREURLEncoder encodeWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0)];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "convertDateWithRAREiWidget:withId:withNSString:", NULL, "LNSString", 0x9, "JavaTextParseException" },
    { "convertDateWithRAREiWidget:withId:withNSString:withNSString:", NULL, "LNSString", 0x9, "JavaTextParseException" },
    { "convertDateTimeWithRAREiWidget:withId:", NULL, "LNSString", 0x9, "JavaTextParseException" },
    { "convertDateTimeWithRAREiWidget:withId:withBoolean:", NULL, "LNSString", 0x9, "JavaTextParseException" },
    ...
    { "createFunctionCallbackChainner", NULL, "LRAREFunctionCallbackChainner", 0x9, NULL },
  ...
  static J2ObjcClassInfo _RAREFunctions = { "Functions", "com.appnativa.rare.scripting", NULL, 0x1, 174, methods, 54, fields, 0, NULL};
