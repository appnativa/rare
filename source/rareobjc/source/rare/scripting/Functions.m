...
+ (int)FUNC_ENCODE {
  return RAREFunctions_FUNC_ENCODE;
}
...
+ (NSString *)base64WithNSString:(NSString *)val {
  ...
  return [RAREUTBase64 encodeWithByteArray:[((RAREUTUTF8Helper *) nil_chk([RAREUTUTF8Helper getInstance])) getBytesWithNSString:val]];
}
...
+ (NSString *)base64NOLFWithNSString:(NSString *)val {
  ...
  return [RAREUTBase64 encodeBytesWithByteArray:[((RAREUTUTF8Helper *) nil_chk([RAREUTUTF8Helper getInstance])) getBytesWithNSString:val] withInt:RAREUTBase64_DONT_BREAK_LINES];
}
...
+ (NSString *)codeBase {
  id u = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getCodeBase];
...
+ (NSString *)convertDateWithId:(id)date {
  return [RAREFunctions convertDateWithId:date withBoolean:YES];
}
...
+ (NSString *)convertDateWithId:(id)date
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    d = (JavaUtilDate *) check_class_cast([cvt fromStringWithNSString:[nil_chk(date) description] withRAREConverterContext:[((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateContext]], [JavaUtilDate class]);
  }
  return (NSString *) check_class_cast([((RAREDateContext *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateContext])) dateToStringWithJavaUtilDate:d], [NSString class]);
}
...
+ (NSString *)convertDateWithId:(id)date
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    RAREDateConverter *cvt = [[RAREDateConverter alloc] init];
    d = (JavaUtilDate *) check_class_cast([cvt fromStringWithNSString:s withRAREConverterContext:[((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateContext]], [JavaUtilDate class]);
  }
...
+ (NSString *)convertDateTimeWithId:(id)date {
  return [RAREFunctions convertDateTimeWithId:date withBoolean:YES];
}
...
+ (NSString *)convertDateTimeWithId:(id)date
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    d = (JavaUtilDate *) check_class_cast([cvt fromStringWithNSString:s withRAREConverterContext:[((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateTimeContext]], [JavaUtilDate class]);
  }
  return [((RAREDateContext *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateTimeContext])) dateToStringWithJavaUtilDate:d];
}
...
+ (NSString *)currentTimeWithNSString:(NSString *)format {
  JavaUtilDate *date = [[JavaUtilDate alloc] init];
  if (format == nil) {
    return [((RAREDateContext *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultTimeContext])) dateToStringWithJavaUtilDate:date];
  }
  JavaTextDateFormat *df = [[RAREUTSimpleDateFormatEx alloc] initWithNSString:format];
  return [df formatWithJavaUtilDate:date];
}

+ (NSString *)dateWithNSString:(NSString *)spec {
  return [RAREFunctions dateWithNSString:spec withNSString:nil];
}
...
+ (NSString *)dateWithNSString:(NSString *)spec
  ...
  if (format == nil) {
    return [((JavaTextDateFormat *) nil_chk([((RAREDateContext *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateContext])) getDisplayFormat])) formatWithJavaUtilDate:date];
  }
...
+ (NSString *)dateTimeWithNSString:(NSString *)spec {
  return [RAREFunctions dateTimeWithNSString:spec withNSString:nil];
}
...
+ (NSString *)dateTimeWithNSString:(NSString *)spec
  ...
  JavaUtilDate *date = [RAREUTHelper createDateWithNSString:spec];
  if (format == nil) {
    return [((RAREDateContext *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDefaultDateTimeContext])) dateToStringWithJavaUtilDate:date];
  }
  JavaTextDateFormat *df = [[RAREUTSimpleDateFormatEx alloc] initWithNSString:format];
  return [df formatWithJavaUtilDate:date];
}
...
+ (NSString *)encodeWithNSString:(NSString *)str {
  return [RAREUTURLEncoder encodeComponentWithNSString:str];
}

+ (NSString *)encodeUrlWithNSString:(NSString *)str {
  return [RAREUTURLEncoder encodeUrlWithNSString:str];
}
...
- (NSString *)executeFunctionWithRAREiWidget:(id<RAREiWidget>)context
  ...
  int plen = (parameters == nil) ? 0 : (int) [parameters count];
  {
    ...
    switch ([((JavaLangInteger *) nil_chk(in)) intValue]) {
      case RAREFunctions_FUNC_ENCODE:
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:1];
      return [RAREUTURLEncoder encodeComponentWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0)];
      ...
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:1];
      color = [((RAREUIColor *) nil_chk([RAREColorUtils getColorWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0)])) toHexString];
      if (plen > 1) {
      ...
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:1];
      return [RAREFunctions dateWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0)];
      case RAREFunctions_FUNC_CURRENT_TIME:
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:1];
      return [RAREFunctions currentTimeWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0)];
      case RAREFunctions_FUNC_DATE_TIME:
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:1];
      s = (plen < 2) ? nil : IOSObjectArray_Get(nil_chk(parameters), 1);
      return [RAREFunctions dateTimeWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0) withNSString:s];
      ...
      return [RAREFunctions codeBase];
      case RAREFunctions_FUNC_RFORMAT:
      [RAREFunctions checkParmLengthWithRAREiWidget:context withInt:plen withInt:2];
      if (plen == 2) {
        return [RAREFunctions rformatWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0) withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ IOSObjectArray_Get(parameters, 1) } count:1 type:[IOSClass classWithClass:[NSObject class]]]];
      }
      ...
      return [RAREFunctions rformatWithNSString:IOSObjectArray_Get(nil_chk(parameters), 0) withNSObjectArray:(IOSObjectArray *) check_class_cast(a, [IOSObjectArray class])];
      case RAREFunctions_FUNC_SERVERBASE:
      return [RAREFunctions serverBase];
      case RAREFunctions_FUNC_DOCBASE:
      return [RAREFunctions documentBase];
      case RAREFunctions_FUNC_APPURL:
      return [RAREFunctions applicationURL];
...
+ (NSString *)formatWithNSString:(NSString *)pattern
  ...
  if ((int) [((IOSObjectArray *) nil_chk(args)) count] == 1) {
    ...
    if (([obj isKindOfClass:[JavaUtilDate class]]) || ([obj isKindOfClass:[JavaUtilCalendar class]])) {
      return [RAREFunctions convertDateWithId:obj withNSString:pattern];
    }
  }
...
+ (NSString *)rformatWithNSString:(NSString *)resource_string
                withNSObjectArray:(IOSObjectArray *)args {
  resource_string = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getResourceAsStringWithNSString:resource_string];
...
+ (NSString *)serverBase {
  JavaNetURL *u = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getCodeBase];
  if (u == nil) {
    u = [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getApplicationURL];
  }
...
+ (NSString *)stringValueWithId:(id)obj {
  ...
  if (([obj isKindOfClass:[JavaUtilDate class]]) || ([obj isKindOfClass:[JavaUtilCalendar class]])) {
    return [RAREFunctions convertDateTimeWithId:obj withBoolean:YES];
  }
...
+ (void)initializeFunctionMap {
  ...
  (void) [RAREFunctions_functionMap_ putWithId:@"encode" withId:in = [JavaLangInteger valueOfWithInt:RAREFunctions_FUNC_ENCODE]];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "convertDateWithId:", NULL, "LNSString", 0x9, NULL },
    { "convertDateWithId:withBoolean:", NULL, "LNSString", 0x9, NULL },
    { "convertDateWithId:withNSString:", NULL, "LNSString", 0x9, NULL },
    { "convertDateWithId:withNSString:withNSString:", NULL, "LNSString", 0x9, NULL },
    { "convertDateTimeWithId:", NULL, "LNSString", 0x9, NULL },
    { "convertDateTimeWithId:withBoolean:", NULL, "LNSString", 0x9, NULL },
    ...
    { "encodeUrlWithNSString:", NULL, "LNSString", 0x9, NULL },
    ...
    { "rformatWithNSString:withNSObjectArray:", NULL, "LNSString", 0x89, NULL },
  ...
  static J2ObjcClassInfo _RAREFunctions = { "Functions", "com.appnativa.rare.scripting", NULL, 0x1, 165, methods, 54, fields, 0, NULL};
