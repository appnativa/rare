...
static id<JavaUtilList> RAREJavaScriptEngineFactory_loadedEngines_;
...
+ (id<JavaUtilList>)loadedEngines {
  return RAREJavaScriptEngineFactory_loadedEngines_;
}

+ (void)setLoadedEngines:(id<JavaUtilList>)loadedEngines {
  RAREJavaScriptEngineFactory_loadedEngines_ = loadedEngines;
}
...
- (void)disposingWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)e {
  @synchronized (RAREJavaScriptEngineFactory_loadedEngines_) {
    [((id<JavaUtilList>) nil_chk(RAREJavaScriptEngineFactory_loadedEngines_)) removeWithId:e];
  }
}

- (id<JavaxScriptScriptEngine>)getScriptEngine {
  RAREJavaScriptEngine *e = [[RAREJavaScriptEngine alloc] initWithRAREJavaScriptEngineFactory:self];
  @synchronized (RAREJavaScriptEngineFactory_loadedEngines_) {
    [((id<JavaUtilList>) nil_chk(RAREJavaScriptEngineFactory_loadedEngines_)) addWithId:e];
  }
  return e;
}
...
+ (void)initialize {
  if (self == [RAREJavaScriptEngineFactory class]) {
    RAREJavaScriptEngineFactory_loadedEngines_ = [[RAREUTIdentityArrayList alloc] initWithInt:2];
    {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "loadedEngines_", NULL, 0xa, "LJavaUtilList" },
  };
  static J2ObjcClassInfo _RAREJavaScriptEngineFactory = { "JavaScriptEngineFactory", "com.appnativa.rare.scripting", NULL, 0x1, 12, methods, 4, fields, 0, NULL};
