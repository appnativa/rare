...
- (RAREWindowViewer *)createWindowViewerWithRAREiPlatformAppContext:(id<RAREiPlatformAppContext>)ctx
  ...
  return [[RAREWindowViewer alloc] initWithRAREiPlatformAppContext:ctx withNSString:name withRAREFrame:(RAREFrame *) check_class_cast(win, [RAREFrame class]) withRAREWindowViewer:parent withRAREiScriptHandler:sh];
}
