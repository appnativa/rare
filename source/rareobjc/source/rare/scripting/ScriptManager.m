...
- (void)initializeEngineWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)engine
  ...
  [je setConstantValueWithNSString:@"Image" withId:[IOSClass classWithClass:[RAREImage class]]];
  [je setPopulatingConstantsWithBoolean:NO];
}
...
- (void)setupDynamicBindingsWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)e
  ...
  [sc setBindingsWithJavaxScriptBindings:[[RAREDynamicBindings alloc] initWithJavaxScriptBindings:[((id<JavaxScriptScriptContext>) nil_chk(sc)) getBindingsWithInt:JavaxScriptScriptContext_GLOBAL_SCOPE] withRAREaScriptManager:self] withInt:JavaxScriptScriptContext_GLOBAL_SCOPE];
}
...
- (NSString *)getResourceStreamAsStringWithNSString:(NSString *)source {
  @try {
    ...
    if (url != nil) {
      RAREActionLink *l = [[RAREActionLink alloc] initWithRAREUTiURLResolver:nil withJavaNetURL:url];
...
- (BOOL)releaseEngineExWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)e {
  RAREJavaScriptEngine *je = (RAREJavaScriptEngine *) check_class_cast(e, [RAREJavaScriptEngine class]);
  [((RAREJavaScriptEngine *) nil_chk(je)) dispose];
  return YES;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "releaseEngineExWithJavaxScriptScriptEngine:", NULL, "Z", 0x1, NULL },
  };
  static J2ObjcClassInfo _RAREScriptManager = { "ScriptManager", "com.appnativa.rare.scripting", NULL, 0x1, 26, methods, 0, NULL, 0, NULL};
