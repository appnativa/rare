...
static RAREJSCocoaBindings_GlobalVariables * RAREJSCocoaBindings_globalVars_;

+ (RAREJSCocoaBindings_GlobalVariables *)globalVars {
  return RAREJSCocoaBindings_globalVars_;
}

+ (void)setGlobalVars:(RAREJSCocoaBindings_GlobalVariables *)globalVars {
  RAREJSCocoaBindings_globalVars_ = globalVars;
}
...
- (void)clear {
  [super clear];
  [((RAREJSCocoaBindings_GlobalVariables *) nil_chk(RAREJSCocoaBindings_globalVars_)) clear];
}

- (BOOL)containsKeyWithId:(id)key {
  RAREJSCocoaBindings_GlobalVariables *gv = RAREJSCocoaBindings_globalVars_;
...
+ (void)initialize {
  if (self == [RAREJSCocoaBindings class]) {
    RAREJSCocoaBindings_globalVars_ = [[RAREJSCocoaBindings_GlobalVariables alloc] init];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "globalVars_", NULL, 0x8, "LRAREJSCocoaBindings_GlobalVariables" },
  };
