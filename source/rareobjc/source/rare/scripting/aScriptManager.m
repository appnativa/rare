...
- (id)initWithRAREiPlatformAppContext:(id<RAREiPlatformAppContext>)app
  ...
  if (self = [super init]) {
    ...
    @try {
      ...
      [scriptContext_ setAttributeWithNSString:@"window" withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      [scriptContext_ setAttributeWithNSString:@"_top" withId:theWindow_ withInt:JavaxScriptScriptContext_GLOBAL_SCOPE];
      [scriptContext_ setAttributeWithNSString:[RAREDynamicBindings WINDOW] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      [scriptContext_ setAttributeWithNSString:[RAREDynamicBindings FORM] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      [scriptContext_ setAttributeWithNSString:[RAREDynamicBindings WIDGET] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      scriptWidget_ = theWindow_;
      scriptForm_ = theWindow_;
      scriptWindow_ = theWindow_;
...
- (RAREWidgetContext *)createScriptingContextWithId:(id)javaobj {
  ...
  if ([javaobj conformsToProtocol: @protocol(RAREiWidget)]) {
    ...
    RAREaWidget *c = (RAREaWidget *) check_class_cast([((id<RAREiWidget>) nil_chk(w)) getParent], [RAREaWidget class]);
    while ((c != nil) && (c != theWindow_)) {
      RAREWidgetContext *fc = [((RAREaWidget *) nil_chk(c)) getScriptingContextEx];
      if ((fc != nil) && (fc->scriptContext_ != nil)) {
        engine = fc->scriptEngine_;
        ((RAREWidgetContext *) nil_chk(oc))->scriptContext_ = fc->scriptContext_;
        break;
      }
      c = (RAREaWidget *) check_class_cast([c getParent], [RAREaWidget class]);
    }
  }
...
- (void)dispose {
  ...
  if ([RAREPlatform isShuttingDown]) {
    ...
    if (scriptContext_ != nil) {
      [scriptContext_ setAttributeWithNSString:[RAREDynamicBindings WINDOW] withId:nil withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
...
- (void)setGlobalVariableWithNSString:(NSString *)name
                               withId:(id)value {
  if (![@"self" isEqual:name] && ![((NSString *) nil_chk([RAREDynamicBindings WINDOW])) isEqual:name]) {
...
- (RAREWidgetContext *)setScriptingContextWithRAREiViewer:(id<RAREiViewer>)viewer
  ...
  id<JavaxScriptScriptEngine> engine = [self getEngineWithNSString:type withBoolean:shared withJavaxScriptScriptContext:nil];
  if (!shared) {
    ...
    if ([((id<RAREiPlatformAppContext>) nil_chk([((id<RAREiViewer>) nil_chk(viewer)) getAppContext])) isDynamicNameLookupEnabled]) {
      [self setupDynamicBindingsWithJavaxScriptScriptEngine:engine withJavaxScriptScriptContext:ctx];
    }
    else {
      [ctx setBindingsWithJavaxScriptBindings:[((id<JavaxScriptScriptEngine>) nil_chk(engine)) createBindings] withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
    }
    [self initializeEngineWithJavaxScriptScriptEngine:engine withJavaxScriptScriptContext:ctx];
    [self initializeEngineExWithJavaxScriptScriptEngine:engine withJavaxScriptScriptContext:ctx];
    [ctx setAttributeWithNSString:[RAREDynamicBindings WINDOW] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
    [ctx setAttributeWithNSString:[RAREDynamicBindings FORM] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
    [ctx setAttributeWithNSString:[RAREDynamicBindings WIDGET] withId:theWindow_ withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
  }
  else {
    ctx = scriptContext_;
  }
  ...
  if (source != nil) {
    @try {
      JavaUtilEventObject *e = [[RAREEventBase alloc] initWithId:viewer];
...
- (RAREWindowViewer *)getCurrentWindowViewer {
  ...
  if (scriptContext_ != nil) {
    w = (RAREWindowViewer *) check_class_cast([scriptContext_ getAttributeWithNSString:[RAREDynamicBindings WINDOW] withInt:JavaxScriptScriptContext_ENGINE_SCOPE], [RAREWindowViewer class]);
...
- (BOOL)canReuseEnginesForNonSharedScripts {
  return YES;
}
...
- (id<JavaxScriptScriptEngine>)getEngineWithNSString:(NSString *)type
  ...
  @synchronized (RAREaScriptManager_loadedEngines_) {
    ...
    if (reuse || [self canReuseEnginesForNonSharedScripts]) {
      if (lang == nil) {
        lang = language;
      }
      if (lang != nil) {
...
- (id<RAREiScriptHandler_iScriptRunnable>)createRunnerWithRAREWidgetContext:(RAREWidgetContext *)context
  ...
  else if ([code conformsToProtocol: @protocol(RAREiEventHandler)]) {
    code = [[RAREaScriptManager_EventHandlerInterfaceScript alloc] initWithJavaxScriptScriptEngine:se withJavaxScriptScriptContext:sc withRAREEventHandlerInterface:[[RAREEventHandlerInterface alloc] initWithRAREiEventHandler:(id<RAREiEventHandler>) check_protocol_cast(code, @protocol(RAREiEventHandler))]];
  }
...
- (void)initializeEngineExWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)engine
  ...
  @try {
    NSString *source = [NSString stringWithFormat:@"%@.init", [((NSString *) nil_chk([((id<JavaxScriptScriptEngineFactory>) nil_chk([((id<JavaxScriptScriptEngine>) nil_chk(engine)) getFactory])) getLanguageName])) lowercaseStringWithJRELocale:[JavaUtilLocale US]]];
...
- (void)setupDynamicBindingsWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)e
  ...
  [sc setBindingsWithJavaxScriptBindings:[[RAREDynamicBindings alloc] initWithJavaxScriptBindings:[((id<JavaxScriptScriptContext>) nil_chk(sc)) getBindingsWithInt:JavaxScriptScriptContext_ENGINE_SCOPE] withRAREaScriptManager:self] withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
}
...
+ (void)releaseEngineWithId:(id)scriptEngine {
  if (![RAREPlatform isShuttingDown]) {
    id<JavaxScriptScriptEngine> engine = (id<JavaxScriptScriptEngine>) check_protocol_cast(scriptEngine, @protocol(JavaxScriptScriptEngine));
    [((RAREaScriptManager *) check_class_cast([((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) getScriptHandler], [RAREaScriptManager class])) releaseEngineExWithJavaxScriptScriptEngine:engine];
  }
}

- (BOOL)releaseEngineExWithJavaxScriptScriptEngine:(id<JavaxScriptScriptEngine>)e {
  // can't call an abstract method
  [self doesNotRecognizeSelector:_cmd];
  return 0;
}
...
- (void)copyAllFieldsTo:(RAREaScriptManager *)other {
  ...
  other->scriptForm_ = scriptForm_;
  other->scriptName_ = scriptName_;
  other->scriptWidget_ = scriptWidget_;
  other->scriptWindow_ = scriptWindow_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "canReuseEnginesForNonSharedScripts", NULL, "Z", 0x4, NULL },
    ...
    { "releaseEngineExWithJavaxScriptScriptEngine:", NULL, "Z", 0x401, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "scriptWidget_", NULL, 0x1, "LRAREiWidget" },
    { "scriptForm_", NULL, 0x1, "LRAREiFormViewer" },
    { "scriptWindow_", NULL, 0x1, "LRAREWindowViewer" },
  };
  static J2ObjcClassInfo _RAREaScriptManager = { "aScriptManager", "com.appnativa.rare.scripting", NULL, 0x401, 59, methods, 26, fields, 0, NULL};
...
- (void)copyAllFieldsTo:(RAREaScriptManager_aCompiledScript *)other {
  ...
  other->scriptEvent_ = scriptEvent_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "scriptEvent_", NULL, 0x0, "LRAREScriptingEvent" },
  };
  static J2ObjcClassInfo _RAREaScriptManager_aCompiledScript = { "aCompiledScript", "com.appnativa.rare.scripting", "aScriptManager", 0x40c, 3, methods, 7, fields, 0, NULL};
...
- (id)evalWithJavaxScriptScriptContext:(id<JavaxScriptScriptContext>)context {
  ...
  for (int i = 0; i < len; i++) {
    ...
    if ([o isKindOfClass:[JavaxScriptCompiledScript class]]) {
      ...
      NSString *code = (NSString *) check_class_cast(o, [NSString class]);
      if ([((NSString *) nil_chk(code)) hasPrefix:@"class:"]) {
        RAREaWidget *w = (RAREaWidget *) check_class_cast([((RAREWidgetContext *) nil_chk(widgetContext_)) getWidget], [RAREaWidget class]);
        w = [RAREPlatform getWindowViewer];
        code = [((RAREaWidget *) nil_chk(w)) expandStringWithNSString:code];
        RAREaScriptManager_EventHandlerInterfaceScript *eis = [[RAREaScriptManager_EventHandlerInterfaceScript alloc] initWithJavaxScriptScriptEngine:engine_ withJavaxScriptScriptContext:context withRAREEventHandlerInterface:[[RAREEventHandlerInterface alloc] initWithNSString:code]];
        [eis setEnvironmentWithRAREaScriptManager:scriptManager_ withRAREWidgetContext:widgetContext_ withRAREScriptingEvent:scriptEvent_];
        (void) [list setWithInt:i withId:eis];
        (void) [eis evalWithJavaxScriptScriptContext:context];
      }
      else {
        RAREaScriptManager_CompiledScriptEx *cs = (RAREaScriptManager_CompiledScriptEx *) check_class_cast([self compileWithNSString:(NSString *) check_class_cast(o, [NSString class]) withJavaxScriptScriptContext:context], [RAREaScriptManager_CompiledScriptEx class]);
        (void) [list setWithInt:i withId:cs];
        [((RAREaScriptManager_CompiledScriptEx *) nil_chk(cs)) setEnvironmentWithRAREaScriptManager:scriptManager_ withRAREWidgetContext:widgetContext_ withRAREScriptingEvent:scriptEvent_];
        (void) [cs evalWithJavaxScriptScriptContext:context];
      }
    }
    ...
    else if ([o isKindOfClass:[RAREaScriptManager_EventHandlerInterfaceScript class]]) {
      (void) [((RAREaScriptManager_EventHandlerInterfaceScript *) check_class_cast(o, [RAREaScriptManager_EventHandlerInterfaceScript class])) evalWithJavaxScriptScriptContext:context];
    }
  }
  return nil;
}
...
- (id)executeCodeWithRAREWindowViewer:(RAREWindowViewer *)win
  ...
  if (scriptContext == nil) {
    scriptContext = (id<JavaxScriptScriptContext>) check_protocol_cast(((RAREWidgetContext *) nil_chk([((RAREWindowViewer *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getMainWindowViewer])) getScriptingContext]))->scriptContext_, @protocol(JavaxScriptScriptContext));
  }
  ...
  id<RAREiWidget> savedWidget = ((RAREaScriptManager *) nil_chk(sm))->scriptWidget_;
  id<RAREiFormViewer> savedForm = sm->scriptForm_;
  RAREWindowViewer *savedWindow = sm->scriptWindow_;
  id savedName = nil;
  id<RAREiFormViewer> form = (w == nil) ? nil : [w getFormViewer];
  @try {
    if (!backgroundExecution) {
      sm->scriptWidget_ = w;
      sm->scriptForm_ = form;
      sm->scriptWindow_ = win;
      [((id<JavaxScriptScriptContext>) nil_chk(scriptContext)) setAttributeWithNSString:[RAREDynamicBindings WIDGET] withId:w withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      ...
      [scriptContext setAttributeWithNSString:[RAREDynamicBindings WINDOW] withId:win withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      if (runContext_->scriptName_ != nil) {
        savedName = [scriptContext getAttributeWithNSString:[JavaxScriptScriptEngine FILENAME] withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
        ...
        sm->executingScriptName_ = runContext_->scriptName_;
      }
    }
    if (cs != nil) {
      if (sm->tracingEnabled_) {
  ...
  @finally {
    if (!backgroundExecution) {
      sm->scriptWidget_ = savedWidget;
      sm->scriptWindow_ = savedWindow;
      sm->scriptForm_ = savedForm;
      [((id<JavaxScriptScriptContext>) nil_chk(scriptContext)) setAttributeWithNSString:[RAREDynamicBindings WINDOW] withId:savedWindow withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      [scriptContext setAttributeWithNSString:[RAREDynamicBindings WIDGET] withId:savedWidget withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      [scriptContext setAttributeWithNSString:[RAREDynamicBindings FORM] withId:savedForm withInt:JavaxScriptScriptContext_ENGINE_SCOPE];
      if ((runContext_->scriptName_ != nil)) {
