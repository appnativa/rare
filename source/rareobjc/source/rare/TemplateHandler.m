...
- (RARETemplateHandler_Template *)loadTemplateWithRAREiWidget:(id<RAREiWidget>)context
                                           withRAREActionLink:(RAREActionLink *)link
                                                 ...
                                                 withNSString:(NSString *)name {
  @try {
    return [self loadTemplateWithRAREiWidget:context withJavaNetURL:[((RAREActionLink *) nil_chk(link)) getURLWithRAREUTiURLResolver:context] withBoolean:cache withNSString:name];
  }
  @catch (JavaNetMalformedURLException *ex) {
...
- (void)setDefaultTemplateExWithRAREiWidget:(id<RAREiWidget>)context
                               withNSString:(NSString *)url
                                withBoolean:(BOOL)cache {
  RAREActionLink *link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:[((id<RAREiWidget>) nil_chk(context)) getURLWithNSString:url]];
  _autoSkin_ = NO;
  [((RAREUTIdentityArrayList *) nil_chk(_contextStack_)) clear];
  [((JavaUtilIdentityHashMap *) nil_chk(_contextMap_)) clear];
  _defaultTemplate_ = nil;
...
- (RARETemplateHandler_Template *)loadContextTemplateWithSPOTSequence:(SPOTSequence *)seq
  ...
  RAREActionLink *link = [RAREActionLink getActionLinkWithRAREUTiURLResolver:[self getContext] withSPOTPrintableString:ps withInt:0];
...
+ (BOOL)hasWidgetTemplateWithNSString:(NSString *)name {
  RARETemplateHandler_Template *t = [((RARETemplateHandler *) nil_chk([RARETemplateHandler getInstanceWithRAREiPlatformAppContext:[RAREPlatform getAppContext]])) getContextTemplate];
  ;
  return [t == nil ? nil : [JavaLangBoolean valueOfWithBoolean:[t getWidgetWithNSString:name] != nil] booleanValue];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "hasWidgetTemplateWithNSString:", NULL, "Z", 0x9, NULL },
  };
  ...
  static J2ObjcClassInfo _RARETemplateHandler = { "TemplateHandler", "com.appnativa.rare", NULL, 0x1, 17, methods, 11, fields, 0, NULL};
