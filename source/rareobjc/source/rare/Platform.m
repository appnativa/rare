...
+ (id)createObjectWithNSString:(NSString *)className_ {
  @try {
    IOSClass *cls = [RAREPlatform loadClassWithNSString:className_];
...
+ (void)debugLogWithNSString:(NSString *)msg {
  if (RAREPlatform_platform_ == nil) {
    ...
    [RAREPlatform_platform_ debugLogWithNSString:msg];
  }
}
...
+ (void)ignoreExceptionWithNSString:(NSString *)msg
  ...
  if (RAREPlatform_platform_ == nil) {
    ...
    [RAREPlatform_platform_ ignoreExceptionWithNSString:msg withJavaLangThrowable:throwable];
  }
}
...
+ (void)ignoreExceptionWithJavaLangThrowable:(JavaLangThrowable *)throwable {
  if (RAREPlatform_platform_ == nil) {
    ...
    [RAREPlatform_platform_ ignoreExceptionWithNSString:nil withJavaLangThrowable:throwable];
  }
}
...
+ (IOSClass *)loadClassWithNSString:(NSString *)className_ {
  NSString *defaultPackage = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getStringWithNSString:@"Rare.class.defaultPackage"];
  if ((defaultPackage != nil)) {
    int n = [((NSString *) nil_chk(className_)) indexOf:'.'];
    NSString *name = nil;
    if (n == 0) {
      name = [NSString stringWithFormat:@"%@%@", defaultPackage, className_];
    }
    else if (n == -1) {
      name = [NSString stringWithFormat:@"%@.%@", defaultPackage, className_];
    }
    if (name != nil) {
      @try {
        IOSClass *cls = [((id<RAREiPlatform>) nil_chk(RAREPlatform_platform_)) loadClassWithNSString:name];
        if (cls != nil) {
          return cls;
        }
      }
...
+ (id<RAREiViewer>)getContextRootViewer {
  id<RAREiPlatformAppContext> ctx = (RAREPlatform_platform_ == nil) ? nil : [RAREPlatform_platform_ getAppContext];
  return (ctx == nil) ? nil : [ctx getRootViewer];
}
...
+ (RAREWindowViewer *)getWindowViewer {
  return [((id<RAREiPlatformAppContext>) nil_chk([((id<RAREiPlatform>) nil_chk(RAREPlatform_platform_)) getAppContext])) getMainWindowViewer];
}
...
+ (BOOL)hasPhysicalKeyboard {
  return [((id<RAREiPlatform>) nil_chk(RAREPlatform_platform_)) hasPhysicalKeyboard];
}

+ (BOOL)hasPointingDevice {
  return [((id<RAREiPlatform>) nil_chk(RAREPlatform_platform_)) hasPointingDevice];
}
...
+ (id<RAREiMultipartMimeHandler>)getMultipartMimeHandler {
  return (RAREPlatform_platform_ == nil) ? nil : [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform_platform_ getAppContext])) getMultipartMimeHandler];
}

+ (JavaNetURL *)createURLWithJavaNetURL:(JavaNetURL *)context
                           withNSString:(NSString *)url {
  return (RAREPlatform_platform_ == nil) ? [[JavaNetURL alloc] initWithJavaNetURL:context withNSString:url] : [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform_platform_ getAppContext])) createURLWithJavaNetURL:context withNSString:url];
}

+ (id<RAREUTiURLResolver>)getDefaultURLResolver {
  id<RAREiPlatformAppContext> ctx = (RAREPlatform_platform_ == nil) ? nil : [RAREPlatform_platform_ getAppContext];
  return (ctx == nil) ? nil : (id<RAREUTiURLResolver>) check_protocol_cast([ctx getDefaultURLResolver], @protocol(RAREUTiURLResolver));
}

+ (void)setMaxBackgroundThreadCountWithInt:(int)max {
  [RAREaPlatformHelper setMaxBackgroundThreadCountWithInt:max];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "openConnectionWithJavaNetURL:withNSString:", NULL, "LRAREiURLConnection", 0x9, "JavaIoIOException" },
    ...
    { "getMultipartMimeHandler", NULL, "LRAREiMultipartMimeHandler", 0x9, NULL },
    { "createURLWithJavaNetURL:withNSString:", NULL, "LJavaNetURL", 0x9, "JavaNetMalformedURLException" },
    { "getDefaultURLResolver", NULL, "LRAREUTiURLResolver", 0x9, NULL },
  };
  ...
  static J2ObjcClassInfo _RAREPlatform = { "Platform", "com.appnativa.rare", NULL, 0x1, 74, methods, 3, fields, 0, NULL};
