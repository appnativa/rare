...
+ (IOSClass *)loadClassWithNSString:(NSString *)className_ {
  ...
  if (defaultPackage != nil && ![((NSString *) nil_chk(className_)) hasPrefix:defaultPackage]) {
    NSString *name = [NSString stringWithFormat:@"%@.%@", defaultPackage, className_];
    @try {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREPlatform = { "Platform", "com.appnativa.rare", NULL, 0x1, 71, methods, 3, fields, 0, NULL};
