...
- (void)run {
  ...
  if (!canceled_ && done_ && (task_ != nil)) {
    if ([RAREPlatform isUIThread]) {
      if (exception_ != nil) {
        @throw [RAREApplicationException runtimeExceptionWithJavaLangThrowable:exception_];
      }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "result_", NULL, 0x0, "LNSObject" },
    { "exception_", NULL, 0x0, "LJavaLangThrowable" },
  };
  static J2ObjcClassInfo _RARECancelableWorker = { "CancelableWorker", "com.appnativa.rare", NULL, 0x1, 2, methods, 5, fields, 0, NULL};
