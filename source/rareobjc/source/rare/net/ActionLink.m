...
- (id)initWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
  ...
  if (self = [self initRAREActionLinkWithRAREUTiURLResolver:context withSPOTPrintableString:((RARESPOTLink *) nil_chk(link))->url_]) {
    urlResolver_ = context;
...
- (id)initRAREActionLinkWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
  ...
  if (self = [super init]) {
    ...
    if (inlineURL_) {
      ...
      @try {
        theURL_ = [RAREScriptURLConnection createURLWithRAREiWidget:[self getContext] withNSString:[stringURL_ substring:7] withNSString:mimeType_];
      }
...
- (id)initWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
         withSPOTPrintableString:(SPOTPrintableString *)url {
  return [self initRAREActionLinkWithRAREUTiURLResolver:context withSPOTPrintableString:url];
}
...
- (id<JavaUtilCollection>)getCollection {
  id<RAREiWidget> w = [self getContext];
  if (w == nil) {
...
- (id<RAREiWidget>)getContext {
  if ([(id) urlResolver_ conformsToProtocol: @protocol(RAREiWidget)]) {
    return (id<RAREiWidget>) check_protocol_cast(urlResolver_, @protocol(RAREiWidget));
  }
  return nil;
}
...
- (id<RAREiMultipartMimeHandler_iMultipart>)getFirstPart {
  if (multiPart_ == nil) {
    id<RAREiMultipartMimeHandler> mh = [RAREPlatform getMultipartMimeHandler];
...
- (NSString *)getStringURLWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context {
  if (stringURL_ != nil) {
    return stringURL_;
  }
  JavaNetURL *u = [self getURLWithRAREUTiURLResolver:context];
...
- (JavaNetURL *)getURLWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context {
  if (theURL_ == nil) {
    if (urlConnection_ != nil) {
  ...
  if ((theURL_ == nil) && (stringURL_ != nil)) {
    if (urlResolver_ != nil) {
      context = urlResolver_;
    }
    if (context == nil) {
      context = [RAREPlatform getContextRootViewer];
    }
    if (context == nil) {
      theURL_ = [[JavaNetURL alloc] initWithNSString:stringURL_];
    }
    else {
      JavaNetURL *curl = (contextURL_ == nil) ? [context getBaseURL] : contextURL_;
      if ([(id) context conformsToProtocol: @protocol(RAREiWidget)]) {
        theURL_ = [RAREPlatform createURLWithJavaNetURL:curl withNSString:[((id<RAREiWidget>) check_protocol_cast(context, @protocol(RAREiWidget))) expandStringWithNSString:stringURL_ withBoolean:NO]];
      }
      else {
        theURL_ = [RAREPlatform createURLWithJavaNetURL:curl withNSString:stringURL_];
      }
    }
  }
  return theURL_;
...
- (JavaNetURL *)getURLWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
  ...
  if ((queryString == nil) || ([queryString sequenceLength] == 0)) {
    return [self getURLWithRAREUTiURLResolver:context];
  }
  JavaNetURL *u = [self getURLWithRAREUTiURLResolver:context];
...
- (id<JavaUtilMap>)getWindowOptions {
  id<RAREiWidget> widget;
  if ([(id) urlResolver_ conformsToProtocol: @protocol(RAREiWidget)]) {
    widget = (id<RAREiWidget>) check_protocol_cast(urlResolver_, @protocol(RAREiWidget));
  }
  else {
...
- (BOOL)isDeferred {
  return [self isDeferredWithRAREUTiURLResolver:nil];
}

- (BOOL)isDeferredWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context {
  if (viewerConfiguration_ != nil || ([(id) context conformsToProtocol: @protocol(RAREiWidget)] && [((id<RAREiWidget>) check_protocol_cast(context, @protocol(RAREiWidget))) isDesignMode])) {
    return NO;
  }
  if (context == nil) {
    context = self->urlResolver_;
  }
  if ([self isInlineURL]) {
    return NO;
  }
  ...
  @try {
    JavaNetURL *url = [self getURLWithRAREUTiURLResolver:context];
...
- (void)loadLaterWithRAREiWidget:(id<RAREiWidget>)widget {
  ...
  (void) [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) executeBackgroundTaskWithJavaLangRunnable:r];
}
...
- (void)run {
  ...
  id<RAREiPlatformWindowManager> w = [((id<RAREiPlatformAppContext>) nil_chk([((id<RAREiWidget>) nil_chk(widget)) getAppContext])) getWindowManager];
...
- (NSString *)sendFormDataWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
  ...
  return [self sendFormDataWithRAREUTiURLResolver:context withJavaUtilMap:map withBoolean:NO withBoolean:YES];
}

- (NSString *)sendFormDataWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                                 withJavaUtilMap:(id<JavaUtilMap>)data {
  return [self sendFormDataWithRAREUTiURLResolver:context withJavaUtilMap:data withBoolean:NO withBoolean:YES];
}
...
- (NSString *)sendFormDataWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                                 withJavaUtilMap:(id<JavaUtilMap>)data
                                     ...
                                     withBoolean:(BOOL)return_content {
  return [self sendFormDataWithRAREUTiURLResolver:context withJavaUtilMap:data withBoolean:multipart withBoolean:return_content withBoolean:YES];
}
...
- (NSString *)sendFormDataWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                                 withJavaUtilMap:(id<JavaUtilMap>)data
                                     withBoolean:(BOOL)multipart
                                     withBoolean:(BOOL)return_content
                                     withBoolean:(BOOL)encodeValues {
  [self sendFormDataExWithRAREUTiURLResolver:context withJavaUtilMap:data withBoolean:multipart withBoolean:encodeValues];
  @try {
    if (return_content) {
      return [self getContentAsString];
    }
...
- (void)sendFormDataExWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                             withJavaUtilMap:(id<JavaUtilMap>)data
                                 withBoolean:(BOOL)multipart
                                 withBoolean:(BOOL)encodeValues {
  ...
  if (multipart) {
    ...
    writer = [self openForOutput];
    [RAREFormHelper writeHTTPContentWithBoolean:YES withJavaIoWriter:writer withNSString:[self getPartBoundary] withJavaUtilMap:data];
    if (linkAttributes_ != nil) {
      [RAREFormHelper writeHTTPContentWithBoolean:YES withJavaIoWriter:writer withNSString:[self getPartBoundary] withJavaUtilMap:linkAttributes_];
    }
    [RAREFormHelper writeBoundaryEndWithJavaIoWriter:writer withNSString:[self getPartBoundary]];
  }
  else {
    ...
    if ([self getRequestEncoding] == [RAREActionLink_RequestEncodingEnum JSON]) {
      ...
      (void) [w object];
      if (linkAttributes_ != nil) {
        [RAREFormHelper writeJSONValuesWithRAREUTJSONWriter:w withJavaUtilMap:linkAttributes_];
      }
      [RAREFormHelper writeJSONValuesWithRAREUTJSONWriter:w withJavaUtilMap:data];
      (void) [w endObject];
    }
    else {
      BOOL first = [RAREFormHelper writeHTTPValuesWithBoolean:YES withJavaIoWriter:writer withJavaUtilMap:data withBoolean:encodeValues];
      if (linkAttributes_ != nil) {
        [RAREFormHelper writeHTTPValuesWithBoolean:first withJavaIoWriter:writer withJavaUtilMap:linkAttributes_ withBoolean:YES];
      }
    }
  }
  [self closeOutput];
...
- (void)setContextWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context {
  self->urlResolver_ = context;
}
...
- (NSString *)description {
  ...
  if ((requestMethod_ == [RAREActionLink_RequestMethodEnum GET]) && (linkAttributes_ != nil)) {
    ...
    @try {
      [RAREFormHelper writeHTTPValuesWithBoolean:YES withJavaIoWriter:sw withJavaUtilMap:[self getAttributes] withBoolean:YES];
    }
...
- (void)uploadDataExWithId:(id)data
  ...
  if (linkAttributes_ != nil) {
    [RAREFormHelper writeHTTPContentWithBoolean:NO withJavaIoWriter:writer withNSString:[self getPartBoundary] withJavaUtilMap:linkAttributes_];
  }
  [RAREFormHelper writeBoundaryEndWithJavaIoWriter:writer withNSString:[self getPartBoundary]];
  [self closeOutput];
}
...
- (void)connectWithBoolean:(BOOL)output {
  ...
  id<RAREUTiURLResolver> widget = (urlResolver_ == nil) ? [RAREPlatform getDefaultURLResolver] : urlResolver_;
  switch ([method ordinal]) {
    ...
    case RAREActionLink_RequestMethod_DELETE:
    {
      if ([self getAttributes] != nil) {
        JavaIoStringWriter *sw = [[JavaIoStringWriter alloc] init];
        if ([RAREFormHelper writeHTTPValuesWithBoolean:YES withJavaIoWriter:sw withJavaUtilMap:[self getAttributes] withBoolean:YES]) {
          url = [self getURLWithRAREUTiURLResolver:widget withNSString:[sw description]];
        }
        else {
          url = [self getURLWithRAREUTiURLResolver:widget];
        }
      }
      else {
        url = [self getURLWithRAREUTiURLResolver:widget];
      ...
      if (widget == nil) {
        urlConnection_ = [[RAREJavaURLConnection alloc] initWithJavaNetURLConnection:[((JavaNetURL *) nil_chk(url)) openConnection]];
      }
      else {
        urlConnection_ = [RAREPlatform openConnectionWithJavaNetURL:url withNSString:mimeType_];
      }
    ...
    case RAREActionLink_RequestMethod_OPTIONS:
    {
      ...
      if (output) {
        ...
        if ([self getRequestEncoding] == [RAREActionLink_RequestEncodingEnum JSON]) {
          ...
          (void) [jw object];
          [RAREFormHelper writeJSONValuesWithRAREUTJSONWriter:jw withJavaUtilMap:[self getAttributes]];
          (void) [jw endObject];
        }
        else if ([self isMultiPartForm]) {
          [RAREFormHelper writeHTTPContentWithBoolean:YES withJavaIoWriter:w withNSString:[self getPartBoundary] withJavaUtilMap:[self getAttributes]];
          [RAREFormHelper writeBoundaryEndWithJavaIoWriter:w withNSString:[self getPartBoundary]];
        }
        else {
          [RAREFormHelper writeHTTPValuesWithBoolean:YES withJavaIoWriter:w withJavaUtilMap:[self getAttributes] withBoolean:YES];
        }
        [w flush];
        [self handlePostConnect];
      }
...
+ (RAREActionLink *)createInlineLinkIfNecessaryWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                                              withSPOTPrintableString:(SPOTPrintableString *)url {
  ...
  RAREActionLink *link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withSPOTPrintableString:url];
  ...
  RAREActionLink *l = [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withJavaNetURL:u];
  l->inlineURL_ = YES;
  return l;
}

+ (RAREActionLink *)getActionLinkWithRAREUTiURLResolver:(id<RAREUTiURLResolver>)context
                                withSPOTPrintableString:(SPOTPrintableString *)url
                                                withInt:(int)index {
  if ([((SPOTPrintableString *) nil_chk(url)) getValue] == nil) {
    return nil;
  ...
  return (index == 0) ? [[RAREActionLink alloc] initWithRAREUTiURLResolver:context withSPOTPrintableString:url] : nil;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getFirstPart", NULL, "LRAREiMultipartMimeHandler_iMultipart", 0x1, "JavaIoIOException" },
    ...
    { "getStringURLWithRAREUTiURLResolver:", NULL, "LNSString", 0x1, "JavaNetMalformedURLException" },
    { "getTargetName", NULL, "LNSString", 0x1, NULL },
    { "getUnescapingReader", NULL, "LJavaIoReader", 0x1, "JavaIoIOException" },
    { "getURLWithRAREUTiURLResolver:", NULL, "LJavaNetURL", 0x1, "JavaNetMalformedURLException" },
    { "getURLWithRAREUTiURLResolver:withNSString:", NULL, "LJavaNetURL", 0x1, "JavaNetMalformedURLException" },
    ...
    { "isDeferredWithRAREUTiURLResolver:", NULL, "Z", 0x1, NULL },
    ...
    { "sendFormDataWithRAREUTiURLResolver:withNSObjectArray:", NULL, "LNSString", 0x81, "JavaIoIOException" },
    { "sendFormDataWithRAREUTiURLResolver:withJavaUtilMap:", NULL, "LNSString", 0x1, "JavaIoIOException" },
    { "sendFormDataWithRAREUTiURLResolver:withJavaUtilMap:withBoolean:withBoolean:", NULL, "LNSString", 0x1, "JavaIoIOException" },
    { "sendFormDataWithRAREUTiURLResolver:withJavaUtilMap:withBoolean:withBoolean:withBoolean:", NULL, "LNSString", 0x1, "JavaIoIOException" },
    { "sendFormDataExWithRAREUTiURLResolver:withJavaUtilMap:withBoolean:withBoolean:", NULL, "V", 0x1, "JavaIoIOException" },
    ...
    { "createInlineLinkIfNecessaryWithRAREUTiURLResolver:withSPOTPrintableString:", NULL, "LRAREActionLink", 0x9, "JavaIoIOException" },
    { "getActionLinkWithRAREUTiURLResolver:withSPOTPrintableString:withInt:", NULL, "LRAREActionLink", 0x9, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "urlResolver_", NULL, 0x4, "LRAREUTiURLResolver" },
  ...
  static J2ObjcClassInfo _RAREActionLink = { "ActionLink", "com.appnativa.rare.net", NULL, 0x1, 83, methods, 56, fields, 0, NULL};
