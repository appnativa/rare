...
- (NSString *)description {
  if (stringURL_ != nil) {
    ...
    return (theURL_ == nil) ? [super description] : [RAREJavaURLConnection toExternalFormWithJavaNetURL:theURL_];
  }
}
    ...
    case RAREActionLink_RequestMethod_OPTIONS:
    {
      ...
      if (output) {
        ...
        if ([self getRequestEncoding] == [RAREActionLink_RequestEncodingEnum JSON]) {
          [RAREFormHelper writeJSONValuesWithRAREiWidget:contextWidget_ withJavaIoWriter:w withJavaUtilMap:[self getAttributes] withBoolean:YES withBoolean:NO];
        }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREActionLink = { "ActionLink", "com.appnativa.rare.net", NULL, 0x1, 81, methods, 56, fields, 0, NULL};
