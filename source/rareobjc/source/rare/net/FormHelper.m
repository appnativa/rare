...
+ (BOOL)writeHTTPValueWithBoolean:(BOOL)first
  ...
  for (int i = 0; i < len; i++) {
    ...
    [((JavaIoWriter *) nil_chk(writer)) writeWithInt:'='];
    if (encodeValue) {
      [RAREUTURLEncoder encodeComponentWithNSString:IOSObjectArray_Get(nil_chk(value), i) withNSString:@"ISO-8859-1" withJavaIoWriter:writer];
    }
    else {
...
+ (BOOL)writeHTTPValuesWithBoolean:(BOOL)first
  ...
  if (values != nil) {
    ...
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      ...
      [RAREUTURLEncoder encodeComponentWithNSString:(NSString *) check_class_cast([((id<JavaUtilMap_Entry>) nil_chk(e)) getKey], [NSString class]) withNSString:@"US-ASCII" withJavaIoWriter:writer];
      [((JavaIoWriter *) nil_chk(writer)) writeWithInt:'='];
      o = [e getValue];
      value = (o == nil) ? nil : [o description];
      if (value != nil) {
        if (encodeValue) {
          [RAREUTURLEncoder encodeComponentWithNSString:value withNSString:@"US-ASCII" withJavaIoWriter:writer];
        }
        else {
          [writer writeWithNSString:value];
        }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "writeHTTPContentWithBoolean:withJavaIoWriter:withNSString:withJavaUtilMap:", NULL, "V", 0x9, "JavaIoIOException" },
    ...
    { "writeHTTPValueWithBoolean:withJavaIoWriter:withNSString:withNSStringArray:withBoolean:", NULL, "Z", 0x9, "JavaIoIOException" },
    { "writeHTTPValuesWithBoolean:withJavaIoWriter:withJavaUtilMap:withBoolean:", NULL, "Z", 0x9, "JavaIoIOException" },
    { "writeJSONValuesWithRAREUTJSONWriter:withJavaUtilMap:", NULL, "Z", 0x9, "JavaIoIOException" },
    ...
    { "writeRawHTTPValuesWithBoolean:withJavaIoWriter:withJavaUtilMap:", NULL, "Z", 0x9, "JavaIoIOException" },
  };
