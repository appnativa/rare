...
+ (BOOL)writeHTTPValuesWithBoolean:(BOOL)first
  ...
  if (values != nil) {
    ...
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      ...
      [RAREURLEncoder encodeWithNSString:(NSString *) check_class_cast([((id<JavaUtilMap_Entry>) nil_chk(e)) getKey], [NSString class]) withNSString:@"US-ASCII" withJavaIoWriter:writer];
      [((JavaIoWriter *) nil_chk(writer)) writeWithInt:'='];
      o = [e getValue];
...
+ (BOOL)writeJSONValueWithBoolean:(BOOL)first
  ...
  while (i < len) {
    ...
    s = IOSObjectArray_Get(nil_chk(value), i++);
    if (s == nil) {
      [writer writeWithNSString:@"null"];
    }
    else {
      [RAREJSONHelper encodeWithNSString:s withJavaIoWriter:writer];
    }
  }
  [writer writeWithInt:']'];
  return YES;
...
+ (BOOL)writeJSONValuesWithRAREiWidget:(id<RAREiWidget>)context
  ...
  if ((values != nil) && (![values isEmpty])) {
    ...
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      ...
      e = [it next];
      [RAREJSONHelper encodeWithNSString:(NSString *) check_class_cast([((id<JavaUtilMap_Entry>) nil_chk(e)) getKey], [NSString class]) withJavaIoWriter:writer];
      [((JavaIoWriter *) nil_chk(writer)) writeWithNSString:@": "];
      o = [e getValue];
      value = (o == nil) ? nil : [o description];
      ...
      if (value != nil) {
        [RAREJSONHelper encodeWithNSString:value withJavaIoWriter:writer];
      }
      else {
        [writer writeWithNSString:@"null"];
      }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "writeJSONValueWithBoolean:withJavaIoWriter:withNSString:withIntArray:", NULL, "Z", 0x9, "JavaIoIOException" },
    { "writeJSONValueWithBoolean:withJavaIoWriter:withNSString:withNSStringArray:", NULL, "Z", 0x9, "JavaIoIOException" },
    { "writeJSONValuesWithRAREiWidget:withJavaIoWriter:withJavaUtilMap:withBoolean:withBoolean:", NULL, "Z", 0x9, "JavaIoIOException" },
  ...
  static J2ObjcClassInfo _RAREFormHelper = { "FormHelper", "com.appnativa.rare.net", NULL, 0x1, 20, methods, 2, fields, 0, NULL};
