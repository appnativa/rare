...
+ (JavaNetURL *)createCollectionURLWithRAREiWidget:(id<RAREiWidget>)context
  ...
  return [[JavaNetURL alloc] initWithNSString:@"http" withNSString:[RAREiConstants COLLECTION_PROTOCOL_HOSTSTRING] withInt:[((id<RAREiPlatformAppContext>) nil_chk(app)) hash] withNSString:[NSString stringWithFormat:@"%@?%@", collection, [context getPathName]]];
}
