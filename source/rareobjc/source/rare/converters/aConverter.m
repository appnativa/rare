...
+ (void)showRangeErrorWithJavaLangComparable:(id<JavaLangComparable>)minValue
  ...
  [((RAREWindowViewer *) nil_chk([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getWindowViewer])) setStatusWithNSString:[RAREaConverter getRangeErrorWithJavaLangComparable:minValue withJavaLangComparable:maxValue]];
}
