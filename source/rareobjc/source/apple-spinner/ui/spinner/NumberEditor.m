...
- (void)modelChanged {
  ...
  if (supportDecimalValues_) {
    [((RARETextFieldView *) nil_chk(v)) setKeyboardTypeWithRAREKeyboardTypeEnum:[RAREKeyboardTypeEnum DECIMAL_TYPE]];
  }
  else {
    [((RARETextFieldView *) nil_chk(v)) setKeyboardTypeWithRAREKeyboardTypeEnum:[RAREKeyboardTypeEnum NUMBER_TYPE]];
  }
  [((RARETextFieldView *) nil_chk(v)) setTextWithNSString:[nil_chk([((id<RAREiSpinnerModel>) nil_chk(spinnerModel_)) getValue]) description]];
