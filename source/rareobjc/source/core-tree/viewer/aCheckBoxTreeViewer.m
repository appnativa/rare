...
//  source: /Code/Dev/appNativa/source/rareobjc/../rare/core-tree/com/appnativa/rare/viewer/aCheckBoxTreeViewer.java
//
...
- (id)init {
  return [self initRAREaCheckBoxTreeViewerWithRAREiFormViewer:nil];
}

- (id)initRAREaCheckBoxTreeViewerWithRAREiFormViewer:(id<RAREiFormViewer>)fv {
...
- (id)initWithRAREiFormViewer:(id<RAREiFormViewer>)fv {
  return [self initRAREaCheckBoxTreeViewerWithRAREiFormViewer:fv];
}
...
- (BOOL)isValidForSubmissionWithBoolean:(BOOL)showerror {
  switch (submitValueType_) {
    ...
    default:
    return [((id<RAREiListHandler>) nil_chk(listComponent_)) hasSelection];
  }
}
