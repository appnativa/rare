...
//  source: /Code/Dev/appNativa/source/rareobjc/../rare/core-tree/com/appnativa/rare/ui/tree/aDataItemTreeModel.java
//
...
- (void)nodeChangedWithRARERenderableDataItem:(RARERenderableDataItem *)node {
  if (eventsEnabled_ && (listenerList_ != nil) && (node != nil)) {
    RARERenderableDataItem *parent = (RARERenderableDataItem *) check_class_cast([node getParentItem], [RARERenderableDataItem class]);
    if (parent != nil) {
      RARERenderableDataItem *list = [self getExpandableItemWithRARERenderableDataItem:parent];
...
withRARERenderableDataItem:(RARERenderableDataItem *)parent {
  ...
  @synchronized (parent) {
    ...
    (void) IOSObjectArray_Set(removed, 0, (RARERenderableDataItem *) check_class_cast([list removeWithInt:index], [RARERenderableDataItem class]));
  }
  IOSIntArray *changed = [IOSIntArray arrayWithInts:(int[]){ index } count:1];
...
- (void)removeNodeFromParentWithRARERenderableDataItem:(RARERenderableDataItem *)node {
  RARERenderableDataItem *parent = (RARERenderableDataItem *) check_class_cast([((RARERenderableDataItem *) nil_chk(node)) getParentItem], [RARERenderableDataItem class]);
  if (parent == nil) {
