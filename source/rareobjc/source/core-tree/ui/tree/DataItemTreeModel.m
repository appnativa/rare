...
//  source: /Code/Dev/appNativa/source/rareobjc/../rare/core-tree/com/appnativa/rare/ui/tree/DataItemTreeModel.java
//
...
- (void)needsSorting {
  [((RARETreeItemEx *) nil_chk([self getRootTreeItem])) needsSortingWithBoolean:NO];
}
