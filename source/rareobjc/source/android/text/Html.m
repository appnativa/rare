...
+ (void)withinDivWithJavaLangStringBuilder:(JavaLangStringBuilder *)outArg
  ...
  for (int i = start; i < end; i = next) {
    ...
    IOSObjectArray *quotes = [text getSpansWithInt:i withInt:next withIOSClass:[IOSClass classWithClass:[RAREQuoteSpan class]]];
    {
      IOSObjectArray *a__ = quotes;
      id const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
      id const *e__ = b__ + a__->size_;
      while (b__ < e__) {
        RAREQuoteSpan *quote = (*b__++);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _AndroidTextHtmlToSpannedConverter = { "HtmlToSpannedConverter", "android.text", NULL, 0x0, 36, methods, 11, fields, 0, NULL};
