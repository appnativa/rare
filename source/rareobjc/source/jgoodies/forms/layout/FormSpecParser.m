...
@implementation RAREFormSpecParser

static JavaUtilRegexPattern * RAREFormSpecParser_MULTIPLIER_PREFIX_PATTERN_;
static JavaUtilRegexPattern * RAREFormSpecParser_DIGIT_PATTERN_;

+ (JavaUtilRegexPattern *)MULTIPLIER_PREFIX_PATTERN {
  return RAREFormSpecParser_MULTIPLIER_PREFIX_PATTERN_;
}

+ (JavaUtilRegexPattern *)DIGIT_PATTERN {
  return RAREFormSpecParser_DIGIT_PATTERN_;
}
...
- (id)initWithNSString:(NSString *)source
  ...
  if (self = [super init]) {
    [RAREFormUtils assertNotNullWithId:source withNSString:description_];
    [RAREFormUtils assertNotNullWithId:layoutMap withNSString:@"LayoutMap"];
    self->layoutMap_ = layoutMap;
    self->source_ = [((RARELayoutMap *) nil_chk(self->layoutMap_)) expandWithNSString:source withBoolean:horizontal];
  }
  return self;
}
...
+ (IOSObjectArray *)parseColumnSpecsWithNSString:(NSString *)encodedColumnSpecs
                               withRARELayoutMap:(RARELayoutMap *)layoutMap {
  RAREFormSpecParser *parser = [[RAREFormSpecParser alloc] initWithNSString:encodedColumnSpecs withNSString:@"encoded column specifications" withRARELayoutMap:layoutMap withBoolean:YES];
  return [parser parseColumnSpecs];
}

+ (IOSObjectArray *)parseRowSpecsWithNSString:(NSString *)encodedRowSpecs
                            withRARELayoutMap:(RARELayoutMap *)layoutMap {
  RAREFormSpecParser *parser = [[RAREFormSpecParser alloc] initWithNSString:encodedRowSpecs withNSString:@"encoded column specifications" withRARELayoutMap:layoutMap withBoolean:NO];
...
- (IOSObjectArray *)parseColumnSpecs {
  ...
  IOSObjectArray *columnSpecs = [IOSObjectArray arrayWithLength:columnCount type:[IOSClass classWithClass:[RAREColumnSpec class]]];
  for (int i = 0; i < columnCount; i++) {
    NSString *encodedSpec = (NSString *) check_class_cast([encodedColumnSpecs getWithInt:i], [NSString class]);
    (void) IOSObjectArray_Set(columnSpecs, i, [RAREColumnSpec decodeExpandedWithNSString:encodedSpec]);
  }
  return columnSpecs;
}
...
- (IOSObjectArray *)parseRowSpecs {
  ...
  IOSObjectArray *rowSpecs = [IOSObjectArray arrayWithLength:rowCount type:[IOSClass classWithClass:[RARERowSpec class]]];
  for (int i = 0; i < rowCount; i++) {
    NSString *encodedSpec = (NSString *) check_class_cast([encodedRowSpecs getWithInt:i], [NSString class]);
    (void) IOSObjectArray_Set(rowSpecs, i, [RARERowSpec decodeExpandedWithNSString:encodedSpec]);
  }
  return rowSpecs;
}
...
- (void)addSpecWithJavaUtilList:(id<JavaUtilList>)encodedSpecs
  ...
  RAREFormSpecParser_Multiplier *multiplier = [self multiplierWithNSString:trimmedExpression withInt:offset];
  if (multiplier == nil) {
    [((id<JavaUtilList>) nil_chk(encodedSpecs)) addWithId:trimmedExpression];
    return;
  }
  id<JavaUtilList> subTokenList = [self splitWithNSString:((RAREFormSpecParser_Multiplier *) nil_chk(multiplier))->expression_ withInt:offset + multiplier->offset_];
...
- (RAREFormSpecParser_Multiplier *)multiplierWithNSString:(NSString *)expression
                                                  withInt:(int)offset {
  JavaUtilRegexMatcher *matcher = [((JavaUtilRegexPattern *) nil_chk(RAREFormSpecParser_MULTIPLIER_PREFIX_PATTERN_)) matcherWithJavaLangCharSequence:expression];
  ...
  JavaUtilRegexMatcher *digitMatcher = [((JavaUtilRegexPattern *) nil_chk(RAREFormSpecParser_DIGIT_PATTERN_)) matcherWithJavaLangCharSequence:expression];
  ...
  return [[RAREFormSpecParser_Multiplier alloc] initWithInt:number withNSString:subexpression withInt:[matcher end]];
}

+ (void)failWithNSString:(NSString *)source
                 withInt:(int)index
            withNSString:(NSString *)description_ {
  @throw [[RAREFormSpecParser_FormLayoutParseException alloc] initWithNSString:[RAREFormSpecParser messageWithNSString:source withInt:index withNSString:description_]];
}

- (void)failWithInt:(int)index
       withNSString:(NSString *)description_ {
  @throw [[RAREFormSpecParser_FormLayoutParseException alloc] initWithNSString:[RAREFormSpecParser messageWithNSString:source_ withInt:index withNSString:description_]];
}

- (void)failWithInt:(int)index
withJavaLangNumberFormatException:(JavaLangNumberFormatException *)cause {
  @throw [[RAREFormSpecParser_FormLayoutParseException alloc] initWithNSString:[RAREFormSpecParser messageWithNSString:source_ withInt:index withNSString:@"Invalid multiplier"] withJavaLangThrowable:cause];
}
...
+ (NSString *)messageWithNSString:(NSString *)source
  ...
  @throw [[RAREFormSpecParser_FormLayoutParseException alloc] initWithNSString:message];
}

+ (void)initialize {
  if (self == [RAREFormSpecParser class]) {
    RAREFormSpecParser_MULTIPLIER_PREFIX_PATTERN_ = [JavaUtilRegexPattern compileWithNSString:@"\\d+\\s*\\*\\s*\\("];
    RAREFormSpecParser_DIGIT_PATTERN_ = [JavaUtilRegexPattern compileWithNSString:@"\\d+"];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "initWithNSString:withNSString:withRARELayoutMap:withBoolean:", NULL, NULL, 0x2, NULL },
    { "parseColumnSpecsWithNSString:withRARELayoutMap:", NULL, "LIOSObjectArray", 0x8, NULL },
    { "parseRowSpecsWithNSString:withRARELayoutMap:", NULL, "LIOSObjectArray", 0x8, NULL },
    ...
    { "multiplierWithNSString:withInt:", NULL, "LRAREFormSpecParser_Multiplier", 0x2, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "layoutMap_", NULL, 0x12, "LRARELayoutMap" },
  };
  static J2ObjcClassInfo _RAREFormSpecParser = { "FormSpecParser", "com.appnativa.jgoodies.forms.layout", NULL, 0x11, 11, methods, 4, fields, 0, NULL};
  return &_RAREFormSpecParser;
}

@end
@implementation RAREFormSpecParser_FormLayoutParseException
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREFormSpecParser_FormLayoutParseException = { "FormLayoutParseException", "com.appnativa.jgoodies.forms.layout", "FormSpecParser", 0x19, 2, methods, 0, NULL, 0, NULL};
  return &_RAREFormSpecParser_FormLayoutParseException;
}

@end
@implementation RAREFormSpecParser_Multiplier
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREFormSpecParser_Multiplier = { "Multiplier", "com.appnativa.jgoodies.forms.layout", "FormSpecParser", 0x18, 1, methods, 3, fields, 0, NULL};
  return &_RAREFormSpecParser_Multiplier;
}
