...
- (RAREJGFormLayout_LayoutInfo *)computeLayoutWithRAREiParentComponent:(id<RAREiParentComponent>)container
  ...
  [((RAREJGFormLayout_ComponentSizeCache *) nil_chk(componentSizeCache_)) setMaxWidthWithFloat:totalWidth < 0 ? 0 : totalWidth];
...
- (RAREUIDimension *)getMinimumSizeWithRAREiParentComponent:(id<RAREiParentComponent>)container
  ...
  [((RAREJGFormLayout_ComponentSizeCache *) nil_chk(componentSizeCache_)) setMaxWidthWithFloat:maxWidth];
