...
- (void)updateChildrenForColorChange {
  ...
  if (((RARENavigatorPanel *) nil_chk(panel_))->selectedPainter_ != nil) {
    [panel_->selectedPainter_ updateModCount];
  }
  if (panel_->pressedPainter_ != nil) {
    [panel_->pressedPainter_ updateModCount];
  }
}
