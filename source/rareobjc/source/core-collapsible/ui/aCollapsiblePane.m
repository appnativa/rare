...
- (void)disposePane {
  ...
  mainComponent_ = nil;
  expandIcon_ = nil;
  eventWillCollapse_ = nil;
  eventWillExpand_ = nil;
  eventCollapsed_ = nil;
  eventExpanded_ = nil;
  collapseIcon_ = nil;
}
...
- (void)fireExpandedWithBoolean:(BOOL)expanded {
  ...
  if (eventCollapsed_ == nil) {
    eventCollapsed_ = [[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum HAS_COLLAPSED]];
    eventExpanded_ = [[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum HAS_EXPANDED]];
  }
  [((RAREExpansionEvent *) nil_chk(eventCollapsed_)) setItemWithId:mainComponent_];
  [((RAREExpansionEvent *) nil_chk(eventExpanded_)) setItemWithId:mainComponent_];
  if (expandedListener != nil) {
    if (expanded) {
      [expandedListener itemHasExpandedWithRAREExpansionEvent:eventExpanded_];
    }
    else {
      [expandedListener itemHasCollapsedWithRAREExpansionEvent:eventCollapsed_];
    }
  }
  ...
  for (int i = (int) [((IOSObjectArray *) nil_chk(listeners)) count] - 2; i >= 0; i -= 2) {
    if (IOSObjectArray_Get(listeners, i) == [IOSClass classWithProtocol:@protocol(RAREiExpandedListener)]) {
      ...
      if (expanded) {
        [((id<RAREiExpandedListener>) nil_chk(t)) itemHasExpandedWithRAREExpansionEvent:eventExpanded_];
      }
      else {
        [((id<RAREiExpandedListener>) nil_chk(t)) itemHasCollapsedWithRAREExpansionEvent:eventCollapsed_];
      }
    }
  }
}
...
- (void)fireExpansionWithBoolean:(BOOL)expanded {
  ...
  if (eventWillCollapse_ == nil) {
    eventWillCollapse_ = [[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_COLLAPSE]];
    eventWillExpand_ = [[RAREExpansionEvent alloc] initWithId:self withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_EXPAND]];
  }
  [((RAREExpansionEvent *) nil_chk(eventWillCollapse_)) setItemWithId:mainComponent_];
  [((RAREExpansionEvent *) nil_chk(eventWillExpand_)) setItemWithId:mainComponent_];
  IOSObjectArray *listeners = [((RAREEventListenerList *) nil_chk(listenerList_)) getListenerList];
  ...
  for (int i = (int) [((IOSObjectArray *) nil_chk(listeners)) count] - 2; i >= 0; i -= 2) {
    if (IOSObjectArray_Get(listeners, i) == [IOSClass classWithProtocol:@protocol(RAREiExpansionListener)]) {
      ...
      if (expanded) {
        [((id<RAREiExpansionListener>) nil_chk(t)) itemWillExpandWithRAREExpansionEvent:eventWillExpand_];
      }
      else {
        [((id<RAREiExpansionListener>) nil_chk(t)) itemWillCollapseWithRAREExpansionEvent:eventWillCollapse_];
      }
    }
  }
}
...
- (void)copyAllFieldsTo:(RAREaCollapsiblePane *)other {
  ...
  other->eventCollapsed_ = eventCollapsed_;
  other->eventExpanded_ = eventExpanded_;
  other->eventWillCollapse_ = eventWillCollapse_;
  other->eventWillExpand_ = eventWillExpand_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "eventCollapsed_", NULL, 0x4, "LRAREExpansionEvent" },
    { "eventExpanded_", NULL, 0x4, "LRAREExpansionEvent" },
    { "eventWillCollapse_", NULL, 0x4, "LRAREExpansionEvent" },
    { "eventWillExpand_", NULL, 0x4, "LRAREExpansionEvent" },
  ...
  static J2ObjcClassInfo _RAREaCollapsiblePane = { "aCollapsiblePane", "com.appnativa.rare.ui", NULL, 0x401, 29, methods, 25, fields, 0, NULL};
