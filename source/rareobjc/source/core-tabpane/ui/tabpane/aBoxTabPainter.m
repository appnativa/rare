...
- (id)init {
  if (self = [super init]) {
    ...
    RAREPaintBucket *pb = (RAREPaintBucket *) check_class_cast([self getUIDefaultsWithJavaLangStringBuilder:sb withInt:sblen withBoolean:NO withNSString:@"tabPainter"], [RAREPaintBucket class]);
    RAREPaintBucket *spb = (RAREPaintBucket *) check_class_cast([self getUIDefaultsWithJavaLangStringBuilder:sb withInt:sblen withBoolean:NO withNSString:@"selectedTabPainter"], [RAREPaintBucket class]);
    if (spb == nil) {
