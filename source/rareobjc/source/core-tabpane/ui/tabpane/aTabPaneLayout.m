...
- (void)setTabAreaPainterWithRAREPaintBucket:(RAREPaintBucket *)pb {
  if (pb != tabAreaPainter_) {
    ...
    if ([tabPainter_ isKindOfClass:[RAREaBoxTabPainter class]] && (![((RAREaBoxTabPainter *) check_class_cast(tabPainter_, [RAREaBoxTabPainter class])) isBorderPainted])) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaTabPaneLayout = { "aTabPaneLayout", "com.appnativa.rare.ui.tabpane", NULL, 0x401, 27, methods, 26, fields, 0, NULL};
