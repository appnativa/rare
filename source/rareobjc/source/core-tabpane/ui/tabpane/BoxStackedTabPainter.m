...
- (RAREPaintBucket *)createDefaultSelectedPainter {
  ...
  [pb setBackgroundPainterWithRAREiBackgroundPainter:[[RAREUIBackgroundPainter alloc] initWithRAREUIColor:[((RAREUIColor *) nil_chk(bg)) lightWithInt:-30] withRAREUIColor:bg]];
