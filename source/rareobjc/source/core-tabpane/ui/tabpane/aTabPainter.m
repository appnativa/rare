...
- (void)setNormalPaintWithRAREPaintBucket:(RAREPaintBucket *)pb {
  ...
  tabForeground_ = c;
  tabDisabledForeground_ = [((RAREUIProperties *) nil_chk([RAREPlatform getUIDefaults])) getColorWithNSString:@"Rare.TabPane.tabDisabledForegroundColor"];
  if (tabDisabledForeground_ == nil) {
    if (c == [RAREUIColorHelper getForeground]) {
      tabDisabledForeground_ = [RAREColorUtils getDisabledForeground];
    }
    else {
      tabDisabledForeground_ = [RAREColorUtils getDisabledVersionWithRAREUIColor:c];
    }
  }
...
- (id<RAREiTabLabel>)configureRendererVisualsWithRAREUIAction:(RAREUIAction *)a
  ...
  if (![((id<RAREiTabLabel>) nil_chk(renderer)) isEnabled]) {
    fg = tabDisabledForeground_;
  }
  [renderer setForegroundWithRAREUIColor:fg];
...
- (void)copyAllFieldsTo:(RAREaTabPainter *)other {
  ...
  other->tabDisabledForeground_ = tabDisabledForeground_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "tabDisabledForeground_", NULL, 0x4, "LRAREUIColor" },
  ...
  static J2ObjcClassInfo _RAREaTabPainter = { "aTabPainter", "com.appnativa.rare.ui.tabpane", NULL, 0x401, 48, methods, 41, fields, 0, NULL};
