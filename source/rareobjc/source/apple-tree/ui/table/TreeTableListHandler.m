...
//  source: /Code/Dev/appNativa/source/rareobjc/../rare/apple-tree/com/appnativa/rare/ui/table/TreeTableListHandler.java
//
...
withRAREiPlatformListDataModel:(id<RAREiPlatformListDataModel>)model
 withRAREDataItemTreeModel:(RAREDataItemTreeModel *)tm {
  if (self = [super initWithRAREaPlatformTableBasedView:view withRAREiPlatformListDataModel:model]) {
    treeModel_ = tm;
  }
  return self;
}
