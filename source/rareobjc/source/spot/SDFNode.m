...
+ (SDFNode *)parseWithJavaIoReader:(JavaIoReader *)r {
  SDFNode *node = [[SDFNode alloc] initWithNSString:nil];
  id<RAREUTiURLResolver> urlResolver = [[RAREUTFileResolver alloc] initWithJavaIoFile:[[JavaIoFile alloc] initWithNSString:@"/"]];
  [node setNodeTypeWithInt:SDFNode_NODETYPE_ROOT];
  SDFNode_ParserCallback *pc = [[SDFNode_ParserCallback alloc] initWithSDFNode:node withRAREUTiURLResolver:urlResolver];
...
+ (void)mainWithNSStringArray:(IOSObjectArray *)args {
  @try {
    ...
    SDFNode *node = [SDFNode parseForReformatWithJavaIoReader:[[JavaIoBufferedReader alloc] initWithJavaIoReader:r] withRAREUTiURLResolver:[[RAREUTFileResolver alloc] initWithJavaIoFile:f] withNSString:file];
...
+ (SDFNode *)parseForReformatWithJavaIoReader:(JavaIoReader *)r
  ...
  SDFNode *node = [[SDFNode alloc] initWithNSString:nil];
  [node setNodeTypeWithInt:SDFNode_NODETYPE_ROOT];
  SDFNode_FormattingCallback *pc = [[SDFNode_FormattingCallback alloc] initWithSDFNode:node withRAREUTiURLResolver:urlResolver];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "parseWithJavaIoReader:withRAREUTiURLResolver:withNSString:withBoolean:", NULL, "LSDFNode", 0x9, "JavaIoIOException" },
    { "parseForReformatWithJavaIoReader:withRAREUTiURLResolver:withNSString:", NULL, "LSDFNode", 0x9, "JavaIoIOException" },
...
- (BOOL)handleCommandExWithNSString:(NSString *)cmd
  ...
  if ((urlResolver_ != nil) && [((NSString *) nil_chk(cmd)) equalsIgnoreCase:@"import"] && (params != nil) && ((len = [params sequenceLength]) > 0)) {
    @try {
      ...
      SDFNode *node = [[SDFNode alloc] initWithNSString:nil];
      [node setNodeTypeWithInt:SDFNode_NODETYPE_ROOT];
      SDFNode_ParserCallback *pc = [[SDFNode_ParserCallback alloc] initWithSDFNode:node withRAREUTiURLResolver:urlResolver_];
...
- (id)initWithSDFNode:(SDFNode *)root
withRAREUTiURLResolver:(id<RAREUTiURLResolver>)urlResolver {
  if (self = [super initWithSDFNode:root withRAREUTiURLResolver:urlResolver]) {
    [self setIgnoreMissingReferencesWithBoolean:YES];
  }
  return self;
}
