...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "setDomainLabelAngelWithRAREiPlatformComponent:withRAREChartDefinition:", NULL, "V", 0x401, NULL },
    { "setRangeLabelWithRAREiPlatformComponent:withRAREChartDefinition:", NULL, "V", 0x401, NULL },
    { "setRangeLabelAngelWithRAREiPlatformComponent:withRAREChartDefinition:", NULL, "V", 0x401, NULL },
    ...
    { "unzoomWithRAREiPlatformComponent:", NULL, "V", 0x401, NULL },
  ...
  static J2ObjcClassInfo _RAREaChartHandler = { "aChartHandler", "com.appnativa.rare.ui.chart", NULL, 0x401, 49, methods, 14, fields, 0, NULL};
...
withRAREPlotInformation_LabelTypeEnum:(RAREPlotInformation_LabelTypeEnum *)lt {
  if (self = [super init]) {
    ...
    self->legend_ = legend;
    domainMap_ = [[JavaUtilHashSet alloc] init];
...
withRAREPlotInformation_LabelTypeEnum:(RAREPlotInformation_LabelTypeEnum *)lt
  ...
  if (self = [super init]) {
    ...
    rangeValues_ = [[JavaUtilArrayList alloc] initWithInt:size];
    dataItems_ = [[JavaUtilArrayList alloc] initWithInt:size];
    self->domainValues_ = domainValues;
    self->legend_ = legend;
    self->domainMap_ = domains;
    self->labelType_ = (lt == nil) ? [RAREPlotInformation_LabelTypeEnum VALUES] : lt;
  }
  return self;
}
...
- (void)addDomainValuesWithJavaUtilList:(id<JavaUtilList>)values {
  for (id<JavaLangComparable> __strong c in nil_chk(values)) {
    if (![((JavaUtilHashSet *) nil_chk(domainMap_)) containsWithId:c]) {
      [((id<JavaUtilList>) nil_chk(domainValues_)) addWithId:c];
    }
  }
}
...
- (int)addValueWithRAREChartDataItem:(RAREChartDataItem *)item
  ...
  if ([((JavaUtilHashSet *) nil_chk(domainMap_)) addWithId:domain]) {
    [((id<JavaUtilList>) nil_chk(dataItems_)) addWithId:item];
    [((id<JavaUtilList>) nil_chk(rangeValues_)) addWithId:range];
    [((id<JavaUtilList>) nil_chk(domainValues_)) addWithId:domain];
    return [rangeValues_ size] - 1;
  }
  return -1;
}
  ...
  if (len > 0) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      if ((data != nil) && (data->domainValues_ != nil)) {
        ...
        data->legend_ = (NSString *) check_class_cast([series description], [NSString class]);
...
- (void)updateRangeBoundsWithRAREaChartHandler:(RAREaChartHandler *)ch
  ...
  for (int i = 0; i < len; i++) {
    ...
    for (int n = 0; n < nlen; n++) {
      if (data->isNumberRange_) {
        RAREUTNumberRange *r = (RAREUTNumberRange *) check_class_cast([((id<JavaUtilList>) nil_chk(nums)) getWithInt:n], [RAREUTNumberRange class]);
        d = [((NSNumber *) nil_chk([((RAREUTNumberRange *) nil_chk(r)) getLowValue])) doubleValue];
        ymin = [JavaLangMath minWithDouble:d withDouble:ymin];
        ymax = [JavaLangMath maxWithDouble:d withDouble:ymax];
        d = [((NSNumber *) nil_chk([r getHighValue])) doubleValue];
        ...
        d = [((NSNumber *) nil_chk([((id<JavaUtilList>) nil_chk(nums)) getWithInt:n])) doubleValue];
        ymin = [JavaLangMath minWithDouble:d withDouble:ymin];
        ymax = [JavaLangMath maxWithDouble:d withDouble:ymax];
      }
    }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaChartHandler_aChartInfo = { "aChartInfo", "com.appnativa.rare.ui.chart", "aChartHandler", 0x40c, 4, methods, 10, fields, 0, NULL};
