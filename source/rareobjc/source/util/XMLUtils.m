...
//  source: /Code/Dev/appNativa/source/rareobjc/../util/src/com/appnativa/util/XMLUtils.java
//
...
+ (void)newLineWithJavaIoWriter:(JavaIoWriter *)outArg {
  [((JavaIoWriter *) nil_chk(outArg)) writeWithNSString:RAREUTXMLUtils_lineSeparator_];
}
...
+ (void)initialize {
  if (self == [RAREUTXMLUtils class]) {
    RAREUTXMLUtils_amplt_ = [@"lt" toCharArray];
    RAREUTXMLUtils_ampgt_ = [@"gt" toCharArray];
    RAREUTXMLUtils_ampquot_ = [@"quot" toCharArray];
    RAREUTXMLUtils_ampapos_ = [@"apos" toCharArray];
    RAREUTXMLUtils_ampamp_ = [@"amp" toCharArray];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREUTXMLUtils = { "XMLUtils", "com.appnativa.util", NULL, 0x1, 18, methods, 8, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREUTXMLUtils_$1 = { "$1", "com.appnativa.util", "XMLUtils", 0x8000, 1, methods, 0, NULL, 0, NULL};
