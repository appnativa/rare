...
- (void)setValueWithId:(id)value {
  if ([value conformsToProtocol: @protocol(JavaUtilMap)]) {
    [self populateWithJavaUtilMap:(id<JavaUtilMap>) check_protocol_cast(value, @protocol(JavaUtilMap))];
  }
  else if ([value conformsToProtocol: @protocol(JavaUtilList)]) {
    if ([value isKindOfClass:[RAREUTJSONArray class]]) {
      listChildren_ = [((RAREUTJSONArray *) check_class_cast(value, [RAREUTJSONArray class])) getObjectList];
    }
    else {
      listChildren_ = (id<JavaUtilList>) check_protocol_cast(value, @protocol(JavaUtilList));
    }
  }
  else {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "populateWithJavaUtilMap:", NULL, "V", 0x4, NULL },
    { "setValueWithId:", NULL, "V", 0x4, NULL },
  };
  ...
  static J2ObjcClassInfo _RAREUTJSONStructuredNode = { "JSONStructuredNode", "com.appnativa.util.json", NULL, 0x1, 22, methods, 12, fields, 0, NULL};
