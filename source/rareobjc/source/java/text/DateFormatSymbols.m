...
- (id)clone {
  JavaTextDateFormatSymbols *dfs = (JavaTextDateFormatSymbols *) check_class_cast([super clone], [JavaTextDateFormatSymbols class]);
  [((JavaTextDateFormatSymbols *) nil_chk(dfs)) initialize__WithJavaUtilLocale:locale_];
  return dfs;
}
