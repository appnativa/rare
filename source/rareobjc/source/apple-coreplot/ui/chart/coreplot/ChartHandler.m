...
- (id<RAREiPlatformComponent>)createChartWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)chartPanel
  ...
  [self updateMarkersWithRAREiPlatformComponent:chartPanel withRAREChartDefinition:cd withBoolean:YES];
  [self updateMarkersWithRAREiPlatformComponent:chartPanel withRAREChartDefinition:cd withBoolean:NO];
  return panel;
}
...
- (void)itemChangedWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)chartPanel
                        ...
                        withRAREChartDataItem:(RAREChartDataItem *)item {
  {
    RAREChartView *chart;
    int index;
    switch ([[((RAREChartDataItem *) nil_chk(item)) getItemType] ordinal]) {
      case RAREChartDataItem_ItemType_SERIES:
      (void) [self dataChangedWithRAREiPlatformComponent:chartPanel withRAREChartDefinition:cd];
      break;
      case RAREChartDataItem_ItemType_DOMAIN_MARKER:
      [self updateMarkersWithRAREiPlatformComponent:chartPanel withRAREChartDefinition:cd withBoolean:NO];
      break;
      case RAREChartDataItem_ItemType_RANGE_MARKER:
      [self updateMarkersWithRAREiPlatformComponent:chartPanel withRAREChartDefinition:cd withBoolean:YES];
      break;
      case RAREChartDataItem_ItemType_POINT:
      chart = [self getChartViewWithRAREiPlatformComponent:chartPanel];
      index = [((RAREChartDefinition *) nil_chk(cd)) findSeriesIndexWithRAREChartDataItem:item];
      if (index != -1) {
        [((RAREChartView *) nil_chk(chart)) reloadSeriesWithInt:index];
      }
      break;
      default:
      break;
...
- (void)updateMarkersWithRAREiPlatformComponent:(id<RAREiPlatformComponent>)chartPanel
  ...
  id<JavaUtilList> markers = range ? [((RAREChartDefinition *) nil_chk(cd)) getRangeMarkers] : [((RAREChartDefinition *) nil_chk(cd)) getDomainMarkers];
  RAREChartView *chart = [self getChartViewWithRAREiPlatformComponent:chartPanel];
  int len = (markers == nil) ? 0 : [markers size];
  [((RAREChartView *) nil_chk(chart)) removeMarkersWithBoolean:range];
  for (int i = 0; i < len; i++) {
    [self createMarkerWithRAREChartDefinition:cd withRAREChartView:chart withRAREChartDataItem:[markers getWithInt:i] withBoolean:range];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "updateMarkersWithRAREiPlatformComponent:withRAREChartDefinition:withBoolean:", NULL, "V", 0x2, NULL },
  };
  static J2ObjcClassInfo _RAREChartHandler = { "ChartHandler", "com.appnativa.rare.ui.chart.coreplot", NULL, 0x1, 12, methods, 0, NULL, 0, NULL};
