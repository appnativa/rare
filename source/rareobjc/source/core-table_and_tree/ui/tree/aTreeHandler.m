  ...
  do {
    ...
    if (![ti isLeaf]) {
      if (hasExpansionListener_) {
        RAREExpansionEvent *e;
        if ([ti isExpanded]) {
          e = [self fireExpansionWithId:view withId:ti withBoolean:NO];
        }
        else {
          e = [self fireExpansionWithId:view withId:ti withBoolean:YES];
        }
      ...
      if (hasExpandedListener_) {
        if ([ti isExpanded]) {
          [self fireExpandedWithId:view withId:ti withBoolean:YES];
        }
        else {
          [self fireExpandedWithId:view withId:ti withBoolean:YES];
        }
...
- (void)setExpandAllWithBoolean:(BOOL)expandAll {
  [((RAREDataItemTreeModel *) nil_chk(treeModel_)) setExpandAllWithBoolean:expandAll];
}
...
- (void)setParentItemsSelectableWithBoolean:(BOOL)parentItemsSelectable {
  [((id<RAREiTree>) nil_chk(theTree_)) setParentItemsSelectableWithBoolean:parentItemsSelectable];
}

- (BOOL)isParentItemsSelectable {
  return [((id<RAREiTree>) nil_chk(theTree_)) isParentItemsSelectable];
}
...
- (void)fireExpandedWithId:(id)source
                    withId:(id)item
               withBoolean:(BOOL)expand {
  RAREExpansionEvent *e;
  if (expand) {
    e = [[RAREExpansionEvent alloc] initWithId:source withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum HAS_EXPANDED] withId:item];
  }
  else {
    e = [[RAREExpansionEvent alloc] initWithId:source withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum HAS_COLLAPSED] withId:item];
  }
...
- (RAREExpansionEvent *)fireExpansionWithId:(id)source
                                     withId:(id)item
                                withBoolean:(BOOL)expand {
  RAREExpansionEvent *e;
  if (expand) {
    e = [[RAREExpansionEvent alloc] initWithId:source withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_EXPAND] withId:item];
  }
  else {
    e = [[RAREExpansionEvent alloc] initWithId:source withRAREExpansionEvent_TypeEnum:[RAREExpansionEvent_TypeEnum WILL_COLLAPSE] withId:item];
  }
  IOSObjectArray *listeners = [((RAREEventListenerList *) nil_chk([self getEventListenerList])) getListenerList];
  for (int i = (int) [((IOSObjectArray *) nil_chk(listeners)) count] - 2; i >= 0; i -= 2) {
    if ([((RAREExpansionEvent *) nil_chk(e)) isConsumed]) {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "fireExpandedWithId:withId:withBoolean:", NULL, "V", 0x2, NULL },
    { "fireExpansionWithId:withId:withBoolean:", NULL, "LRAREExpansionEvent", 0x2, "RAREExpandVetoException" },
  ...
  static J2ObjcClassInfo _RAREaTreeHandler = { "aTreeHandler", "com.appnativa.rare.ui.tree", NULL, 0x401, 29, methods, 4, fields, 0, NULL};
