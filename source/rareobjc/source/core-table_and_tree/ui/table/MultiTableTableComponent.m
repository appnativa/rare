...
- (void)moveColumnWithInt:(int)column
  ...
  id<RAREiTableComponent> table = [self getTableForModelColumnWithInt:column];
  column = [self getColumnIndexForModelColumnWithInt:column];
  targetColumn = [self getColumnIndexForModelColumnWithInt:targetColumn];
  if ((column != -1) && (targetColumn != -1)) {
    [((id<RAREiTableComponent>) nil_chk(table)) moveColumnWithInt:column withInt:targetColumn];
  }
}
...
- (void)setMainTableWithRAREiTableComponent:(id<RAREiTableComponent>)mainTable {
  ...
  [((RAREaTableHeader *) nil_chk([mainTable getTableHeader])) setMultiTableColumnsWithJavaUtilList:[((RAREMultiDataItemTableModel *) nil_chk(tableModel_)) getColumns]];
}
...
- (void)setRowFooterTableWithRAREiTableComponent:(id<RAREiTableComponent>)rowFooterTable {
  ...
  [((RAREaTableHeader *) nil_chk([rowFooterTable getTableHeader])) setMultiTableColumnsWithJavaUtilList:[((RAREMultiDataItemTableModel *) nil_chk(tableModel_)) getColumns]];
}
...
- (void)setRowHeaderTableWithRAREiTableComponent:(id<RAREiTableComponent>)rowHeaderTable {
  ...
  [((RAREaTableHeader *) nil_chk([rowHeaderTable getTableHeader])) setMultiTableColumnsWithJavaUtilList:[((RAREMultiDataItemTableModel *) nil_chk(tableModel_)) getColumns]];
}
...
- (void)structureChangedWithId:(id)source {
  [((RAREaTableHeader *) nil_chk([((id<RAREiTableComponent>) nil_chk(mainTable_)) getTableHeader])) setMultiTableColumnsWithJavaUtilList:[((RAREMultiDataItemTableModel *) nil_chk(tableModel_)) getColumns]];
  if (rowHeaderTable_ != nil) {
    [((RAREaTableHeader *) nil_chk([rowHeaderTable_ getTableHeader])) setMultiTableColumnsWithJavaUtilList:[tableModel_ getColumns]];
  }
  if (rowFooterTable_ != nil) {
    [((RAREaTableHeader *) nil_chk([rowFooterTable_ getTableHeader])) setMultiTableColumnsWithJavaUtilList:[tableModel_ getColumns]];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "rowHeaderColumnCount_", NULL, 0x0, "I" },
    { "rowFooterColumnStart_", NULL, 0x0, "I" },
    { "mainColumnCount_", NULL, 0x0, "I" },
    { "tableModel_", NULL, 0x0, "LRAREMultiDataItemTableModel" },
    { "component_", NULL, 0x0, "LRAREiPlatformComponent" },
  };
  static J2ObjcClassInfo _RAREMultiTableTableComponent = { "MultiTableTableComponent", "com.appnativa.rare.ui.table", NULL, 0x1, 22, methods, 10, fields, 0, NULL};
