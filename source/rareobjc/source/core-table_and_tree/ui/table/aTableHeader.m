...
- (void)setMultiTableColumnsWithJavaUtilList:(id<JavaUtilList>)columns {
  multiTableColumns_ = (columns == nil) ? nil : [columns toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[columns size] type:[IOSClass classWithClass:[RAREColumn class]]]];
}

- (IOSObjectArray *)getMultiTableColumns {
  return multiTableColumns_;
}
...
- (int)getFirstVisibleColumnInView {
  ...
  if (n == -1) {
    ...
    if (n != -1) {
      n = [((id<RAREiTableComponent>) nil_chk([self getTableComponent])) convertModelIndexToViewWithInt:n];
    }
  }
  return n;
}
...
- (int)getSpanWidthWithInt:(int)start
                   withInt:(int)span {
  return [RARETableHelper getSpanWidthWithInt:start withInt:span withRAREColumnArray:columns_];
}
...
withRAREiPlatformItemRenderer:(id<RAREiPlatformItemRenderer>)renderer
  ...
  if (h < 1) {
    IOSObjectArray *columns = multiTableColumns_;
    if (columns == nil) {
    ...
    if (h < 1) {
      h = [RARETableHelper calculateRowHeightWithRAREiPlatformComponent:pc withRAREiPlatformItemRenderer:renderer withRAREiPlatformListDataModel:tm withInt:row withRAREColumnArray:columns withBoolean:NO withInt:defaultHeight];
    }
...
- (void)copyAllFieldsTo:(RAREaTableHeader *)other {
  ...
  other->multiTableColumns_ = multiTableColumns_;
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getMultiTableColumns", NULL, "LIOSObjectArray", 0x1, NULL },
    ...
    { "getColumnForViewAtWithInt:", NULL, "LRAREColumn", 0x401, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "multiTableColumns_", NULL, 0x4, "LIOSObjectArray" },
  ...
  static J2ObjcClassInfo _RAREaTableHeader = { "aTableHeader", "com.appnativa.rare.ui.table", NULL, 0x401, 53, methods, 36, fields, 0, NULL};
