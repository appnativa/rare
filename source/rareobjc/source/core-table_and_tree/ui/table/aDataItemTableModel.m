...
- (BOOL)addAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  if (rowData_ == nil) {
    ...
    [rowData_ addAllWithJavaUtilCollection:collection];
    [self updateForInsertionOrDeletion];
  }
  return YES;
}
...
- (BOOL)setAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  [self clearRows];
  rowData_ = [[RAREaDataItemTableModel_TableFilterableList alloc] initWithRAREaDataItemTableModel:self withJavaUtilCollection:collection];
  [self tableDataChanged];
  return YES;
}
...
@end
@implementation RAREaDataItemTableModel_TableFilterableList

- (BOOL)passesWithRAREUTiFilter:(id<RAREUTiFilter>)filter
                         withId:(RARERenderableDataItem *)e {
  if (e != nil) {
    e = [e getItemExWithInt:this$0_->activeColumn_];
  }
  return [super passesWithRAREUTiFilter:filter withId:e];
}
...
- (id)initWithRAREaDataItemTableModel:(RAREaDataItemTableModel *)outer$
  ...
  this$0_ = outer$;
  return [super initWithJavaUtilList:list];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "passesWithRAREUTiFilter:withRARERenderableDataItem:", NULL, "Z", 0x4, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LRAREaDataItemTableModel" },
  };
  static const char *superclass_type_args[] = {"LRARERenderableDataItem"};
  static J2ObjcClassInfo _RAREaDataItemTableModel_TableFilterableList = { "TableFilterableList", "com.appnativa.rare.ui.table", "aDataItemTableModel", 0x0, 1, methods, 1, fields, 1, superclass_type_args};
  return &_RAREaDataItemTableModel_TableFilterableList;
}
