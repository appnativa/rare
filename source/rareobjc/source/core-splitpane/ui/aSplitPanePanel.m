...
- (void)checkOrientationWithId:(id)newConfig {
  if ((newConfig != nil) && autoOrient_) {
    RAREUIDimension *size = [RAREUIScreen getSizeForConfigurationWithId:newConfig];
    BOOL t2b = (((RAREUIDimension *) nil_chk(size))->width_ > size->height_) ? NO : YES;
    if (t2b != [self isTopToBottom]) {
      ...
      [self setLeftToRightSplitExWithBoolean:!leftToRight_ withBoolean:NO];
    }
  }
}
...
- (void)toggleOrientationWithBoolean:(BOOL)splitEvenly {
  ...
  [self setLeftToRightSplitExWithBoolean:!leftToRight_ withBoolean:YES];
}
...
- (void)setLeftToRightSplitWithBoolean:(BOOL)leftToRight {
  autoOrient_ = NO;
  [self setLeftToRightSplitExWithBoolean:leftToRight withBoolean:YES];
}
...
- (void)layoutContainerWithRAREUIDimension:(RAREUIDimension *)size
  ...
  int w = width;
  int h = height;
  if (autoOrient_ && [self canChangeOrientationInCurrentState]) {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "canChangeOrientationInCurrentState", NULL, "Z", 0x4, NULL },
    ...
    { "setLeftToRightSplitExWithBoolean:withBoolean:", NULL, "V", 0x4, NULL },
  ...
  static J2ObjcClassInfo _RAREaSplitPanePanel = { "aSplitPanePanel", "com.appnativa.rare.ui", NULL, 0x401, 30, methods, 33, fields, 0, NULL};
