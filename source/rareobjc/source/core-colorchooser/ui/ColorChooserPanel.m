...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREColorChooserPanel_iColorWheel = { "iColorWheel", "com.appnativa.rare.ui", "ColorChooserPanel", 0x209, 6, methods, 0, NULL, 0, NULL};
...
- (void)dispose {
  if (palettePanel_ != nil) {
    [palettePanel_ dispose];
  }
  if (colorWheel_ != nil) {
    [colorWheel_ dispose];
  }
  if (colorPalette_ != nil) {
    [colorPalette_ dispose];
  }
  [super dispose];
  colorPalette_ = nil;
  colorWheel_ = nil;
...
- (id<RAREiPlatformComponent>)getButtonPannel {
  ...
  if (showNoneButton_) {
    ...
    pb = [RAREAlertPanel createButtonWithNSString:s withNSString:@"Rare.ColorChooser.noneButton" withRAREiActionListener:[[RAREColorChooserPanel_$5 alloc] initWithRAREColorChooserPanel:self]];
  ...
  if (showOkButton_) {
    ...
    pb = [RAREAlertPanel createButtonWithNSString:s withNSString:@"Rare.ColorChooser.noneButton" withRAREiActionListener:[[RAREColorChooserPanel_$6 alloc] initWithRAREColorChooserPanel:self]];
    if ([RAREPlatform isTouchDevice]) {
      [((RAREPushButtonWidget *) nil_chk(pb)) setMinimumSizeWithNSString:nil withNSString:@"2ln"];
    }
    if (grow) {
...
- (void)updateComboboxEditor {
  ...
  [((id<RAREiPlatformTextEditor>) nil_chk(editor_)) selectAll];
