...
- (int)getRowHeightWithInt:(int)row {
  ...
  return [((RARETableHeader *) nil_chk(header_)) getRowHeightWithInt:row withRAREiPlatformItemRenderer:itemRenderer_ withInt:rh];
}
...
withRARERenderableDataItem:(RARERenderableDataItem *)rowItem
  ...
  int width = 0;
  IOSObjectArray *columns = [((RARETableHeader *) nil_chk([self getHeader])) getColumns];
  int n = 0;
  ...
  int lvc = [((RARETableHeader *) nil_chk(header_)) getLastVisibleColumn];
  for (int i = 0; i < len; i++) {
    ...
    if (span != 1) {
      ...
      width = [self getSpanWidthWithInt:i withInt:span withInt:len withRAREColumnArray:columns withInt:d];
    }
    else {
      width = [c getWidth];
    }
...
withRAREaTableBasedView_RowView:(RAREaTableBasedView_RowView *)view
  ...
  [((RAREaPlatformTableBasedView_TableRowView *) check_class_cast(view, [RAREaPlatformTableBasedView_TableRowView class])) renderWithRAREView:self withRAREiPlatformComponent:[self getComponent] withRAREaListItemRenderer:itemRenderer_ withInt:row withRARERenderableDataItem:item withRAREColumnArray:[((RARETableHeader *) nil_chk(header_)) getColumns] withBoolean:isSelected withBoolean:isPressed withRAREiTreeItem:ti];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RARETableView = { "TableView", "com.appnativa.rare.ui.table", NULL, 0x1, 22, methods, 2, fields, 0, NULL};
