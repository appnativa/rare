...
- (void)initialize__WithRARETableView:(RARETableView *)table
  ...
  [((RAREDataItemTreeModelForTable *) nil_chk(treeModel_)) setExpandableColumnWithInt:[((SPOTInteger *) nil_chk(((RARESPOTTreeTable *) nil_chk(tt))->expandableColumn_)) intValue]];
  [self setTreeIconsWithRAREiPlatformIcon:[[RAREPainterUtils_TwistyIcon alloc] initWithRAREiPlatformComponent:self withBoolean:NO] withRAREiPlatformIcon:[[RAREPainterUtils_TwistyIcon alloc] initWithRAREiPlatformComponent:self withBoolean:YES]];
}
...
- (void)setTreeIconsWithRAREiPlatformIcon:(id<RAREiPlatformIcon>)expanded
  ...
  [((RARETreeTableView *) nil_chk(tv)) setTreeIconsWithRAREiPlatformIcon:expanded withRAREiPlatformIcon:collapsed];
}
