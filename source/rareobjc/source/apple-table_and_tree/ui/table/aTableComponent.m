...
- (void)getMinimumSizeExWithRAREUIDimension:(RAREUIDimension *)size {
  (void) [((RAREaTableHeader *) nil_chk(tableHeader_)) getMinimumSizeWithRAREUIDimension:size];
  float w = ((RAREUIDimension *) nil_chk(size))->width_;
  float h = size->height_;
  [((RARETableView *) nil_chk(tableView_)) getMinimumSizeWithRAREUIDimension:size];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "moveColumnWithInt:withInt:", NULL, "V", 0x101, NULL },
  ...
  static J2ObjcClassInfo _RAREaTableComponent = { "aTableComponent", "com.appnativa.rare.ui.table", NULL, 0x401, 59, methods, 10, fields, 0, NULL};
