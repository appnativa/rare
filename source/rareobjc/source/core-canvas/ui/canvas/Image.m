...
- (void)addReflectionWithInt:(int)y
                   ...
                   withFloat:(float)opacity
                     withInt:(int)gap {
  if (image_ != nil) {
    [image_ addReflectionImageWithInt:y withInt:height withFloat:opacity withInt:gap];
  }
}
...
- (void)setSrcWithNSString:(NSString *)src {
  ...
  if (src != nil) {
    @try {
      ...
      if (![((RAREUIImage *) nil_chk(image_)) isLoaded]) {
        [image_ load__];
        ;
      }
      if (onload_ != nil) {
...
- (RAREWidgetContext *)getScriptingContext {
  if (scriptingContext_ == nil) {
    ...
    ((RAREWidgetContext *) nil_chk(scriptingContext_))->needsJSRetention_ = YES;
  }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREImage = { "Image", "com.appnativa.rare.ui.canvas", NULL, 0x1, 11, methods, 0, NULL, 0, NULL};
  return &_RAREImage;
}
