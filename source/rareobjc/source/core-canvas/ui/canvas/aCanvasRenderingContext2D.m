...
- (void)createReflectionWithInt:(int)y
                      ...
                      withFloat:(float)opacity
                        withInt:(int)gap {
  if ([((id<RAREiCanvas>) nil_chk(theCanvas_)) getHeight] < y + height + gap + height) {
    return;
  }
  [((RAREUIImage *) nil_chk(theImage_)) addReflectionImageWithInt:y withInt:height withFloat:opacity withInt:gap];
  if (!repaintCalled_) {
    [theCanvas_ repaint];
    repaintCalled_ = YES;
  }
...
- (void)drawImageWithRAREiContext_iImageElement:(id<RAREiContext_iImageElement>)img
  ...
  [self drawImageWithRAREUIImage:[((id<RAREiContext_iImageElement>) nil_chk(img)) getImage] withFloat:sx withFloat:sy withFloat:swidth withFloat:sheight withFloat:dx withFloat:dy withFloat:dwidth withFloat:dheight];
}
...
- (void)setFillStyleWithNSString:(NSString *)color {
  [self setFillStyleWithRAREUIColor:[RAREColorUtils getColorWithNSString:color]];
}
...
- (void)setStrokeStyleWithNSString:(NSString *)color {
  [self setStrokeStyleWithRAREUIColor:[RAREColorUtils getColorWithNSString:color]];
}
