...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "mainValue_", NULL, 0x0, "LRAREUTSNumber" },
    { "workValue_", NULL, 0x0, "LRAREUTSNumber" },
    { "stepSize_", NULL, 0x0, "LRAREUTSNumber" },
    { "returnValue_", NULL, 0x0, "LRAREUTSNumber" },
    { "format_", NULL, 0x0, "LJavaTextDecimalFormat" },
    { "circular_", NULL, 0x0, "Z" },
  };
  static J2ObjcClassInfo _RARESpinnerNumberModel = { "SpinnerNumberModel", "com.appnativa.rare.ui.spinner", NULL, 0x1, 13, methods, 6, fields, 0, NULL};
