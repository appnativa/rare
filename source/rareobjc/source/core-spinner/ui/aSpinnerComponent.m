...
- (void)paintButtonsWithRAREiPlatformGraphics:(id<RAREiPlatformGraphics>)g
  ...
  if ([self isButtonsVisible]) {
    ...
    if ((ph != nil) && stackedButtons_) {
      ...
      if (ustate == dstate) {
        fg = [up isEnabled] ? [RAREUIColorHelper getForeground] : [RAREUIColorHelper getDisabledForeground];
        ph = nil;
      }
    }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _RAREaSpinnerComponent = { "aSpinnerComponent", "com.appnativa.rare.ui", NULL, 0x401, 24, methods, 22, fields, 0, NULL};
