...
//RARE: Don DeCoteau - added group stuff

JSContextGroupRef (*_JSContextGroupCreate)();
JSContextGroupRef JSContextGroupCreate() {
  return _JSContextGroupCreate();
}

JSContextGroupRef (*_JSContextGroupRetain)(JSContextGroupRef group);
JSContextGroupRef JSContextGroupRetain(JSContextGroupRef group) {
  return _JSContextGroupCreate(group);
}

void (*_JSContextGroupRelease)(JSContextGroupRef group);
void JSContextGroupRelease(JSContextGroupRef group) {
  _JSContextGroupRelease(group);
}

JSContextGroupRef (*_JSContextGetGroup)(JSContextRef ctx);
JSContextGroupRef JSContextGetGroup(JSContextRef ctx) {
  return _JSContextGetGroup(ctx);
}


JSGlobalContextRef (*_JSGlobalContextCreateInGroup)(JSContextGroupRef group,JSClassRef globalObjectClass);
...
#define SYM_ORDER RTLD_NEXT
  ...
  //RARE: Don DeCoteau - added group stuff
  _JSContextGroupCreate=dlsym(SYM_ORDER, "JSContextGroupCreate");
  _JSContextGroupRelease=dlsym(SYM_ORDER, "JSContextGroupRelease");
  _JSContextGroupRetain=dlsym(SYM_ORDER, "JSContextGroupRetain");
  _JSGlobalContextCreateInGroup=dlsym(SYM_ORDER, "JSGlobalContextCreateInGroup");
  _JSContextGetGroup=dlsym(SYM_ORDER,"JSContextGetGroup");
