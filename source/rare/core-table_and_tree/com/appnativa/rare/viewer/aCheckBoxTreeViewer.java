 ...
 * @author Don DeCoteau
 */
public abstract class aCheckBoxTreeViewer extends TreeViewer {
   ...
   */
  public aCheckBoxTreeViewer(iContainer parent) {
    super(parent);
    widgetType = WidgetType.CheckBoxTree;
  }
   ...
   */
  public static CheckBoxTreeViewer create(iContainer parent, CheckBoxList cfg) {
    CheckBoxTreeViewer widget = new CheckBoxTreeViewer(parent);
  ...
  /**
   * Sets whether  whether checkboxes and the tree selection are automatically linked
   *
   * @param linked true if checkboxes and the tree selection are automatically linked; false otherwise
   */
  public void setLinkSelection(boolean linked) {
    linkedSelection = linked;
  }

  public abstract void setManageChildNodeSelections(boolean manage);
  ...
  /**
   * Gets whether  whether checkboxes and the tree selection are automatically linked
   *
   * @return true if checkboxes and the tree selection are automatically linked; false otherwise
   */
  ...
  protected void configureEx(Tree cfg) {
    ...
    CheckBoxTree cbt = (CheckBoxTree) cfg;

    if (cbt.checkboxTrailing.spot_valueWasSet() && Platform.isTouchDevice()) {
      setCheckboxTrailing(cbt.checkboxTrailing.booleanValue());
    } else {
    ...
    setLinkSelection(cbt.linkSelection.booleanValue());
  ...
  protected class CheckBoxChangeHandler implements iItemChangeListener {
    String handler;
    Object scriptCode;
    ...
    public void itemChanged(ItemChangeEvent e) {
      ...
      aWidgetListener.execute(aCheckBoxTreeViewer.this, sh, scriptCode, iConstants.EVENT_CHANGE, e);
    }
