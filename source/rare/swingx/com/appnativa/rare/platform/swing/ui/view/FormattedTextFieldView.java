...
public class FormattedTextFieldView extends JFormattedTextField implements iPainterSupport, iActionable, FocusListener, iView {
  ...
  public FormattedTextFieldView() {
    ...
    setDisabledTextColor(UIColor.GRAY);
  }
  
  public FormattedTextFieldView(AbstractFormatter formatter) {
    super(formatter);
    setFont(FontUtils.getDefaultFont());
    setForeground(UIColor.BLACK);
    setBackground(UIColor.WHITE);
