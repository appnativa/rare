...
public class ListBoxListHandler extends aPlatformListHandler {
  public ListBoxListHandler(aPlatformTableBasedView view, iPlatformListDataModel model) {
    super(view, model);
  }

  public ListBoxListHandler(aPlatformTableBasedView view) {
    super(view);
  }

  @Override
  public void selectAll() {
    aPlatformTableBasedView view = (aPlatformTableBasedView) getView();
