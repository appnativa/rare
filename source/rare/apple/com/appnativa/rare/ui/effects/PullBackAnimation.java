...
public class PullBackAnimation extends aPullBackAnimation implements iAnimatorListener {
  ...
  public void animationEnded(iPlatformAnimator animator) {
    ...
    super.animationEnded(animator);
  }

  @Override
  public void animationStarted(iPlatformAnimator animator) {
    if (animator == slideBack) {
      return;
    }

    super.animationStarted(animator);
  }
}
