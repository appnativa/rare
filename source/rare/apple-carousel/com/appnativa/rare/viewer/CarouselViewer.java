...
public class CarouselViewer extends aCarouselViewer {
  ...
  protected void registerForUse() {
    Platform.getAppContext().registerWidgetClass(Platform.getSPOTName(Carousel.class), CarouselViewer.class);
  }
}
