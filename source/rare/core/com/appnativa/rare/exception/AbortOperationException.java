...
/**
 * An exception that causes the current operation to be aborted
 *
 * @author Don DeCoteau
 */
public class AbortOperationException extends RuntimeException {
  ...
  /** Creates a new instance of AbortOperationException */
  public AbortOperationException() {}

  public AbortOperationException(iPlatformAppContext app, boolean shutdown) {
