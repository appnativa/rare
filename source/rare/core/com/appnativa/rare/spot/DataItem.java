...
//GENERATED_COMMENT{}
  ...
  public static class CValueType extends SPOTEnumerated {
    ...
    public String spot_getValidityRange() {
      return "{" + "auto_type(0), " + "string_type(1), " + "integer_type(2), " + "decimal_type(3), "
             + "date_time_type(4), " + "date_type(5), " + "time_type(6), " + "boolean_type(7), "
             + "bytes_base64_type(8), " + "struct_type(9), " + "array_type(10), " + "widget_type(11), "
             + "custom_type(99) }";
    }
    ...
    private final static String _schoices[] = {
      "auto_type", "string_type", "integer_type", "decimal_type", "date_time_type", "date_type", "time_type",
      "boolean_type", "bytes_base64_type", "struct_type", "array_type", "widget_type", "custom_type"
    };
  }
