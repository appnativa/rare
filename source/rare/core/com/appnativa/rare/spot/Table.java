/**************************************************************************
 * Table.java - Wed Nov 18 17:50:58 PST 2015
 *
...
public class Table extends Viewer {
  ...
  public CAutoResizeMode autoResizeMode = new CAutoResizeMode(null, null, CAutoResizeMode.resize_subsequent_columns, "resize_subsequent_columns", true);
  ...
  public CGridLineType gridLineType = new CGridLineType(null, null, CGridLineType.horizontal_lines, "horizontal_lines", false );
  ...
  public CAlternatingHighlightType alternatingHighlightType = new CAlternatingHighlightType(null, null, CAlternatingHighlightType.none, "none", false );
  ...
  public CEnterKeyAction enterKeyAction = new CEnterKeyAction(null, null, CEnterKeyAction.action_event, "action_event", false );

  /** Behavior: what action should be taken when the enter key is pressed */
  public CTabKeyAction tabKeyAction = new CTabKeyAction(null, null, CTabKeyAction.next_component_unless_editable, "next_component_unless_editable", false );
  ...
  public SPOTBoolean handleFirstFocusSelection = new SPOTBoolean(null, false, false );
  ...
  public CGridViewType gridViewType = new CGridViewType(null, null, CGridViewType.vertical_wrap, "vertical_wrap", false );
   ...
   */
  public GridCell getHeaderRightFillerCell() { return headerRightFillerCell; }
   ...
   */
  public SPOTSet getColumnPopupMenu() { return columnPopupMenu; }
  ...
  public static class CAutoResizeMode extends SPOTEnumerated {
    ...
    public String spot_getValidityRange()
    {
      return "{"
      +"none(0), "
      +"resize_next_column(1), "
      +"resize_subsequent_columns(2), "
      +"resize_last_column(3), "
      +"resize_all_columns(4) }";
    }
  ...
  public static class CAlternatingHighlightType extends SPOTEnumerated {
     ...
     * @param optional   <code>true</code> if the node the object represents is optional
     */
    public CAlternatingHighlightType( Integer ival, String sval, Integer idefaultval, String sdefaultval, boolean optional)
    {
      super(ival,sval,idefaultval,sdefaultval,optional);
      _sChoices=_schoices;
      _nChoices=_nchoices;
  ...
  public static class CTabKeyAction extends SPOTEnumerated {
    ...
    public String spot_getValidityRange()
    {
      return "{"
      +"next_component(0), "
      +"next_component_unless_editable(1), "
      +"next_cell(2) }";
    }
    private final static int    _nchoices[] = {
              0,
    ...
    private final static String _schoices[] = {
              "next_component",
              "next_component_unless_editable",
              "next_cell"
             };
  ...
  public static class CSubmitValue extends SPOTEnumerated {
    ...
    public String spot_getValidityRange()
    {
      ...
      +"selected_index(3), "
      +"selected_specific_column_value_text(4), "
    ...
    private final static String _schoices[] = {
              ...
              "selected_index",
              "selected_specific_column_value_text",
              "selected_specific_column_linked_data"
             };
