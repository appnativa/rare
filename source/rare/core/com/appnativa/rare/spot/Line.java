/**************************************************************************
 * Line.java - Wed Nov 18 17:50:58 PST 2015
 *
...
public class Line extends Widget {
   ...
   */
  public SPOTSet getLines() { return lines; }
  ...
  public SPOTSet getLinesReference() {
    if ( lines == null ) {
      lines = new SPOTSet( "lineStyle", new CLineStyle(null, null, CLineStyle.separator, "separator", false ), -1, -1, true);
