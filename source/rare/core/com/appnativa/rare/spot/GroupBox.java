...
//GENERATED_COMMENT{}
   ...
   */
  public SPOTSet getCellPainters() {
    return cellPainters;
  }
  ...
  public static class CLayout extends SPOTEnumerated {
    ...
    private final static int    _nchoices[] = { 1, 2, 3, 4, 10 };
    private final static String _schoices[] = { "absolute", "table", "forms", "flow", "custom" };
  }
  ...
  public static class CSubmitValue extends SPOTEnumerated {
    ...
    private final static String _schoices[] = { "widget_values", "viewer_linked_data", "viewer_value" };
  }
  //}GENERATED_INNER_CLASSES
}
