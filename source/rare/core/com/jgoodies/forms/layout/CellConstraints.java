...
public final class CellConstraints implements Cloneable {
   ...
   * @param hAlign            the component's horizontal alignment
   * @param vAlign            the component's vertical alignment
   * @param insets            the component's display area <code>UIInsets</code>
  ...
  void setBounds(iPlatformComponent c, FormLayout layout, UIRectangle cellBounds, FormLayout.Measure minWidthMeasure,
    ...
    UIInsets   concreteInsets = (this.insets != null)
                                ? this.insets
                                : EMPTY_INSETS;
  ...
  int getMeasuredWidth(iPlatformComponent c, FormLayout layout, UIRectangle cellBounds,
                       FormLayout.Measure minWidthMeasure, FormLayout.Measure minHeightMeasure,
   ...
   */
  private int componentSize(iPlatformComponent component, FormSpec formSpec, int cellSize,
  ...
  private void setAlignments(String encodedAlignments, boolean horizontalThenVertical) {
    ...
    hAlign = horizontalThenVertical
             ? first
             : second;
    vAlign = horizontalThenVertical
             ? second
             : first;
    ensureValidOrientations(hAlign, vAlign);
  }
