...
public class EditableListBoxListHandler extends ListBoxListHandler implements iEditableListHandler {
  ListViewEx listView;

  public EditableListBoxListHandler(ListViewEx view, iPlatformListDataModel model) {
    super(view, model);
    listView = view;
  }
