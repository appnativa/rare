...
public interface iPlatformListDataModel extends iListDataModel {
  void sortEx(Comparator comparator);
  ...
  Paint getAlternatingColorPaint();
  ...
  void setAutoSizeRows(boolean autoSize);
