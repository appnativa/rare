...
public interface iPlatformPainter extends iPainter {
   ...
   * @param orientation the orientation. One of iPlatformPainter.HORIZONTAL, iPlatformPainter.VERTICAL, iPlatformPainter.UNKNOWN
   */
  void paint(View c, Canvas g, float x, float y, float width, float height, int orientation);

  /**
   * Gets the drawable for the painter
   * @param view TODO
   * @return the drawable for the painter
   */
