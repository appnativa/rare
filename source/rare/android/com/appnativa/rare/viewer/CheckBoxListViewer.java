...
public class CheckBoxListViewer extends aCheckBoxListViewer {
  ...
  /**
   *  Sets whether checkboxes are automatically checked/unchecked when they are clicked on
   *
   *  @param managed true if checkboxes are automatically checked/unchecked when they are clicked on; false otherwise
   */
  public void setCheckboxSelectionManaged(boolean managed) {}
