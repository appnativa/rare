...
/**
 * A viewer that holds a set of commonly used actions that can be general or context sensitive
 *
 * @author     Don DeCoteau
 */
public class ToolBarViewer extends aToolBarViewer {
  ...
  protected void createComponents(boolean horizontal) {
    formComponent = dataComponent = new LinearPanel(getAppContext().getActivity(), horizontal);
  }
}
