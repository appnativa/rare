...
/**
 * Mouse handler interface for charts
 *
 * @author     Don DeCoteau
 */
public interface iMouseHandler {
   ...
   *
   * @param event the mouse event
   * @param item the item the mouse is over
   */
  public void mouseMoved(MouseEvent event, ChartDataItem item);

  /**
   * Checks whether the handler wants move events
   * @return true for move events;false othrrwsie
   */
