...
class AwtFocusHandler implements FocusListener, ContainerListener, WindowFocusListener {
  ...
  AwtFocusHandler(Frame frame) {
    ...
    this.frame = frame;
    frame.addContainerListener(containerListener=new RecursiveContainerListener(this));
  ...
  void gainFocus() {
    ...
    if (component != null) {
      ...
      // TODO: else case error? If not, consider moving flag setting below into
      // this if
    }
    awtHasFocus = true;
  }
  ...
  public void focusGained(FocusEvent e) {
    ...
    // System.out.println("gained (awt). component = " + e.getComponent() +
    // ", opposite = " + e.getOppositeComponent());
